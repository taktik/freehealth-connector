...
public final class ResponseObjectBuilderFactory {
   ...
   private static ConfigurableFactoryHelper<ResponseObjectBuilder> helperFactoryresponseBuilder = new ConfigurableFactoryHelper("memberdata.responseobjectbuilder.class", "be.ehealth.businessconnector.mycarenet.agreement.builders.impl.ResponseObjectBuilderImpl");
