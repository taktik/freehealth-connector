...
public class AttestXmlValidatorImpl extends XMLValidatorImpl {
   ...
   static {
      ...
      XSD_FILE_LOCATION_FOR_CLASS_MAP.put(SendAttestationRequest.class, "/ehealth-mycarenet-attest/XSD/mycarenet-attest-protocol-1_0.xsd");
      XSD_FILE_LOCATION_FOR_CLASS_MAP.put(SendAttestationResponse.class, "/ehealth-mycarenet-attest/XSD/mycarenet-attest-protocol-1_0.xsd");
