...
import org.taktik.connector.business.domain.kmehr.v20161201.be.fgov.ehealth.standards.kmehr.schema.v1.RecipeCDTEMPORALITY;


/**
 * <p>Classe Java pour CD-TEMPORALITY complex type.
 * 
 * <p>Le fragment de schéma suivant indique le contenu attendu figurant dans cette classe.
 * 
 * <pre>
 * &lt;complexType name="CD-TEMPORALITY">
 *   &lt;simpleContent>
 *     &lt;extension base="&lt;http://www.ehealth.fgov.be/standards/kmehr/cd/v1>CD-TEMPORALITYvalues">
...
@XmlType(name = "CD-TEMPORALITY", propOrder = {
    "value"
})
@XmlSeeAlso({
    RecipeCDTEMPORALITY.class
})
    ...
    implements Serializable
{
    ...
    @XmlValue
    protected CDTEMPORALITYvalues value;
     ...
     * @return
     *     possible object is
     *     {@link CDTEMPORALITYvalues }
     *     
     */
    public CDTEMPORALITYvalues getValue() {
        return value;
    }
     ...
     *     
     */
    public void setValue(CDTEMPORALITYvalues value) {
        this.value = value;
    }
