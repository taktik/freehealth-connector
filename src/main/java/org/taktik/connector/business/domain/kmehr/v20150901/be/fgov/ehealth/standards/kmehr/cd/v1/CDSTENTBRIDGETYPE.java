...
/**
 * <p>Classe Java pour CD-STENT-BRIDGETYPE complex type.
 * 
 * <p>Le fragment de schéma suivant indique le contenu attendu figurant dans cette classe.
 * 
 * <pre>
 * &lt;complexType name="CD-STENT-BRIDGETYPE">
 *   &lt;simpleContent>
 *     &lt;extension base="&lt;http://www.ehealth.fgov.be/standards/kmehr/cd/v1>CD-STENT-BRIDGETYPEvalues">
 *       &lt;attribute name="S" use="required" type="{http://www.w3.org/2001/XMLSchema}string" fixed="CD-STENT-BRIDGETYPE" />
...
@XmlType(name = "CD-STENT-BRIDGETYPE", propOrder = {
    "value"
})
public class CDSTENTBRIDGETYPE
    implements Serializable
{

    private final static long serialVersionUID = 20150901L;
    @XmlValue
    protected CDSTENTBRIDGETYPEvalues value;
    @XmlAttribute(name = "S", required = true)
    protected String s = "CD-STENT-BRIDGETYPE";
     ...
     * @return
     *     possible object is
     *     {@link CDSTENTBRIDGETYPEvalues }
     *     
     */
    public CDSTENTBRIDGETYPEvalues getValue() {
        return value;
    }
     ...
     *     
     */
    public void setValue(CDSTENTBRIDGETYPEvalues value) {
        this.value = value;
    }
