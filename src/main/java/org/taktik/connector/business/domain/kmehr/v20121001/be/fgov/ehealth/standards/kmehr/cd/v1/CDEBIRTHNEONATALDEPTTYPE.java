...
/**
 * <p>Classe Java pour CD-EBIRTH-NEONATALDEPTTYPE complex type.
 * 
 * <p>Le fragment de schéma suivant indique le contenu attendu figurant dans cette classe.
 * 
 * <pre>
 * &lt;complexType name="CD-EBIRTH-NEONATALDEPTTYPE">
 *   &lt;simpleContent>
 *     &lt;extension base="&lt;http://www.ehealth.fgov.be/standards/kmehr/cd/v1>CD-EBIRTH-NEONATALDEPTTYPEvalues">
 *       &lt;attribute name="S" use="required" type="{http://www.w3.org/2001/XMLSchema}string" fixed="CD-EBIRTH-NEONATALDEPTTYPE" />
...
@XmlType(name = "CD-EBIRTH-NEONATALDEPTTYPE", propOrder = {
    "value"
})
public class CDEBIRTHNEONATALDEPTTYPE
    implements Serializable
{

    private final static long serialVersionUID = 20121001L;
    @XmlValue
    protected CDEBIRTHNEONATALDEPTTYPEvalues value;
    @XmlAttribute(name = "S", required = true)
    protected String s = "CD-EBIRTH-NEONATALDEPTTYPE";
     ...
     * @return
     *     possible object is
     *     {@link CDEBIRTHNEONATALDEPTTYPEvalues }
     *     
     */
    public CDEBIRTHNEONATALDEPTTYPEvalues getValue() {
        return value;
    }
     ...
     *     
     */
    public void setValue(CDEBIRTHNEONATALDEPTTYPEvalues value) {
        this.value = value;
    }
    ...
    public String getS() {
        if (s == null) {
            return "CD-EBIRTH-NEONATALDEPTTYPE";
        } else {
            return s;
        }
    }
