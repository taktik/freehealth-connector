...
/**
 * <p>Classe Java pour CD-CARENET-MUTATION-INDICATOR complex type.
 * 
 * <p>Le fragment de schéma suivant indique le contenu attendu figurant dans cette classe.
 * 
 * <pre>
 * &lt;complexType name="CD-CARENET-MUTATION-INDICATOR">
 *   &lt;simpleContent>
 *     &lt;extension base="&lt;http://www.ehealth.fgov.be/standards/kmehr/cd/v1>CD-CARENET-MUTATION-INDICATORvalues">
 *       &lt;attribute name="S" use="required" type="{http://www.w3.org/2001/XMLSchema}string" fixed="CD-CARENET-MUTATION-INDICATOR" />
...
@XmlType(name = "CD-CARENET-MUTATION-INDICATOR", propOrder = {
    "value"
})
public class CDCARENETMUTATIONINDICATOR
    implements Serializable
{
    ...
    protected String s = "CD-CARENET-MUTATION-INDICATOR";
    ...
    public String getS() {
        if (s == null) {
            return "CD-CARENET-MUTATION-INDICATOR";
        } else {
            return s;
        }
    }
