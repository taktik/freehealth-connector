...
/**
 * <p>Classe Java pour CD-MAA-REFUSALJUSTIFICATION complex type.
 * 
 * <p>Le fragment de schéma suivant indique le contenu attendu figurant dans cette classe.
 * 
 * <pre>
 * &lt;complexType name="CD-MAA-REFUSALJUSTIFICATION">
 *   &lt;simpleContent>
 *     &lt;extension base="&lt;http://www.ehealth.fgov.be/standards/kmehr/cd/v1>CD-MAA-REFUSALJUSTIFICATIONvalues">
 *       &lt;attribute name="S" use="required" type="{http://www.w3.org/2001/XMLSchema}string" fixed="CD-MAA-REFUSALJUSTIFICATION" />
...
@XmlType(name = "CD-MAA-REFUSALJUSTIFICATION", propOrder = {
    "value"
})
public class CDMAAREFUSALJUSTIFICATION
    implements Serializable
{
    ...
    protected String s = "CD-MAA-REFUSALJUSTIFICATION";
    ...
    public String getS() {
        if (s == null) {
            return "CD-MAA-REFUSALJUSTIFICATION";
        } else {
            return s;
        }
    }
