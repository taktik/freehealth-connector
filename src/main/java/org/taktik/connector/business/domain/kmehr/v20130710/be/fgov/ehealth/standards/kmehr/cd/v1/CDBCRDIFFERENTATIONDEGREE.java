...
/**
 * <p>Classe Java pour CD-BCR-DIFFERENTATIONDEGREE complex type.
 * 
 * <p>Le fragment de schéma suivant indique le contenu attendu figurant dans cette classe.
 * 
 * <pre>
 * &lt;complexType name="CD-BCR-DIFFERENTATIONDEGREE">
 *   &lt;simpleContent>
 *     &lt;extension base="&lt;http://www.ehealth.fgov.be/standards/kmehr/cd/v1>CD-BCR-DIFFERENTATIONDEGREEvalues">
 *       &lt;attribute name="S" use="required" type="{http://www.w3.org/2001/XMLSchema}string" fixed="CD-BCR-DIFFERENTATIONDEGREE" />
...
@XmlType(name = "CD-BCR-DIFFERENTATIONDEGREE", propOrder = {
    "value"
})
public class CDBCRDIFFERENTATIONDEGREE
    implements Serializable
{

    private final static long serialVersionUID = 20130710L;
    @XmlValue
    protected CDBCRDIFFERENTATIONDEGREEvalues value;
    @XmlAttribute(name = "S", required = true)
    protected String s = "CD-BCR-DIFFERENTATIONDEGREE";
     ...
     * @return
     *     possible object is
     *     {@link CDBCRDIFFERENTATIONDEGREEvalues }
     *
     */
    public CDBCRDIFFERENTATIONDEGREEvalues getValue() {
        return value;
    }
     ...
     *
     */
    public void setValue(CDBCRDIFFERENTATIONDEGREEvalues value) {
        this.value = value;
    }
    ...
    public String getS() {
        if (s == null) {
            return "CD-BCR-DIFFERENTATIONDEGREE";
        } else {
            return s;
        }
    }
