...
/**
 * <p>Classe Java pour CD-CHAPTER4FORMALINTERPRETATION complex type.
 * 
 * <p>Le fragment de schéma suivant indique le contenu attendu figurant dans cette classe.
 * 
 * <pre>
 * &lt;complexType name="CD-CHAPTER4FORMALINTERPRETATION">
 *   &lt;simpleContent>
 *     &lt;extension base="&lt;http://www.ehealth.fgov.be/standards/kmehr/cd/v1>CD-CHAPTER4FORMALINTERPRETATIONvalues">
 *       &lt;attribute name="S" use="required" type="{http://www.w3.org/2001/XMLSchema}string" fixed="CD-CHAPTER4FORMALINTERPRETATION" />
...
@XmlType(name = "CD-CHAPTER4FORMALINTERPRETATION", propOrder = {
    "value"
})
public class CDCHAPTER4FORMALINTERPRETATION
    implements Serializable
{
    ...
    public String getS() {
        if (s == null) {
            return "CD-CHAPTER4FORMALINTERPRETATION";
        } else {
            return s;
        }
    }
