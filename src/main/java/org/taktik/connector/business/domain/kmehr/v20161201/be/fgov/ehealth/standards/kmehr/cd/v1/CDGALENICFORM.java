...
import org.taktik.connector.business.domain.kmehr.v20161201.be.fgov.ehealth.standards.kmehr.schema.v1.RecipeCDGALENICFORM;


/**
 * <p>Classe Java pour CD-GALENICFORM complex type.
 * 
 * <p>Le fragment de schéma suivant indique le contenu attendu figurant dans cette classe.
 * 
 * <pre>
 * &lt;complexType name="CD-GALENICFORM">
 *   &lt;simpleContent>
 *     &lt;extension base="&lt;http://www.w3.org/2001/XMLSchema>string">
 *       &lt;attribute name="S" use="required" type="{http://www.ehealth.fgov.be/standards/kmehr/cd/v1}CD-GALENICFORMschemes" />
...
@XmlType(name = "CD-GALENICFORM", propOrder = {
    "value"
})
@XmlSeeAlso({
    RecipeCDGALENICFORM.class
})
public class CDGALENICFORM
    implements Serializable
{
    ...
    protected CDGALENICFORMschemes s;
     ...
     * @return
     *     possible object is
     *     {@link CDGALENICFORMschemes }
     *     
     */
    public CDGALENICFORMschemes getS() {
        return s;
    }
     ...
     *     
     */
    public void setS(CDGALENICFORMschemes value) {
        this.s = value;
    }
