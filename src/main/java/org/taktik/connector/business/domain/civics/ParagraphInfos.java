...
public class ParagraphInfos implements Serializable{
    ...
    org.taktik.connector.business.domain.civics.VerseInfos headerVerse;
    ...
    public org.taktik.connector.business.domain.civics.VerseInfos getHeaderVerse() {
        return headerVerse;
    }

    public void setHeaderVerse(org.taktik.connector.business.domain.civics.VerseInfos headerVerse) {
