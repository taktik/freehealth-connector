...
/**
 * <p>Classe Java pour CD-ORTHO-INTERFACE complex type.
 * 
 * <p>Le fragment de schéma suivant indique le contenu attendu figurant dans cette classe.
 * 
 * <pre>
 * &lt;complexType name="CD-ORTHO-INTERFACE">
 *   &lt;simpleContent>
 *     &lt;extension base="&lt;http://www.ehealth.fgov.be/standards/kmehr/cd/v1>CD-ORTHO-INTERFACEvalues">
 *       &lt;attribute name="S" use="required" type="{http://www.w3.org/2001/XMLSchema}string" fixed="CD-ORTHO-INTERFACE" />
...
@XmlType(name = "CD-ORTHO-INTERFACE", propOrder = {
    "value"
})
public class CDORTHOINTERFACE
    implements Serializable
{

    private final static long serialVersionUID = 20121001L;
    @XmlValue
    protected CDORTHOINTERFACEvalues value;
    @XmlAttribute(name = "S", required = true)
    protected String s = "CD-ORTHO-INTERFACE";
     ...
     * @return
     *     possible object is
     *     {@link CDORTHOINTERFACEvalues }
     *
     */
    public CDORTHOINTERFACEvalues getValue() {
        return value;
    }
     ...
     *
     */
    public void setValue(CDORTHOINTERFACEvalues value) {
        this.value = value;
    }
