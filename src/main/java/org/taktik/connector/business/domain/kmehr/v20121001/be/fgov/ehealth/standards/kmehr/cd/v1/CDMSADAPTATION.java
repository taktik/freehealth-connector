...
/**
 * <p>Classe Java pour CD-MS-ADAPTATION complex type.
 * 
 * <p>Le fragment de schéma suivant indique le contenu attendu figurant dans cette classe.
 * 
 * <pre>
 * &lt;complexType name="CD-MS-ADAPTATION">
 *   &lt;simpleContent>
 *     &lt;extension base="&lt;http://www.ehealth.fgov.be/standards/kmehr/cd/v1>CD-MS-ADAPTATIONvalues">
 *       &lt;attribute name="S" use="required" type="{http://www.w3.org/2001/XMLSchema}string" fixed="CD-MS-ADAPTATION" />
...
@XmlType(name = "CD-MS-ADAPTATION", propOrder = {
    "value"
})
public class CDMSADAPTATION
    implements Serializable
{

    private final static long serialVersionUID = 20121001L;
    @XmlValue
    protected CDMSADAPTATIONvalues value;
    @XmlAttribute(name = "S", required = true)
    protected String s = "CD-MS-ADAPTATION";
     ...
     * @return
     *     possible object is
     *     {@link CDMSADAPTATIONvalues }
     *
     */
    public CDMSADAPTATIONvalues getValue() {
        return value;
    }
     ...
     *
     */
    public void setValue(CDMSADAPTATIONvalues value) {
        this.value = value;
    }
