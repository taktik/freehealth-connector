...
import org.taktik.connector.business.domain.kmehr.v20161201.be.fgov.ehealth.standards.kmehr.schema.v1.RecipeCDQUANTITYPREFIX;


/**
 * <p>Classe Java pour CD-QUANTITYPREFIX complex type.
 * 
 * <p>Le fragment de schéma suivant indique le contenu attendu figurant dans cette classe.
 * 
 * <pre>
 * &lt;complexType name="CD-QUANTITYPREFIX">
 *   &lt;simpleContent>
 *     &lt;extension base="&lt;http://www.ehealth.fgov.be/standards/kmehr/cd/v1>CD-QUANTITYPREFIXvalues">
 *       &lt;attribute name="S" use="required" type="{http://www.w3.org/2001/XMLSchema}string" fixed="CD-QUANTITYPREFIX" />
...
@XmlType(name = "CD-QUANTITYPREFIX", propOrder = {
    "value"
})
@XmlSeeAlso({
    RecipeCDQUANTITYPREFIX.class
})
public class CDQUANTITYPREFIX
