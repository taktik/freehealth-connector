...
/**
 * <p>Classe Java pour CD-ORTHO-NAVCOM complex type.
 * 
 * <p>Le fragment de schéma suivant indique le contenu attendu figurant dans cette classe.
 * 
 * <pre>
 * &lt;complexType name="CD-ORTHO-NAVCOM">
 *   &lt;simpleContent>
 *     &lt;extension base="&lt;http://www.ehealth.fgov.be/standards/kmehr/cd/v1>CD-ORTHO-NAVCOMvalues">
 *       &lt;attribute name="S" use="required" type="{http://www.w3.org/2001/XMLSchema}string" fixed="CD-ORTHO-NAVCOM" />
...
@XmlType(name = "CD-ORTHO-NAVCOM", propOrder = {
    "value"
})
public class CDORTHONAVCOM
    implements Serializable
{

    private final static long serialVersionUID = 20150901L;
    @XmlValue
    protected CDORTHONAVCOMvalues value;
    @XmlAttribute(name = "S", required = true)
    protected String s = "CD-ORTHO-NAVCOM";
     ...
     *     
     */
    public void setValue(CDORTHONAVCOMvalues value) {
        this.value = value;
    }
