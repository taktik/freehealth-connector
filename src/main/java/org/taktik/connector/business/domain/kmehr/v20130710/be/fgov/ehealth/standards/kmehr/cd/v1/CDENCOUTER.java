...
/**
 * <p>Classe Java pour CD-ENCOUTER complex type.
 * 
 * <p>Le fragment de schéma suivant indique le contenu attendu figurant dans cette classe.
 * 
 * <pre>
 * &lt;complexType name="CD-ENCOUTER">
 *   &lt;simpleContent>
 *     &lt;extension base="&lt;http://www.ehealth.fgov.be/standards/kmehr/cd/v1>CD-ENCOUTERvalues">
 *       &lt;attribute name="S" use="required" type="{http://www.w3.org/2001/XMLSchema}string" fixed="CD-ENCOUTER" />
...
@XmlType(name = "CD-ENCOUTER", propOrder = {
    "value"
})
public class CDENCOUTER
    implements Serializable
{

    private final static long serialVersionUID = 20130710L;
    @XmlValue
    protected CDENCOUTERvalues value;
    @XmlAttribute(name = "S", required = true)
    protected String s = "CD-ENCOUTER";
     ...
     * @return
     *     possible object is
     *     {@link CDENCOUTERvalues }
     *
     */
    public CDENCOUTERvalues getValue() {
        return value;
    }
     ...
     *
     */
    public void setValue(CDENCOUTERvalues value) {
        this.value = value;
    }
