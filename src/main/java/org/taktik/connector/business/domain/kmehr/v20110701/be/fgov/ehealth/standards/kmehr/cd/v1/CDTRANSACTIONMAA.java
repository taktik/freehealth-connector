...
/**
 * <p>Classe Java pour CD-TRANSACTION-MAA complex type.
 * 
 * <p>Le fragment de schéma suivant indique le contenu attendu figurant dans cette classe.
 * 
 * <pre>
 * &lt;complexType name="CD-TRANSACTION-MAA">
 *   &lt;simpleContent>
 *     &lt;extension base="&lt;http://www.ehealth.fgov.be/standards/kmehr/cd/v1>CD-TRANSACTION-MAAvalues">
 *       &lt;attribute name="S" use="required" type="{http://www.w3.org/2001/XMLSchema}string" fixed="CD-TRANSACTION-MAA" />
...
@XmlType(name = "CD-TRANSACTION-MAA", propOrder = {
    "value"
})
public class CDTRANSACTIONMAA
    implements Serializable
{

    private final static long serialVersionUID = 20110701L;
    @XmlValue
    protected CDTRANSACTIONMAAvalues value;
    @XmlAttribute(name = "S", required = true)
    protected String s = "CD-TRANSACTION-MAA";
     ...
     * @return
     *     possible object is
     *     {@link CDTRANSACTIONMAAvalues }
     *
     */
    public CDTRANSACTIONMAAvalues getValue() {
        return value;
    }
     ...
     *
     */
    public void setValue(CDTRANSACTIONMAAvalues value) {
        this.value = value;
    }
