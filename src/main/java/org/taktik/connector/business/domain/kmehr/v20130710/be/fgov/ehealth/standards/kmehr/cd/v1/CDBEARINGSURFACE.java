...
/**
 * <p>Classe Java pour CD-BEARING-SURFACE complex type.
 * 
 * <p>Le fragment de schéma suivant indique le contenu attendu figurant dans cette classe.
 * 
 * <pre>
 * &lt;complexType name="CD-BEARING-SURFACE">
 *   &lt;simpleContent>
 *     &lt;extension base="&lt;http://www.ehealth.fgov.be/standards/kmehr/cd/v1>CD-BEARING-SURFACEvalues">
 *       &lt;attribute name="S" use="required" type="{http://www.w3.org/2001/XMLSchema}string" fixed="CD-BEARING-SURFACE" />
...
@XmlType(name = "CD-BEARING-SURFACE", propOrder = {
    "value"
})
public class CDBEARINGSURFACE
    implements Serializable
{

    private final static long serialVersionUID = 20130710L;
    @XmlValue
    protected CDBEARINGSURFACEvalues value;
    @XmlAttribute(name = "S", required = true)
    protected String s = "CD-BEARING-SURFACE";
     ...
     *     
     */
    public void setValue(CDBEARINGSURFACEvalues value) {
        this.value = value;
    }
