...
/**
 * <p>Classe Java pour CD-DISCHARGETYPE complex type.
 * 
 * <p>Le fragment de schéma suivant indique le contenu attendu figurant dans cette classe.
 * 
 * <pre>
 * &lt;complexType name="CD-DISCHARGETYPE">
 *   &lt;simpleContent>
 *     &lt;extension base="&lt;http://www.ehealth.fgov.be/standards/kmehr/cd/v1>CD-DISCHARGETYPEvalues">
 *       &lt;attribute name="S" use="required" type="{http://www.w3.org/2001/XMLSchema}string" fixed="CD-DISCHARGETYPE" />
...
@XmlType(name = "CD-DISCHARGETYPE", propOrder = {
    "value"
})
public class CDDISCHARGETYPE
    implements Serializable
{

    private final static long serialVersionUID = 20130710L;
    @XmlValue
    protected CDDISCHARGETYPEvalues value;
    @XmlAttribute(name = "S", required = true)
    protected String s = "CD-DISCHARGETYPE";
     ...
     * @return
     *     possible object is
     *     {@link CDDISCHARGETYPEvalues }
     *
     */
    public CDDISCHARGETYPEvalues getValue() {
        return value;
    }
     ...
     *
     */
    public void setValue(CDDISCHARGETYPEvalues value) {
        this.value = value;
    }
