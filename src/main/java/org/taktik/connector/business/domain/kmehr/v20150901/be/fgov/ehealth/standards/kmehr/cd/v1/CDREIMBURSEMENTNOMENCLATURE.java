...
/**
 * <p>Classe Java pour CD-REIMBURSEMENT-NOMENCLATURE complex type.
 * 
 * <p>Le fragment de schéma suivant indique le contenu attendu figurant dans cette classe.
 * 
 * <pre>
 * &lt;complexType name="CD-REIMBURSEMENT-NOMENCLATURE">
 *   &lt;simpleContent>
 *     &lt;extension base="&lt;http://www.ehealth.fgov.be/standards/kmehr/cd/v1>CD-REIMBURSEMENT-NOMENCLATUREvalues">
 *       &lt;attribute name="S" use="required" type="{http://www.w3.org/2001/XMLSchema}string" fixed="CD-REIMBURSEMENT-NOMENCLATURE" />
...
@XmlType(name = "CD-REIMBURSEMENT-NOMENCLATURE", propOrder = {
    "value"
})
public class CDREIMBURSEMENTNOMENCLATURE
    implements Serializable
{
    ...
    protected String s = "CD-REIMBURSEMENT-NOMENCLATURE";
    ...
    public String getS() {
        if (s == null) {
            return "CD-REIMBURSEMENT-NOMENCLATURE";
        } else {
            return s;
        }
    }
