...
/**
 * <p>Classe Java pour CD-CARENET-PERSONAL-PART complex type.
 * 
 * <p>Le fragment de schéma suivant indique le contenu attendu figurant dans cette classe.
 * 
 * <pre>
 * &lt;complexType name="CD-CARENET-PERSONAL-PART">
 *   &lt;simpleContent>
 *     &lt;extension base="&lt;http://www.ehealth.fgov.be/standards/kmehr/cd/v1>CD-CARENET-PERSONAL-PARTvalues">
 *       &lt;attribute name="S" use="required" type="{http://www.w3.org/2001/XMLSchema}string" fixed="CD-CARENET-PERSONAL-PART" />
...
@XmlType(name = "CD-CARENET-PERSONAL-PART", propOrder = {
    "value"
})
    ...
    implements Serializable
{
    ...
    @XmlValue
    protected CDCARENETPERSONALPARTvalues value;
    @XmlAttribute(name = "S", required = true)
    protected String s = "CD-CARENET-PERSONAL-PART";
     ...
     * @return
     *     possible object is
     *     {@link CDCARENETPERSONALPARTvalues }
     *     
     */
     ...
     *     
     */
    public void setValue(CDCARENETPERSONALPARTvalues value) {
        this.value = value;
    }
    ...
    public String getS() {
        if (s == null) {
            return "CD-CARENET-PERSONAL-PART";
        } else {
            return s;
        }
    }
