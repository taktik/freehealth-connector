...
/**
 * <p>Classe Java pour CD-PROOF complex type.
 * 
 * <p>Le fragment de schéma suivant indique le contenu attendu figurant dans cette classe.
 * 
 * <pre>
 * &lt;complexType name="CD-PROOF">
 *   &lt;simpleContent>
 *     &lt;extension base="&lt;http://www.ehealth.fgov.be/standards/kmehr/cd/v1>CD-PROOFvalues">
 *       &lt;attribute name="S" use="required" type="{http://www.ehealth.fgov.be/standards/kmehr/cd/v1}CD-PROOFschemes" />
...
@XmlType(name = "CD-PROOF", propOrder = {
    "value"
})
    ...
    implements Serializable
{
    ...
    @XmlValue
    protected CDPROOFvalues value;
    @XmlAttribute(name = "S", required = true)
    protected CDPROOFschemes s;
     ...
     *
     */
    public void setValue(CDPROOFvalues value) {
        this.value = value;
    }
     ...
     *     
     */
    public void setS(CDPROOFschemes value) {
        this.s = value;
    }
