...
/**
 * <p>Classe Java pour CD-MAA-TYPE complex type.
 * 
 * <p>Le fragment de schéma suivant indique le contenu attendu figurant dans cette classe.
 * 
 * <pre>
 * &lt;complexType name="CD-MAA-TYPE">
 *   &lt;simpleContent>
 *     &lt;extension base="&lt;http://www.ehealth.fgov.be/standards/kmehr/cd/v1>CD-MAA-TYPEvalues">
 *       &lt;attribute name="S" use="required" type="{http://www.w3.org/2001/XMLSchema}string" fixed="CD-MAA-TYPE" />
...
@XmlType(name = "CD-MAA-TYPE", propOrder = {
    "value"
})
public class CDMAATYPE
    implements Serializable
{

    private final static long serialVersionUID = 20130710L;
    @XmlValue
    protected CDMAATYPEvalues value;
    @XmlAttribute(name = "S", required = true)
    protected String s = "CD-MAA-TYPE";
     ...
     * @return
     *     possible object is
     *     {@link CDMAATYPEvalues }
     *     
     */
    public CDMAATYPEvalues getValue() {
        return value;
    }
     ...
     *     
     */
    public void setValue(CDMAATYPEvalues value) {
        this.value = value;
    }
