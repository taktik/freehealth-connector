...
/**
 * <p>Classe Java pour CD-BALLON-DEVICE complex type.
 * 
 * <p>Le fragment de schéma suivant indique le contenu attendu figurant dans cette classe.
 * 
 * <pre>
 * &lt;complexType name="CD-BALLON-DEVICE">
 *   &lt;simpleContent>
 *     &lt;extension base="&lt;http://www.ehealth.fgov.be/standards/kmehr/cd/v1>CD-BALLON-DEVICEvalues">
 *       &lt;attribute name="S" use="required" type="{http://www.w3.org/2001/XMLSchema}string" fixed="CD-BALLON-DEVICE" />
...
@XmlType(name = "CD-BALLON-DEVICE", propOrder = {
    "value"
})
public class CDBALLONDEVICE
    implements Serializable
{

    private final static long serialVersionUID = 20121001L;
    @XmlValue
    protected CDBALLONDEVICEvalues value;
    @XmlAttribute(name = "S", required = true)
    protected String s = "CD-BALLON-DEVICE";
     ...
     * @return
     *     possible object is
     *     {@link CDBALLONDEVICEvalues }
     *     
     */
    public CDBALLONDEVICEvalues getValue() {
        return value;
    }
     ...
     *     
     */
    public void setValue(CDBALLONDEVICEvalues value) {
        this.value = value;
    }
