...
/**
 * <p>Classe Java pour CD-CARENET-ACCIDENT-TYPE complex type.
 * 
 * <p>Le fragment de schéma suivant indique le contenu attendu figurant dans cette classe.
 * 
 * <pre>
 * &lt;complexType name="CD-CARENET-ACCIDENT-TYPE">
 *   &lt;simpleContent>
 *     &lt;extension base="&lt;http://www.ehealth.fgov.be/standards/kmehr/cd/v1>CD-CARENET-ACCIDENT-TYPEvalues">
 *       &lt;attribute name="S" use="required" type="{http://www.w3.org/2001/XMLSchema}string" fixed="CD-CARENET-ACCIDENT-TYPE" />
...
@XmlType(name = "CD-CARENET-ACCIDENT-TYPE", propOrder = {
    "value"
})
public class CDCARENETACCIDENTTYPE
    implements Serializable
{
    ...
    protected String s = "CD-CARENET-ACCIDENT-TYPE";
    ...
    public String getS() {
        if (s == null) {
            return "CD-CARENET-ACCIDENT-TYPE";
        } else {
            return s;
        }
    }
