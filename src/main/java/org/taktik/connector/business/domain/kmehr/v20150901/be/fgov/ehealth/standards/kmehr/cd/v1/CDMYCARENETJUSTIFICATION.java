...
/**
 * <p>Classe Java pour CD-MYCARENET-JUSTIFICATION complex type.
 * 
 * <p>Le fragment de schéma suivant indique le contenu attendu figurant dans cette classe.
 * 
 * <pre>
 * &lt;complexType name="CD-MYCARENET-JUSTIFICATION">
 *   &lt;simpleContent>
 *     &lt;extension base="&lt;http://www.ehealth.fgov.be/standards/kmehr/cd/v1>CD-MYCARENET-JUSTIFICATIONvalues">
 *       &lt;attribute name="S" use="required" type="{http://www.w3.org/2001/XMLSchema}string" fixed="CD-MYCARENET-JUSTIFICATION" />
...
@XmlType(name = "CD-MYCARENET-JUSTIFICATION", propOrder = {
    "value"
})
public class CDMYCARENETJUSTIFICATION
    implements Serializable
{
    ...
    protected String s = "CD-MYCARENET-JUSTIFICATION";
    ...
    public String getS() {
        if (s == null) {
            return "CD-MYCARENET-JUSTIFICATION";
        } else {
            return s;
        }
    }
