...
/**
 * <p>Java class for CD-EMPLOYMENTSITUATIONvalues.
 *
 * <p>The following schema fragment specifies the expected content contained within this class.
 * <p>
 * <pre>
 * &lt;simpleType name="CD-EMPLOYMENTSITUATIONvalues">
 *   &lt;restriction base="{http://www.w3.org/2001/XMLSchema}string">
 *     &lt;enumeration value="selfemployed"/>
 *     &lt;enumeration value="employed"/>
 *     &lt;enumeration value="civilservant"/>
 *   &lt;/restriction>
 * &lt;/simpleType>
 * </pre>
 *
...
public enum CDEMPLOYMENTSITUATIONvalues {
    ...
    CDEMPLOYMENTSITUATIONvalues(String v) {
        value = v;
    }
    ...
    public static CDEMPLOYMENTSITUATIONvalues fromValue(String v) {
        for (CDEMPLOYMENTSITUATIONvalues c: CDEMPLOYMENTSITUATIONvalues.values()) {
            if (c.value.equals(v)) {
                return c;
            }
        }
