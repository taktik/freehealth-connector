...
/**
 * <p>Classe Java pour CD-ITEM-MAA complex type.
 * 
 * <p>Le fragment de schéma suivant indique le contenu attendu figurant dans cette classe.
 * 
 * <pre>
 * &lt;complexType name="CD-ITEM-MAA">
 *   &lt;simpleContent>
 *     &lt;extension base="&lt;http://www.ehealth.fgov.be/standards/kmehr/cd/v1>CD-ITEM-MAAvalues">
 *       &lt;attribute name="S" use="required" type="{http://www.w3.org/2001/XMLSchema}string" fixed="CD-ITEM-MAA" />
...
@XmlType(name = "CD-ITEM-MAA", propOrder = {
    "value"
})
public class CDITEMMAA
    implements Serializable
{

    private final static long serialVersionUID = 20121001L;
    @XmlValue
    protected CDITEMMAAvalues value;
    @XmlAttribute(name = "S", required = true)
    protected String s = "CD-ITEM-MAA";
     ...
     * @return
     *     possible object is
     *     {@link CDITEMMAAvalues }
     *
     */
    public CDITEMMAAvalues getValue() {
        return value;
    }
     ...
     *
     */
    public void setValue(CDITEMMAAvalues value) {
        this.value = value;
    }
