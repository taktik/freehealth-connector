...
/**
 * <p>Classe Java pour CD-ACTS-NURSING complex type.
 * 
 * <p>Le fragment de schéma suivant indique le contenu attendu figurant dans cette classe.
 * 
 * <pre>
 * &lt;complexType name="CD-ACTS-NURSING">
 *   &lt;simpleContent>
 *     &lt;extension base="&lt;http://www.ehealth.fgov.be/standards/kmehr/cd/v1>CD-ACTS-NURSINGvalues">
 *       &lt;attribute name="S" use="required" type="{http://www.w3.org/2001/XMLSchema}string" fixed="CD-ACTS-NURSING" />
...
@XmlType(name = "CD-ACTS-NURSING", propOrder = {
    "value"
})
public class CDACTSNURSING
    implements Serializable
{

    private final static long serialVersionUID = 20150901L;
    @XmlValue
    protected CDACTSNURSINGvalues value;
    @XmlAttribute(name = "S", required = true)
    protected String s = "CD-ACTS-NURSING";
     ...
     * @return
     *     possible object is
     *     {@link CDACTSNURSINGvalues }
     *     
     */
    public CDACTSNURSINGvalues getValue() {
        return value;
    }
     ...
     *     
     */
    public void setValue(CDACTSNURSINGvalues value) {
        this.value = value;
    }
