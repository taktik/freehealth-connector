...
/**
 * <p>Classe Java pour CD-STENT-LESIONTYPE complex type.
 * 
 * <p>Le fragment de schéma suivant indique le contenu attendu figurant dans cette classe.
 * 
 * <pre>
 * &lt;complexType name="CD-STENT-LESIONTYPE">
 *   &lt;simpleContent>
 *     &lt;extension base="&lt;http://www.ehealth.fgov.be/standards/kmehr/cd/v1>CD-STENT-LESIONTYPEvalues">
 *       &lt;attribute name="S" use="required" type="{http://www.w3.org/2001/XMLSchema}string" fixed="CD-STENT-LESIONTYPE" />
...
@XmlType(name = "CD-STENT-LESIONTYPE", propOrder = {
    "value"
})
public class CDSTENTLESIONTYPE
    implements Serializable
{

    private final static long serialVersionUID = 20130710L;
    @XmlValue
    protected CDSTENTLESIONTYPEvalues value;
    @XmlAttribute(name = "S", required = true)
    protected String s = "CD-STENT-LESIONTYPE";
     ...
     * @return
     *     possible object is
     *     {@link CDSTENTLESIONTYPEvalues }
     *
     */
    public CDSTENTLESIONTYPEvalues getValue() {
        return value;
    }
     ...
     *
     */
    public void setValue(CDSTENTLESIONTYPEvalues value) {
        this.value = value;
    }
