...
/**
 * <p>Classe Java pour CD-CLINICALPLAN complex type.
 * 
 * <p>Le fragment de schéma suivant indique le contenu attendu figurant dans cette classe.
 * 
 * <pre>
 * &lt;complexType name="CD-CLINICALPLAN">
 *   &lt;simpleContent>
 *     &lt;extension base="&lt;http://www.ehealth.fgov.be/standards/kmehr/cd/v1>CD-CLINICALPLANvalues">
 *       &lt;attribute name="S" use="required" type="{http://www.w3.org/2001/XMLSchema}string" fixed="CD-CLINICALPLAN" />
...
@XmlType(name = "CD-CLINICALPLAN", propOrder = {
    "value"
})
public class CDCLINICALPLAN
    implements Serializable
{

    private final static long serialVersionUID = 20150901L;
    @XmlValue
    protected CDCLINICALPLANvalues value;
    @XmlAttribute(name = "S", required = true)
    protected String s = "CD-CLINICALPLAN";
     ...
     * @return
     *     possible object is
     *     {@link CDCLINICALPLANvalues }
     *
     */
    public CDCLINICALPLANvalues getValue() {
        return value;
    }
     ...
     *
     */
    public void setValue(CDCLINICALPLANvalues value) {
        this.value = value;
    }
