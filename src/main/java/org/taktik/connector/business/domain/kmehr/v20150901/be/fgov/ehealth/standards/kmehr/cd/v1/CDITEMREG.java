...
/**
 * <p>Classe Java pour CD-ITEM-REG complex type.
 * 
 * <p>Le fragment de schéma suivant indique le contenu attendu figurant dans cette classe.
 * 
 * <pre>
 * &lt;complexType name="CD-ITEM-REG">
 *   &lt;simpleContent>
 *     &lt;extension base="&lt;http://www.ehealth.fgov.be/standards/kmehr/cd/v1>CD-ITEM-REGvalues">
 *       &lt;attribute name="S" use="required" type="{http://www.w3.org/2001/XMLSchema}string" fixed="CD-ITEM-REG" />
...
@XmlType(name = "CD-ITEM-REG", propOrder = {
    "value"
})
public class CDITEMREG
    implements Serializable
{

    private final static long serialVersionUID = 20150901L;
    @XmlValue
    protected CDITEMREGvalues value;
    @XmlAttribute(name = "S", required = true)
    protected String s = "CD-ITEM-REG";
    @XmlAttribute(name = "SV", required = true)
    protected String sv = "1.5";
     ...
     * @return
     *     possible object is
     *     {@link CDITEMREGvalues }
     *
     */
    public CDITEMREGvalues getValue() {
        return value;
    }
     ...
     *
     */
    public void setValue(CDITEMREGvalues value) {
        this.value = value;
    }
