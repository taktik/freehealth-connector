...
/**
 * <p>Classe Java pour CD-TUCO-PATHOLOGYTYPE complex type.
 * 
 * <p>Le fragment de schéma suivant indique le contenu attendu figurant dans cette classe.
 * 
 * <pre>
 * &lt;complexType name="CD-TUCO-PATHOLOGYTYPE">
 *   &lt;simpleContent>
 *     &lt;extension base="&lt;http://www.ehealth.fgov.be/standards/kmehr/cd/v1>CD-TUCO-PATHOLOGYTYPEvalues">
 *       &lt;attribute name="S" use="required" type="{http://www.w3.org/2001/XMLSchema}string" fixed="CD-TUCO-PATHOLOGYTYPE" />
...
@XmlType(name = "CD-TUCO-PATHOLOGYTYPE", propOrder = {
    "value"
})
public class CDTUCOPATHOLOGYTYPE
    implements Serializable
{

    private final static long serialVersionUID = 20121001L;
    @XmlValue
    protected CDTUCOPATHOLOGYTYPEvalues value;
    @XmlAttribute(name = "S", required = true)
    protected String s = "CD-TUCO-PATHOLOGYTYPE";
     ...
     * @return
     *     possible object is
     *     {@link CDTUCOPATHOLOGYTYPEvalues }
     *     
     */
    public CDTUCOPATHOLOGYTYPEvalues getValue() {
        return value;
    }
     ...
     *     
     */
    public void setValue(CDTUCOPATHOLOGYTYPEvalues value) {
        this.value = value;
    }
