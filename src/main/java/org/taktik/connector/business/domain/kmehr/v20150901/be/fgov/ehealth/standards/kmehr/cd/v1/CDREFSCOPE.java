...
/**
 * <p>Classe Java pour CD-REFSCOPE complex type.
 * 
 * <p>Le fragment de schéma suivant indique le contenu attendu figurant dans cette classe.
 * 
 * <pre>
 * &lt;complexType name="CD-REFSCOPE">
 *   &lt;simpleContent>
 *     &lt;extension base="&lt;http://www.ehealth.fgov.be/standards/kmehr/cd/v1>CD-REFSCOPEvalues">
 *       &lt;attribute name="S" use="required" type="{http://www.w3.org/2001/XMLSchema}string" fixed="CD-REFSCOPE" />
...
@XmlType(name = "CD-REFSCOPE", propOrder = {
    "value"
})
    ...
    implements Serializable
{
    ...
    @XmlValue
    protected CDREFSCOPEvalues value;
    @XmlAttribute(name = "S", required = true)
    protected String s = "CD-REFSCOPE";
     ...
     * @return
     *     possible object is
     *     {@link CDREFSCOPEvalues }
     *     
     */
    public CDREFSCOPEvalues getValue() {
        return value;
    }
     ...
     *     
     */
    public void setValue(CDREFSCOPEvalues value) {
        this.value = value;
    }
