...
/**
 * <p>Classe Java pour CD-CARENET-REFUSAL-REASON complex type.
 * 
 * <p>Le fragment de schéma suivant indique le contenu attendu figurant dans cette classe.
 * 
 * <pre>
 * &lt;complexType name="CD-CARENET-REFUSAL-REASON">
 *   &lt;simpleContent>
 *     &lt;extension base="&lt;http://www.ehealth.fgov.be/standards/kmehr/cd/v1>CD-CARENET-REFUSAL-REASONvalues">
 *       &lt;attribute name="S" use="required" type="{http://www.w3.org/2001/XMLSchema}string" fixed="CD-CARENET-REFUSAL-REASON" />
...
@XmlType(name = "CD-CARENET-REFUSAL-REASON", propOrder = {
    "value"
})
public class CDCARENETREFUSALREASON
    implements Serializable
{
    ...
    protected String s = "CD-CARENET-REFUSAL-REASON";
    ...
    public String getS() {
        if (s == null) {
            return "CD-CARENET-REFUSAL-REASON";
        } else {
            return s;
        }
    }
