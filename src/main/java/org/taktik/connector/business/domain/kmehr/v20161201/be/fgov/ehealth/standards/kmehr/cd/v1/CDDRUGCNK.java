...
import org.taktik.connector.business.domain.kmehr.v20161201.be.fgov.ehealth.standards.kmehr.schema.v1.RecipeCDDRUGCNK;


/**
 * <p>Classe Java pour CD-DRUG-CNK complex type.
 * 
 * <p>Le fragment de schéma suivant indique le contenu attendu figurant dans cette classe.
 * 
 * <pre>
 * &lt;complexType name="CD-DRUG-CNK">
 *   &lt;simpleContent>
 *     &lt;extension base="&lt;http://www.ehealth.fgov.be/standards/kmehr/cd/v1>CD-DRUG-CNKvalues">
 *       &lt;attribute name="S" use="required" type="{http://www.ehealth.fgov.be/standards/kmehr/cd/v1}CD-DRUG-CNKschemes" />
...
@XmlType(name = "CD-DRUG-CNK", propOrder = {
    "value"
})
@XmlSeeAlso({
    RecipeCDDRUGCNK.class
})
public class CDDRUGCNK
    implements Serializable
{
     ...
     * @return
     *     possible object is
     *     {@link CDDRUGCNKschemes }
     *     
     */
    public CDDRUGCNKschemes getS() {
        return s;
    }
     ...
     *     
     */
    public void setS(CDDRUGCNKschemes value) {
        this.s = value;
    }
