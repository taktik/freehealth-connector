...
/**
 * <p>Classe Java pour CD-SITE complex type.
 * 
 * <p>Le fragment de schéma suivant indique le contenu attendu figurant dans cette classe.
 * 
 * <pre>
 * &lt;complexType name="CD-SITE">
 *   &lt;simpleContent>
 *     &lt;extension base="&lt;http://www.ehealth.fgov.be/standards/kmehr/cd/v1>CD-SITEvalues">
 *       &lt;attribute name="S" use="required" type="{http://www.w3.org/2001/XMLSchema}string" fixed="CD-SITE" />
...
@XmlType(name = "CD-SITE", propOrder = {
    "value"
})
public class CDSITE
    implements Serializable
{
    ...
    @XmlValue
    protected CDSITEvalues value;
    @XmlAttribute(name = "S", required = true)
    protected String s = "CD-SITE";
     ...
     *     
     */
    public void setValue(CDSITEvalues value) {
        this.value = value;
    }
