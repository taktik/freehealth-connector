...
/**
 * <p>Classe Java pour CD-BVT-PATIENTOPPOSITION complex type.
 * 
 * <p>Le fragment de schéma suivant indique le contenu attendu figurant dans cette classe.
 * 
 * <pre>
 * &lt;complexType name="CD-BVT-PATIENTOPPOSITION">
 *   &lt;simpleContent>
 *     &lt;extension base="&lt;http://www.ehealth.fgov.be/standards/kmehr/cd/v1>CD-BVT-PATIENTOPPOSITIONvalues">
 *       &lt;attribute name="S" use="required" type="{http://www.w3.org/2001/XMLSchema}string" fixed="CD-BVT-PATIENTOPPOSITION" />
...
@XmlType(name = "CD-BVT-PATIENTOPPOSITION", propOrder = {
    "value"
})
public class CDBVTPATIENTOPPOSITION
    implements Serializable
{

    private final static long serialVersionUID = 20150901L;
    @XmlValue
    protected CDBVTPATIENTOPPOSITIONvalues value;
    @XmlAttribute(name = "S", required = true)
    protected String s = "CD-BVT-PATIENTOPPOSITION";
     ...
     * @return
     *     possible object is
     *     {@link CDBVTPATIENTOPPOSITIONvalues }
     *
     */
    public CDBVTPATIENTOPPOSITIONvalues getValue() {
        return value;
    }
     ...
     *
     */
    public void setValue(CDBVTPATIENTOPPOSITIONvalues value) {
        this.value = value;
    }
    ...
    public String getS() {
        if (s == null) {
            return "CD-BVT-PATIENTOPPOSITION";
        } else {
            return s;
        }
    }
