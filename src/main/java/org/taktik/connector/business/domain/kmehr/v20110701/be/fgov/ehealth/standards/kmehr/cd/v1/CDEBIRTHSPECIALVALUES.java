...
/**
 * <p>Classe Java pour CD-EBIRTH-SPECIALVALUES complex type.
 * 
 * <p>Le fragment de schéma suivant indique le contenu attendu figurant dans cette classe.
 * 
 * <pre>
 * &lt;complexType name="CD-EBIRTH-SPECIALVALUES">
 *   &lt;simpleContent>
 *     &lt;extension base="&lt;http://www.ehealth.fgov.be/standards/kmehr/cd/v1>CD-EBIRTH-SPECIALVALUESvalues">
 *       &lt;attribute name="S" use="required" type="{http://www.w3.org/2001/XMLSchema}string" fixed="CD-EBIRTH-SPECIALVALUES" />
...
@XmlType(name = "CD-EBIRTH-SPECIALVALUES", propOrder = {
    "value"
})
public class CDEBIRTHSPECIALVALUES
    implements Serializable
{

    private final static long serialVersionUID = 20110701L;
    @XmlValue
    protected CDEBIRTHSPECIALVALUESvalues value;
    @XmlAttribute(name = "S", required = true)
    protected String s = "CD-EBIRTH-SPECIALVALUES";
     ...
     * @return
     *     possible object is
     *     {@link CDEBIRTHSPECIALVALUESvalues }
     *     
     */
    public CDEBIRTHSPECIALVALUESvalues getValue() {
        return value;
    }
     ...
     *     
     */
    public void setValue(CDEBIRTHSPECIALVALUESvalues value) {
        this.value = value;
    }
    ...
    public String getS() {
        if (s == null) {
            return "CD-EBIRTH-SPECIALVALUES";
        } else {
            return s;
        }
    }
