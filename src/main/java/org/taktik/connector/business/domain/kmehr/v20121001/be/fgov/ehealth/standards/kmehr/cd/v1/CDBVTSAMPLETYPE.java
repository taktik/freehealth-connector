...
/**
 * <p>Classe Java pour CD-BVT-SAMPLETYPE complex type.
 * 
 * <p>Le fragment de schéma suivant indique le contenu attendu figurant dans cette classe.
 * 
 * <pre>
 * &lt;complexType name="CD-BVT-SAMPLETYPE">
 *   &lt;simpleContent>
 *     &lt;extension base="&lt;http://www.ehealth.fgov.be/standards/kmehr/cd/v1>CD-BVT-SAMPLETYPEvalues">
 *       &lt;attribute name="S" use="required" type="{http://www.w3.org/2001/XMLSchema}string" fixed="CD-BVT-SAMPLETYPE" />
...
@XmlType(name = "CD-BVT-SAMPLETYPE", propOrder = {
    "value"
})
public class CDBVTSAMPLETYPE
    implements Serializable
{

    private final static long serialVersionUID = 20121001L;
    @XmlValue
    protected CDBVTSAMPLETYPEvalues value;
    @XmlAttribute(name = "S", required = true)
    protected String s = "CD-BVT-SAMPLETYPE";
     ...
     * @return
     *     possible object is
     *     {@link CDBVTSAMPLETYPEvalues }
     *     
     */
    public CDBVTSAMPLETYPEvalues getValue() {
        return value;
    }
     ...
     *     
     */
    public void setValue(CDBVTSAMPLETYPEvalues value) {
        this.value = value;
    }
