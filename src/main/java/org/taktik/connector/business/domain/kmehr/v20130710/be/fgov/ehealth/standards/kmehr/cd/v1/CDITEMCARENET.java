...
/**
 * <p>Classe Java pour CD-ITEM-CARENET complex type.
 * 
 * <p>Le fragment de schéma suivant indique le contenu attendu figurant dans cette classe.
 * 
 * <pre>
 * &lt;complexType name="CD-ITEM-CARENET">
 *   &lt;simpleContent>
 *     &lt;extension base="&lt;http://www.ehealth.fgov.be/standards/kmehr/cd/v1>CD-ITEM-CARENETvalues">
 *       &lt;attribute name="S" use="required" type="{http://www.w3.org/2001/XMLSchema}string" fixed="CD-ITEM-CARENET" />
...
@XmlType(name = "CD-ITEM-CARENET", propOrder = {
    "value"
})
public class CDITEMCARENET
    implements Serializable
{

    private final static long serialVersionUID = 20130710L;
    @XmlValue
    protected CDITEMCARENETvalues value;
    @XmlAttribute(name = "S", required = true)
    protected String s = "CD-ITEM-CARENET";
     ...
     * @return
     *     possible object is
     *     {@link CDITEMCARENETvalues }
     *     
     */
    public CDITEMCARENETvalues getValue() {
        return value;
    }
     ...
     *     
     */
    public void setValue(CDITEMCARENETvalues value) {
        this.value = value;
    }
