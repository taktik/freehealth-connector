...
/**
 * <p>Classe Java pour CD-BVT-CONSERVATIONMODE complex type.
 * 
 * <p>Le fragment de schéma suivant indique le contenu attendu figurant dans cette classe.
 * 
 * <pre>
 * &lt;complexType name="CD-BVT-CONSERVATIONMODE">
 *   &lt;simpleContent>
 *     &lt;extension base="&lt;http://www.ehealth.fgov.be/standards/kmehr/cd/v1>CD-BVT-CONSERVATIONMODEvalues">
 *       &lt;attribute name="S" use="required" type="{http://www.w3.org/2001/XMLSchema}string" fixed="CD-BVT-CONSERVATIONMODE" />
...
@XmlType(name = "CD-BVT-CONSERVATIONMODE", propOrder = {
    "value"
})
public class CDBVTCONSERVATIONMODE
    implements Serializable
{

    private final static long serialVersionUID = 20150901L;
    @XmlValue
    protected CDBVTCONSERVATIONMODEvalues value;
    @XmlAttribute(name = "S", required = true)
    protected String s = "CD-BVT-CONSERVATIONMODE";
     ...
     * @return
     *     possible object is
     *     {@link CDBVTCONSERVATIONMODEvalues }
     *
     */
    public CDBVTCONSERVATIONMODEvalues getValue() {
        return value;
    }
     ...
     *
     */
    public void setValue(CDBVTCONSERVATIONMODEvalues value) {
        this.value = value;
    }
    ...
    public String getS() {
        if (s == null) {
            return "CD-BVT-CONSERVATIONMODE";
        } else {
            return s;
        }
    }
