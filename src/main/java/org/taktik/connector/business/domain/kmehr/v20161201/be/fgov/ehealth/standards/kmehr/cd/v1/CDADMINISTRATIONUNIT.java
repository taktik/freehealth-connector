...
import org.taktik.connector.business.domain.kmehr.v20161201.be.fgov.ehealth.standards.kmehr.schema.v1.RecipeCDADMINISTRATIONUNIT;


/**
 * <p>Classe Java pour CD-ADMINISTRATIONUNIT complex type.
 * 
 * <p>Le fragment de schéma suivant indique le contenu attendu figurant dans cette classe.
 * 
 * <pre>
 * &lt;complexType name="CD-ADMINISTRATIONUNIT">
 *   &lt;simpleContent>
 *     &lt;extension base="&lt;http://www.ehealth.fgov.be/standards/kmehr/cd/v1>CD-ADMINISTRATIONUNITvalues">
 *       &lt;attribute name="S" use="required" type="{http://www.w3.org/2001/XMLSchema}string" fixed="CD-ADMINISTRATIONUNIT" />
...
@XmlType(name = "CD-ADMINISTRATIONUNIT", propOrder = {
    "value"
})
@XmlSeeAlso({
    RecipeCDADMINISTRATIONUNIT.class
})
public class CDADMINISTRATIONUNIT
