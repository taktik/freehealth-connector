...
/**
 * <p>Classe Java pour CD-MS-ORIGIN complex type.
 * 
 * <p>Le fragment de schéma suivant indique le contenu attendu figurant dans cette classe.
 * 
 * <pre>
 * &lt;complexType name="CD-MS-ORIGIN">
 *   &lt;simpleContent>
 *     &lt;extension base="&lt;http://www.ehealth.fgov.be/standards/kmehr/cd/v1>CD-MS-ORIGINvalues">
 *       &lt;attribute name="S" use="required" type="{http://www.w3.org/2001/XMLSchema}string" fixed="CD-MS-ORIGIN" />
...
@XmlType(name = "CD-MS-ORIGIN", propOrder = {
    "value"
})
public class CDMSORIGIN
    implements Serializable
{

    private final static long serialVersionUID = 20150901L;
    @XmlValue
    protected CDMSORIGINvalues value;
    @XmlAttribute(name = "S", required = true)
    protected String s = "CD-MS-ORIGIN";
     ...
     *     
     */
    public void setValue(CDMSORIGINvalues value) {
        this.value = value;
    }
