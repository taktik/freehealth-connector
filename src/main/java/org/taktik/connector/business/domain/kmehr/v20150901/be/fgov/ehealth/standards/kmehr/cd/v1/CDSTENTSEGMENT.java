...
/**
 * <p>Classe Java pour CD-STENT-SEGMENT complex type.
 * 
 * <p>Le fragment de schéma suivant indique le contenu attendu figurant dans cette classe.
 * 
 * <pre>
 * &lt;complexType name="CD-STENT-SEGMENT">
 *   &lt;simpleContent>
 *     &lt;extension base="&lt;http://www.ehealth.fgov.be/standards/kmehr/cd/v1>CD-STENT-SEGMENTvalues">
 *       &lt;attribute name="S" use="required" type="{http://www.w3.org/2001/XMLSchema}string" fixed="CD-STENT-SEGMENT" />
...
@XmlType(name = "CD-STENT-SEGMENT", propOrder = {
    "value"
})
public class CDSTENTSEGMENT
    implements Serializable
{

    private final static long serialVersionUID = 20150901L;
    @XmlValue
    protected CDSTENTSEGMENTvalues value;
    @XmlAttribute(name = "S", required = true)
    protected String s = "CD-STENT-SEGMENT";
     ...
     * @return
     *     possible object is
     *     {@link CDSTENTSEGMENTvalues }
     *
     */
    public CDSTENTSEGMENTvalues getValue() {
        return value;
    }
     ...
     *
     */
    public void setValue(CDSTENTSEGMENTvalues value) {
        this.value = value;
    }
