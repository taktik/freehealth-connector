...
/**
 * <p>Classe Java pour CD-CARENET-NATIONAL-INSURANCE complex type.
 * 
 * <p>Le fragment de schéma suivant indique le contenu attendu figurant dans cette classe.
 * 
 * <pre>
 * &lt;complexType name="CD-CARENET-NATIONAL-INSURANCE">
 *   &lt;simpleContent>
 *     &lt;extension base="&lt;http://www.ehealth.fgov.be/standards/kmehr/cd/v1>CD-CARENET-NATIONAL-INSURANCEvalues">
 *       &lt;attribute name="S" use="required" type="{http://www.w3.org/2001/XMLSchema}string" fixed="CD-CARENET-NATIONAL-INSURANCE" />
...
@XmlType(name = "CD-CARENET-NATIONAL-INSURANCE", propOrder = {
    "value"
})
public class CDCARENETNATIONALINSURANCE
    implements Serializable
{
    ...
    protected String s = "CD-CARENET-NATIONAL-INSURANCE";
    ...
    public String getS() {
        if (s == null) {
            return "CD-CARENET-NATIONAL-INSURANCE";
        } else {
            return s;
        }
    }
