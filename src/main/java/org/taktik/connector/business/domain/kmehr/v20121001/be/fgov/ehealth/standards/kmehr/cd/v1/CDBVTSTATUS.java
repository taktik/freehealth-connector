...
/**
 * <p>Classe Java pour CD-BVT-STATUS complex type.
 * 
 * <p>Le fragment de schéma suivant indique le contenu attendu figurant dans cette classe.
 * 
 * <pre>
 * &lt;complexType name="CD-BVT-STATUS">
 *   &lt;simpleContent>
 *     &lt;extension base="&lt;http://www.ehealth.fgov.be/standards/kmehr/cd/v1>CD-BVT-STATUSvalues">
 *       &lt;attribute name="S" use="required" type="{http://www.w3.org/2001/XMLSchema}string" fixed="CD-BVT-STATUS" />
...
@XmlType(name = "CD-BVT-STATUS", propOrder = {
    "value"
})
public class CDBVTSTATUS
    implements Serializable
{

    private final static long serialVersionUID = 20121001L;
    @XmlValue
    protected CDBVTSTATUSvalues value;
    @XmlAttribute(name = "S", required = true)
    protected String s = "CD-BVT-STATUS";
     ...
     * @return
     *     possible object is
     *     {@link CDBVTSTATUSvalues }
     *
     */
    public CDBVTSTATUSvalues getValue() {
        return value;
    }
     ...
     *
     */
    public void setValue(CDBVTSTATUSvalues value) {
        this.value = value;
    }
