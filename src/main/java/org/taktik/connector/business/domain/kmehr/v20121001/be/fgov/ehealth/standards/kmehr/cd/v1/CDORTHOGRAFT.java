...
/**
 * <p>Classe Java pour CD-ORTHO-GRAFT complex type.
 * 
 * <p>Le fragment de schéma suivant indique le contenu attendu figurant dans cette classe.
 * 
 * <pre>
 * &lt;complexType name="CD-ORTHO-GRAFT">
 *   &lt;simpleContent>
 *     &lt;extension base="&lt;http://www.ehealth.fgov.be/standards/kmehr/cd/v1>CD-ORTHO-GRAFTvalues">
 *       &lt;attribute name="S" use="required" type="{http://www.w3.org/2001/XMLSchema}string" fixed="CD-ORTHO-GRAFT" />
...
@XmlType(name = "CD-ORTHO-GRAFT", propOrder = {
    "value"
})
public class CDORTHOGRAFT
    implements Serializable
{

    private final static long serialVersionUID = 20121001L;
    @XmlValue
    protected CDORTHOGRAFTvalues value;
    @XmlAttribute(name = "S", required = true)
    protected String s = "CD-ORTHO-GRAFT";
     ...
     * @return
     *     possible object is
     *     {@link CDORTHOGRAFTvalues }
     *
     */
    public CDORTHOGRAFTvalues getValue() {
        return value;
    }
     ...
     *
     */
    public void setValue(CDORTHOGRAFTvalues value) {
        this.value = value;
    }
