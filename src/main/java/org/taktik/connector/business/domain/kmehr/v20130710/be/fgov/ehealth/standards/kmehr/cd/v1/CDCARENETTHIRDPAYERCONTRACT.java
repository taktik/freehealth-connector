...
/**
 * <p>Classe Java pour CD-CARENET-THIRDPAYER-CONTRACT complex type.
 * 
 * <p>Le fragment de schéma suivant indique le contenu attendu figurant dans cette classe.
 * 
 * <pre>
 * &lt;complexType name="CD-CARENET-THIRDPAYER-CONTRACT">
 *   &lt;simpleContent>
 *     &lt;extension base="&lt;http://www.ehealth.fgov.be/standards/kmehr/cd/v1>CD-CARENET-THIRDPAYER-CONTRACTvalues">
 *       &lt;attribute name="S" use="required" type="{http://www.w3.org/2001/XMLSchema}string" fixed="CD-CARENET-THIRDPAYER-CONTRACT" />
...
@XmlType(name = "CD-CARENET-THIRDPAYER-CONTRACT", propOrder = {
    "value"
})
    ...
    implements Serializable
{
    ...
    protected String s = "CD-CARENET-THIRDPAYER-CONTRACT";
    ...
    public String getS() {
        if (s == null) {
            return "CD-CARENET-THIRDPAYER-CONTRACT";
        } else {
            return s;
        }
    }
