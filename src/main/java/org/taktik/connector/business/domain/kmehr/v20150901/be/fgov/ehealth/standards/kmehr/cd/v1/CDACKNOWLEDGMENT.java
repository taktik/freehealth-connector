...
/**
 * <p>Classe Java pour CD-ACKNOWLEDGMENT complex type.
 * 
 * <p>Le fragment de schéma suivant indique le contenu attendu figurant dans cette classe.
 * 
 * <pre>
 * &lt;complexType name="CD-ACKNOWLEDGMENT">
 *   &lt;simpleContent>
 *     &lt;extension base="&lt;http://www.ehealth.fgov.be/standards/kmehr/cd/v1>CD-ACKNOWLEDGMENTvalues">
 *       &lt;attribute name="S" use="required" type="{http://www.w3.org/2001/XMLSchema}string" fixed="CD-ACKNOWLEDGMENT" />
...
@XmlType(name = "CD-ACKNOWLEDGMENT", propOrder = {
    "value"
})
    ...
    implements Serializable
{
    ...
    @XmlValue
    protected CDACKNOWLEDGMENTvalues value;
    @XmlAttribute(name = "S", required = true)
    protected String s = "CD-ACKNOWLEDGMENT";
     ...
     * @return
     *     possible object is
     *     {@link CDACKNOWLEDGMENTvalues }
     *
     */
    public CDACKNOWLEDGMENTvalues getValue() {
        return value;
    }
     ...
     *
     */
    public void setValue(CDACKNOWLEDGMENTvalues value) {
        this.value = value;
    }
