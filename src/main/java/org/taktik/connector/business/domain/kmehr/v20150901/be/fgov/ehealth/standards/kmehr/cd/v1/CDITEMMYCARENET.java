...
/**
 * <p>Classe Java pour CD-ITEM-MYCARENET complex type.
 * 
 * <p>Le fragment de schéma suivant indique le contenu attendu figurant dans cette classe.
 * 
 * <pre>
 * &lt;complexType name="CD-ITEM-MYCARENET">
 *   &lt;simpleContent>
 *     &lt;extension base="&lt;http://www.ehealth.fgov.be/standards/kmehr/cd/v1>CD-ITEM-MYCARENETvalues">
 *       &lt;attribute name="S" use="required" type="{http://www.w3.org/2001/XMLSchema}string" fixed="CD-ITEM-MYCARENET" />
...
@XmlType(name = "CD-ITEM-MYCARENET", propOrder = {
    "value"
})
public class CDITEMMYCARENET
    implements Serializable
{

    private final static long serialVersionUID = 20150901L;
    @XmlValue
    protected CDITEMMYCARENETvalues value;
    @XmlAttribute(name = "S", required = true)
    protected String s = "CD-ITEM-MYCARENET";
     ...
     * @return
     *     possible object is
     *     {@link CDITEMMYCARENETvalues }
     *
     */
    public CDITEMMYCARENETvalues getValue() {
        return value;
    }
     ...
     *
     */
    public void setValue(CDITEMMYCARENETvalues value) {
        this.value = value;
    }
