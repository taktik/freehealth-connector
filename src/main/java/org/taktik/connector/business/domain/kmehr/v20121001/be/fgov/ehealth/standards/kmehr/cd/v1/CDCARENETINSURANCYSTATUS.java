...
/**
 * <p>Classe Java pour CD-CARENET-INSURANCY-STATUS complex type.
 * 
 * <p>Le fragment de schéma suivant indique le contenu attendu figurant dans cette classe.
 * 
 * <pre>
 * &lt;complexType name="CD-CARENET-INSURANCY-STATUS">
 *   &lt;simpleContent>
 *     &lt;extension base="&lt;http://www.ehealth.fgov.be/standards/kmehr/cd/v1>CD-CARENET-INSURANCY-STATUSvalues">
 *       &lt;attribute name="S" use="required" type="{http://www.w3.org/2001/XMLSchema}string" fixed="CD-CARENET-INSURANCY-STATUS" />
...
@XmlType(name = "CD-CARENET-INSURANCY-STATUS", propOrder = {
    "value"
})
public class CDCARENETINSURANCYSTATUS
    implements Serializable
{
    ...
    protected String s = "CD-CARENET-INSURANCY-STATUS";
    ...
    public String getS() {
        if (s == null) {
            return "CD-CARENET-INSURANCY-STATUS";
        } else {
            return s;
        }
    }
