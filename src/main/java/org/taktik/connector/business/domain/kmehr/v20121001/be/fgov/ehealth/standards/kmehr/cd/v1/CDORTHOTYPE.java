...
/**
 * <p>Classe Java pour CD-ORTHO-TYPE complex type.
 * 
 * <p>Le fragment de schéma suivant indique le contenu attendu figurant dans cette classe.
 * 
 * <pre>
 * &lt;complexType name="CD-ORTHO-TYPE">
 *   &lt;simpleContent>
 *     &lt;extension base="&lt;http://www.ehealth.fgov.be/standards/kmehr/cd/v1>CD-ORTHO-TYPEvalues">
 *       &lt;attribute name="S" use="required" type="{http://www.w3.org/2001/XMLSchema}string" fixed="CD-ORTHO-TYPE" />
...
@XmlType(name = "CD-ORTHO-TYPE", propOrder = {
    "value"
})
public class CDORTHOTYPE
    implements Serializable
{

    private final static long serialVersionUID = 20121001L;
    @XmlValue
    protected CDORTHOTYPEvalues value;
    @XmlAttribute(name = "S", required = true)
    protected String s = "CD-ORTHO-TYPE";
     ...
     *
     */
    public void setValue(CDORTHOTYPEvalues value) {
        this.value = value;
    }
