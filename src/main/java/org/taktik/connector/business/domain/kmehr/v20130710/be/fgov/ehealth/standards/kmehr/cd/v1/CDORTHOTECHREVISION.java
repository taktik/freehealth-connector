...
/**
 * <p>Classe Java pour CD-ORTHO-TECHREVISION complex type.
 * 
 * <p>Le fragment de schéma suivant indique le contenu attendu figurant dans cette classe.
 * 
 * <pre>
 * &lt;complexType name="CD-ORTHO-TECHREVISION">
 *   &lt;simpleContent>
 *     &lt;extension base="&lt;http://www.ehealth.fgov.be/standards/kmehr/cd/v1>CD-ORTHO-TECHREVISIONvalues">
 *       &lt;attribute name="S" use="required" type="{http://www.w3.org/2001/XMLSchema}string" fixed="CD-ORTHO-TECHREVISION" />
...
@XmlType(name = "CD-ORTHO-TECHREVISION", propOrder = {
    "value"
})
public class CDORTHOTECHREVISION
    implements Serializable
{

    private final static long serialVersionUID = 20130710L;
    @XmlValue
    protected CDORTHOTECHREVISIONvalues value;
    @XmlAttribute(name = "S", required = true)
    protected String s = "CD-ORTHO-TECHREVISION";
     ...
     * @return
     *     possible object is
     *     {@link CDORTHOTECHREVISIONvalues }
     *
     */
    public CDORTHOTECHREVISIONvalues getValue() {
        return value;
    }
     ...
     *
     */
    public void setValue(CDORTHOTECHREVISIONvalues value) {
        this.value = value;
    }
