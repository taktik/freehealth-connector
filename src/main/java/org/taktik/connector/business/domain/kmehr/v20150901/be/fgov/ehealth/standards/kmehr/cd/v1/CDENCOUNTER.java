...
/**
 * <p>Classe Java pour CD-ENCOUNTER complex type.
 * 
 * <p>Le fragment de schéma suivant indique le contenu attendu figurant dans cette classe.
 * 
 * <pre>
 * &lt;complexType name="CD-ENCOUNTER">
 *   &lt;simpleContent>
 *     &lt;extension base="&lt;http://www.ehealth.fgov.be/standards/kmehr/cd/v1>CD-ENCOUNTERvalues">
 *       &lt;attribute name="S" use="required" type="{http://www.w3.org/2001/XMLSchema}string" fixed="CD-ENCOUNTER" />
...
@XmlType(name = "CD-ENCOUNTER", propOrder = {
    "value"
})
public class CDENCOUNTER
    implements Serializable
{

    private final static long serialVersionUID = 20150901L;
    @XmlValue
    protected CDENCOUNTERvalues value;
    @XmlAttribute(name = "S", required = true)
    protected String s = "CD-ENCOUNTER";
     ...
     * @return
     *     possible object is
     *     {@link CDENCOUNTERvalues }
     *
     */
    public CDENCOUNTERvalues getValue() {
        return value;
    }
     ...
     *
     */
    public void setValue(CDENCOUNTERvalues value) {
        this.value = value;
    }
