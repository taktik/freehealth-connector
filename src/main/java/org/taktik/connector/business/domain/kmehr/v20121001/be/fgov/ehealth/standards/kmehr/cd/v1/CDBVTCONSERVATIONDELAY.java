...
/**
 * <p>Classe Java pour CD-BVT-CONSERVATIONDELAY complex type.
 * 
 * <p>Le fragment de schéma suivant indique le contenu attendu figurant dans cette classe.
 * 
 * <pre>
 * &lt;complexType name="CD-BVT-CONSERVATIONDELAY">
 *   &lt;simpleContent>
 *     &lt;extension base="&lt;http://www.ehealth.fgov.be/standards/kmehr/cd/v1>CD-BVT-CONSERVATIONDELAYvalues">
 *       &lt;attribute name="S" use="required" type="{http://www.w3.org/2001/XMLSchema}string" fixed="CD-BVT-CONSERVATIONDELAY" />
...
@XmlType(name = "CD-BVT-CONSERVATIONDELAY", propOrder = {
    "value"
})
public class CDBVTCONSERVATIONDELAY
    implements Serializable
{

    private final static long serialVersionUID = 20121001L;
    @XmlValue
    protected CDBVTCONSERVATIONDELAYvalues value;
    @XmlAttribute(name = "S", required = true)
    protected String s = "CD-BVT-CONSERVATIONDELAY";
     ...
     * @return
     *     possible object is
     *     {@link CDBVTCONSERVATIONDELAYvalues }
     *
     */
    public CDBVTCONSERVATIONDELAYvalues getValue() {
        return value;
    }
     ...
     *
     */
    public void setValue(CDBVTCONSERVATIONDELAYvalues value) {
        this.value = value;
    }
    ...
    public String getS() {
        if (s == null) {
            return "CD-BVT-CONSERVATIONDELAY";
        } else {
            return s;
        }
    }
