...
/**
 * <p>Classe Java pour CD-HEADING-REG complex type.
 * 
 * <p>Le fragment de schéma suivant indique le contenu attendu figurant dans cette classe.
 * 
 * <pre>
 * &lt;complexType name="CD-HEADING-REG">
 *   &lt;simpleContent>
 *     &lt;extension base="&lt;http://www.ehealth.fgov.be/standards/kmehr/cd/v1>CD-HEADING-REGvalues">
 *       &lt;attribute name="S" use="required" type="{http://www.w3.org/2001/XMLSchema}string" fixed="CD-HEADING-REG" />
...
@XmlType(name = "CD-HEADING-REG", propOrder = {
    "value"
})
public class CDHEADINGREG
    implements Serializable
{

    private final static long serialVersionUID = 20150901L;
    @XmlValue
    protected CDHEADINGREGvalues value;
    @XmlAttribute(name = "S", required = true)
    protected String s = "CD-HEADING-REG";
     ...
     * @return
     *     possible object is
     *     {@link CDHEADINGREGvalues }
     *
     */
    public CDHEADINGREGvalues getValue() {
        return value;
    }
     ...
     *
     */
    public void setValue(CDHEADINGREGvalues value) {
        this.value = value;
    }
