...
/**
 * <p>Classe Java pour CD-ITEM-EBIRTH complex type.
 * 
 * <p>Le fragment de schéma suivant indique le contenu attendu figurant dans cette classe.
 * 
 * <pre>
 * &lt;complexType name="CD-ITEM-EBIRTH">
 *   &lt;simpleContent>
 *     &lt;extension base="&lt;http://www.ehealth.fgov.be/standards/kmehr/cd/v1>CD-ITEM-EBIRTHvalues">
 *       &lt;attribute name="S" use="required" type="{http://www.w3.org/2001/XMLSchema}string" fixed="CD-ITEM-EBIRTH" />
...
@XmlType(name = "CD-ITEM-EBIRTH", propOrder = {
    "value"
})
public class CDITEMEBIRTH
    implements Serializable
{

    private final static long serialVersionUID = 20130710L;
    @XmlValue
    protected CDITEMEBIRTHvalues value;
    @XmlAttribute(name = "S", required = true)
    protected String s = "CD-ITEM-EBIRTH";
     ...
     * @return
     *     possible object is
     *     {@link CDITEMEBIRTHvalues }
     *     
     */
    public CDITEMEBIRTHvalues getValue() {
        return value;
    }
     ...
     *     
     */
    public void setValue(CDITEMEBIRTHvalues value) {
        this.value = value;
    }
