...
import org.taktik.connector.business.domain.kmehr.v20190301.be.fgov.ehealth.standards.kmehr.cd.v1.CDCARENETPERSONALPART;
import org.taktik.connector.business.domain.kmehr.v20190301.be.fgov.ehealth.standards.kmehr.cd.v1.CDCARENETTHIRDPAYERCONTRACT;
import org.taktik.connector.business.domain.kmehr.v20190301.be.fgov.ehealth.standards.kmehr.id.v1.IDINSURANCE;
    ...
    implements Serializable
{
    ...
    public List<Personalpart> getPersonalparts() {
        if (personalparts == null) {
            personalparts = new ArrayList<Personalpart>();
        }
