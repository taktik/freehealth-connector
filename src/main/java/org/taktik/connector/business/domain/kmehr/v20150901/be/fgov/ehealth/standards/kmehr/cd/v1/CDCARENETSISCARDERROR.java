...
/**
 * <p>Classe Java pour CD-CARENET-SISCARD-ERROR complex type.
 * 
 * <p>Le fragment de schéma suivant indique le contenu attendu figurant dans cette classe.
 * 
 * <pre>
 * &lt;complexType name="CD-CARENET-SISCARD-ERROR">
 *   &lt;simpleContent>
 *     &lt;extension base="&lt;http://www.ehealth.fgov.be/standards/kmehr/cd/v1>CD-CARENET-SISCARD-ERRORvalues">
 *       &lt;attribute name="S" use="required" type="{http://www.w3.org/2001/XMLSchema}string" fixed="CD-CARENET-SISCARD-ERROR" />
...
@XmlType(name = "CD-CARENET-SISCARD-ERROR", propOrder = {
    "value"
})
public class CDCARENETSISCARDERROR
    implements Serializable
{
    ...
    protected String s = "CD-CARENET-SISCARD-ERROR";
    ...
    public String getS() {
        if (s == null) {
            return "CD-CARENET-SISCARD-ERROR";
        } else {
            return s;
        }
    }
