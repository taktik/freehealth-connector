...
/**
 * <p>Classe Java pour CD-TUCO-STEMITYPE complex type.
 * 
 * <p>Le fragment de schéma suivant indique le contenu attendu figurant dans cette classe.
 * 
 * <pre>
 * &lt;complexType name="CD-TUCO-STEMITYPE">
 *   &lt;simpleContent>
 *     &lt;extension base="&lt;http://www.ehealth.fgov.be/standards/kmehr/cd/v1>CD-TUCO-STEMITYPEvalues">
 *       &lt;attribute name="S" use="required" type="{http://www.w3.org/2001/XMLSchema}string" fixed="CD-TUCO-STEMITYPE" />
...
@XmlType(name = "CD-TUCO-STEMITYPE", propOrder = {
    "value"
})
public class CDTUCOSTEMITYPE
    implements Serializable
{

    private final static long serialVersionUID = 20150901L;
    @XmlValue
    protected CDTUCOSTEMITYPEvalues value;
    @XmlAttribute(name = "S", required = true)
    protected String s = "CD-TUCO-STEMITYPE";
     ...
     * @return
     *     possible object is
     *     {@link CDTUCOSTEMITYPEvalues }
     *     
     */
    public CDTUCOSTEMITYPEvalues getValue() {
        return value;
    }
     ...
     *     
     */
    public void setValue(CDTUCOSTEMITYPEvalues value) {
        this.value = value;
    }
