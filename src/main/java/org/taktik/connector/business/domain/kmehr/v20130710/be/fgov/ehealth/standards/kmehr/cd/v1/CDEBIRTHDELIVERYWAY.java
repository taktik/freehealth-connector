...
/**
 * <p>Classe Java pour CD-EBIRTH-DELIVERYWAY complex type.
 * 
 * <p>Le fragment de schéma suivant indique le contenu attendu figurant dans cette classe.
 * 
 * <pre>
 * &lt;complexType name="CD-EBIRTH-DELIVERYWAY">
 *   &lt;simpleContent>
 *     &lt;extension base="&lt;http://www.ehealth.fgov.be/standards/kmehr/cd/v1>CD-EBIRTH-DELIVERYWAYvalues">
 *       &lt;attribute name="S" use="required" type="{http://www.w3.org/2001/XMLSchema}string" fixed="CD-EBIRTH-DELIVERYWAY" />
...
@XmlType(name = "CD-EBIRTH-DELIVERYWAY", propOrder = {
    "value"
})
public class CDEBIRTHDELIVERYWAY
    implements Serializable
{

    private final static long serialVersionUID = 20130710L;
    @XmlValue
    protected CDEBIRTHDELIVERYWAYvalues value;
    @XmlAttribute(name = "S", required = true)
    protected String s = "CD-EBIRTH-DELIVERYWAY";
     ...
     * @return
     *     possible object is
     *     {@link CDEBIRTHDELIVERYWAYvalues }
     *     
     */
    public CDEBIRTHDELIVERYWAYvalues getValue() {
        return value;
    }
     ...
     *     
     */
    public void setValue(CDEBIRTHDELIVERYWAYvalues value) {
        this.value = value;
    }
