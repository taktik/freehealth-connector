...
/**
 * <p>Classe Java pour CD-PATIENTWILL complex type.
 * 
 * <p>Le fragment de schéma suivant indique le contenu attendu figurant dans cette classe.
 * 
 * <pre>
 * &lt;complexType name="CD-PATIENTWILL">
 *   &lt;simpleContent>
 *     &lt;extension base="&lt;http://www.ehealth.fgov.be/standards/kmehr/cd/v1>CD-PATIENTWILLvalues">
 *       &lt;attribute name="S" use="required" type="{http://www.w3.org/2001/XMLSchema}string" fixed="CD-PATIENTWILL" />
...
@XmlType(name = "CD-PATIENTWILL", propOrder = {
    "value"
})
public class CDPATIENTWILL
    implements Serializable
{

    private final static long serialVersionUID = 20121001L;
    @XmlValue
    protected CDPATIENTWILLvalues value;
    @XmlAttribute(name = "S", required = true)
    protected String s = "CD-PATIENTWILL";
     ...
     * @return
     *     possible object is
     *     {@link CDPATIENTWILLvalues }
     *
     */
    public CDPATIENTWILLvalues getValue() {
        return value;
    }
     ...
     *
     */
    public void setValue(CDPATIENTWILLvalues value) {
        this.value = value;
    }
