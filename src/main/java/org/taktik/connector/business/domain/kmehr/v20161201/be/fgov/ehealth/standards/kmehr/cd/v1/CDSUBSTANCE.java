 ...
 *       &lt;attribute name="S" use="required" type="{http://www.ehealth.fgov.be/standards/kmehr/cd/v1}CD-SUBSTANCEschemes" />
...
@XmlSeeAlso({
    RecipeCDSUBSTANCE.class
})
public class CDSUBSTANCE
    implements Serializable
{
    ...
    protected CDSUBSTANCEschemes s;
