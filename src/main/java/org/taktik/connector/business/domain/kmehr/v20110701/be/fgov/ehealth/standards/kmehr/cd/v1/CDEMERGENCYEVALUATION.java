...
/**
 * <p>Classe Java pour CD-EMERGENCYEVALUATION complex type.
 * 
 * <p>Le fragment de schéma suivant indique le contenu attendu figurant dans cette classe.
 * 
 * <pre>
 * &lt;complexType name="CD-EMERGENCYEVALUATION">
 *   &lt;simpleContent>
 *     &lt;extension base="&lt;http://www.ehealth.fgov.be/standards/kmehr/cd/v1>CD-EMERGENCYEVALUATIONvalues">
 *       &lt;attribute name="S" use="required" type="{http://www.w3.org/2001/XMLSchema}string" fixed="CD-EMERGENCYEVALUATION" />
...
@XmlType(name = "CD-EMERGENCYEVALUATION", propOrder = {
    "value"
})
public class CDEMERGENCYEVALUATION
    implements Serializable
{

    private final static long serialVersionUID = 20110701L;
    @XmlValue
    protected CDEMERGENCYEVALUATIONvalues value;
    @XmlAttribute(name = "S", required = true)
    protected String s = "CD-EMERGENCYEVALUATION";
     ...
     * @return
     *     possible object is
     *     {@link CDEMERGENCYEVALUATIONvalues }
     *     
     */
    public CDEMERGENCYEVALUATIONvalues getValue() {
        return value;
    }
     ...
     *     
     */
    public void setValue(CDEMERGENCYEVALUATIONvalues value) {
        this.value = value;
    }
