...
/**
 * <p>Classe Java pour CD-MICROORGANISM complex type.
 * 
 * <p>Le fragment de schéma suivant indique le contenu attendu figurant dans cette classe.
 * 
 * <pre>
 * &lt;complexType name="CD-MICROORGANISM">
 *   &lt;simpleContent>
 *     &lt;extension base="&lt;http://www.ehealth.fgov.be/standards/kmehr/cd/v1>CD-MICROORGANISMvalues">
 *       &lt;attribute name="S" use="required" type="{http://www.w3.org/2001/XMLSchema}string" fixed="CD-MICROORGANISM" />
...
@XmlType(name = "CD-MICROORGANISM", propOrder = {
    "value"
})
public class CDMICROORGANISM
    implements Serializable
{

    private final static long serialVersionUID = 20130710L;
    @XmlValue
    protected CDMICROORGANISMvalues value;
    @XmlAttribute(name = "S", required = true)
    protected String s = "CD-MICROORGANISM";
     ...
     * @return
     *     possible object is
     *     {@link CDMICROORGANISMvalues }
     *
     */
    public CDMICROORGANISMvalues getValue() {
        return value;
    }
     ...
     *
     */
    public void setValue(CDMICROORGANISMvalues value) {
        this.value = value;
    }
