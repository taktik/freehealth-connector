...
/**
 * <p>Classe Java pour CD-CHAPTER4DOCUMENTSEQAPPENDIX complex type.
 * 
 * <p>Le fragment de schéma suivant indique le contenu attendu figurant dans cette classe.
 * 
 * <pre>
 * &lt;complexType name="CD-CHAPTER4DOCUMENTSEQAPPENDIX">
 *   &lt;simpleContent>
 *     &lt;extension base="&lt;http://www.ehealth.fgov.be/standards/kmehr/cd/v1>CD-CHAPTER4DOCUMENTSEQAPPENDIXvalues">
 *       &lt;attribute name="S" use="required" type="{http://www.w3.org/2001/XMLSchema}string" fixed="CD-CHAPTER4DOCUMENTSEQAPPENDIX" />
...
@XmlType(name = "CD-CHAPTER4DOCUMENTSEQAPPENDIX", propOrder = {
    "value"
})
public class CDCHAPTER4DOCUMENTSEQAPPENDIX
    implements Serializable
{
    ...
    protected String s = "CD-CHAPTER4DOCUMENTSEQAPPENDIX";
    ...
    public String getS() {
        if (s == null) {
            return "CD-CHAPTER4DOCUMENTSEQAPPENDIX";
        } else {
            return s;
        }
    }
