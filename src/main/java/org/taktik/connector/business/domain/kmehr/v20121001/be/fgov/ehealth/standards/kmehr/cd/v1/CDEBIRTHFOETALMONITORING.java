...
/**
 * <p>Classe Java pour CD-EBIRTH-FOETALMONITORING complex type.
 * 
 * <p>Le fragment de schéma suivant indique le contenu attendu figurant dans cette classe.
 * 
 * <pre>
 * &lt;complexType name="CD-EBIRTH-FOETALMONITORING">
 *   &lt;simpleContent>
 *     &lt;extension base="&lt;http://www.ehealth.fgov.be/standards/kmehr/cd/v1>CD-EBIRTH-FOETALMONITORINGvalues">
 *       &lt;attribute name="S" use="required" type="{http://www.w3.org/2001/XMLSchema}string" fixed="CD-EBIRTH-FOETALMONITORING" />
...
@XmlType(name = "CD-EBIRTH-FOETALMONITORING", propOrder = {
    "value"
})
public class CDEBIRTHFOETALMONITORING
    implements Serializable
{

    private final static long serialVersionUID = 20121001L;
    @XmlValue
    protected CDEBIRTHFOETALMONITORINGvalues value;
    @XmlAttribute(name = "S", required = true)
    protected String s = "CD-EBIRTH-FOETALMONITORING";
     ...
     * @return
     *     possible object is
     *     {@link CDEBIRTHFOETALMONITORINGvalues }
     *
     */
    public CDEBIRTHFOETALMONITORINGvalues getValue() {
        return value;
    }
     ...
     *
     */
    public void setValue(CDEBIRTHFOETALMONITORINGvalues value) {
        this.value = value;
    }
    ...
    public String getS() {
        if (s == null) {
            return "CD-EBIRTH-FOETALMONITORING";
        } else {
            return s;
        }
    }
