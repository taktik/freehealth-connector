...
/**
 * <p>Classe Java pour CD-TRANSACTION-REG complex type.
 * 
 * <p>Le fragment de schéma suivant indique le contenu attendu figurant dans cette classe.
 * 
 * <pre>
 * &lt;complexType name="CD-TRANSACTION-REG">
 *   &lt;simpleContent>
 *     &lt;extension base="&lt;http://www.ehealth.fgov.be/standards/kmehr/cd/v1>CD-TRANSACTION-REGvalues">
 *       &lt;attribute name="S" use="required" type="{http://www.w3.org/2001/XMLSchema}string" fixed="CD-TRANSACTION-REG" />
...
@XmlType(name = "CD-TRANSACTION-REG", propOrder = {
    "value"
})
public class CDTRANSACTIONREG
    implements Serializable
{

    private final static long serialVersionUID = 20121001L;
    @XmlValue
    protected CDTRANSACTIONREGvalues value;
    @XmlAttribute(name = "S", required = true)
    protected String s = "CD-TRANSACTION-REG";
     ...
     * @return
     *     possible object is
     *     {@link CDTRANSACTIONREGvalues }
     *
     */
    public CDTRANSACTIONREGvalues getValue() {
        return value;
    }
     ...
     *
     */
    public void setValue(CDTRANSACTIONREGvalues value) {
        this.value = value;
    }
