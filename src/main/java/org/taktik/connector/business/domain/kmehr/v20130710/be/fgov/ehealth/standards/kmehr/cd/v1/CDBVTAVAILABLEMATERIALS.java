...
/**
 * <p>Classe Java pour CD-BVT-AVAILABLEMATERIALS complex type.
 * 
 * <p>Le fragment de schéma suivant indique le contenu attendu figurant dans cette classe.
 * 
 * <pre>
 * &lt;complexType name="CD-BVT-AVAILABLEMATERIALS">
 *   &lt;simpleContent>
 *     &lt;extension base="&lt;http://www.ehealth.fgov.be/standards/kmehr/cd/v1>CD-BVT-AVAILABLEMATERIALSvalues">
 *       &lt;attribute name="S" use="required" type="{http://www.w3.org/2001/XMLSchema}string" fixed="CD-BVT-AVAILABLEMATERIALS" />
...
@XmlType(name = "CD-BVT-AVAILABLEMATERIALS", propOrder = {
    "value"
})
public class CDBVTAVAILABLEMATERIALS
    implements Serializable
{

    private final static long serialVersionUID = 20130710L;
    @XmlValue
    protected CDBVTAVAILABLEMATERIALSvalues value;
    @XmlAttribute(name = "S", required = true)
    protected String s = "CD-BVT-AVAILABLEMATERIALS";
     ...
     * @return
     *     possible object is
     *     {@link CDBVTAVAILABLEMATERIALSvalues }
     *
     */
    public CDBVTAVAILABLEMATERIALSvalues getValue() {
        return value;
    }
     ...
     *
     */
    public void setValue(CDBVTAVAILABLEMATERIALSvalues value) {
        this.value = value;
    }
    ...
    public String getS() {
        if (s == null) {
            return "CD-BVT-AVAILABLEMATERIALS";
        } else {
            return s;
        }
    }
