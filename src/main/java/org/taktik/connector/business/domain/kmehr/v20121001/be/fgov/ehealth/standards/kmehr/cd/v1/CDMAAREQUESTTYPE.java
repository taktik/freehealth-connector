...
/**
 * <p>Classe Java pour CD-MAA-REQUESTTYPE complex type.
 * 
 * <p>Le fragment de schéma suivant indique le contenu attendu figurant dans cette classe.
 * 
 * <pre>
 * &lt;complexType name="CD-MAA-REQUESTTYPE">
 *   &lt;simpleContent>
 *     &lt;extension base="&lt;http://www.ehealth.fgov.be/standards/kmehr/cd/v1>CD-MAA-REQUESTTYPEvalues">
 *       &lt;attribute name="S" use="required" type="{http://www.w3.org/2001/XMLSchema}string" fixed="CD-MAA-REQUESTTYPE" />
...
@XmlType(name = "CD-MAA-REQUESTTYPE", propOrder = {
    "value"
})
public class CDMAAREQUESTTYPE
    implements Serializable
{

    private final static long serialVersionUID = 20121001L;
    @XmlValue
    protected CDMAAREQUESTTYPEvalues value;
    @XmlAttribute(name = "S", required = true)
    protected String s = "CD-MAA-REQUESTTYPE";
     ...
     * @return
     *     possible object is
     *     {@link CDMAAREQUESTTYPEvalues }
     *
     */
    public CDMAAREQUESTTYPEvalues getValue() {
        return value;
    }
     ...
     *
     */
    public void setValue(CDMAAREQUESTTYPEvalues value) {
        this.value = value;
    }
