...
/**
 * <p>Classe Java pour CD-EBIRTH-CAESAREANINDICATION complex type.
 * 
 * <p>Le fragment de schéma suivant indique le contenu attendu figurant dans cette classe.
 * 
 * <pre>
 * &lt;complexType name="CD-EBIRTH-CAESAREANINDICATION">
 *   &lt;simpleContent>
 *     &lt;extension base="&lt;http://www.ehealth.fgov.be/standards/kmehr/cd/v1>CD-EBIRTH-CAESAREANINDICATIONvalues">
 *       &lt;attribute name="S" use="required" type="{http://www.w3.org/2001/XMLSchema}string" fixed="CD-EBIRTH-CAESAREANINDICATION" />
...
@XmlType(name = "CD-EBIRTH-CAESAREANINDICATION", propOrder = {
    "value"
})
public class CDEBIRTHCAESAREANINDICATION
    implements Serializable
{

    private final static long serialVersionUID = 20150901L;
    @XmlValue
    protected CDEBIRTHCAESAREANINDICATIONvalues value;
    @XmlAttribute(name = "S", required = true)
    protected String s = "CD-EBIRTH-CAESAREANINDICATION";
     ...
     * @return
     *     possible object is
     *     {@link CDEBIRTHCAESAREANINDICATIONvalues }
     *     
     */
    public CDEBIRTHCAESAREANINDICATIONvalues getValue() {
        return value;
    }
     ...
     *     
     */
    public void setValue(CDEBIRTHCAESAREANINDICATIONvalues value) {
        this.value = value;
    }
    ...
    public String getS() {
        if (s == null) {
            return "CD-EBIRTH-CAESAREANINDICATION";
        } else {
            return s;
        }
    }
