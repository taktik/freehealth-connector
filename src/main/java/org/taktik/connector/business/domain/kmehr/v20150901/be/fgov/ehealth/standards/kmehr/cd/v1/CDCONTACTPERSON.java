...
/**
 * <p>Classe Java pour CD-CONTACT-PERSON complex type.
 * 
 * <p>Le fragment de schéma suivant indique le contenu attendu figurant dans cette classe.
 * 
 * <pre>
 * &lt;complexType name="CD-CONTACT-PERSON">
 *   &lt;simpleContent>
 *     &lt;extension base="&lt;http://www.ehealth.fgov.be/standards/kmehr/cd/v1>CD-CONTACT-PERSONvalues">
 *       &lt;attribute name="S" use="required" type="{http://www.w3.org/2001/XMLSchema}string" fixed="CD-CONTACT-PERSON" />
...
@XmlType(name = "CD-CONTACT-PERSON", propOrder = {
    "value"
})
public class CDCONTACTPERSON
    implements Serializable
{

    private final static long serialVersionUID = 20150901L;
    @XmlValue
    protected CDCONTACTPERSONvalues value;
    @XmlAttribute(name = "S", required = true)
    protected String s = "CD-CONTACT-PERSON";
     ...
     * @return
     *     possible object is
     *     {@link CDCONTACTPERSONvalues }
     *     
     */
    public CDCONTACTPERSONvalues getValue() {
        return value;
    }
     ...
     *     
     */
    public void setValue(CDCONTACTPERSONvalues value) {
        this.value = value;
    }
