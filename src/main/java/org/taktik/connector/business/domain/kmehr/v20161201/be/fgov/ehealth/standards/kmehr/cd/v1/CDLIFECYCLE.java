...
import org.taktik.connector.business.domain.kmehr.v20161201.be.fgov.ehealth.standards.kmehr.schema.v1.RecipeCDLIFECYCLE;


/**
 * <p>Classe Java pour CD-LIFECYCLE complex type.
 * 
 * <p>Le fragment de schéma suivant indique le contenu attendu figurant dans cette classe.
 * 
 * <pre>
 * &lt;complexType name="CD-LIFECYCLE">
 *   &lt;simpleContent>
 *     &lt;extension base="&lt;http://www.ehealth.fgov.be/standards/kmehr/cd/v1>CD-LIFECYCLEvalues">
 *       &lt;attribute name="S" use="required" type="{http://www.w3.org/2001/XMLSchema}string" fixed="CD-LIFECYCLE" />
...
@XmlType(name = "CD-LIFECYCLE", propOrder = {
    "value"
})
@XmlSeeAlso({
    RecipeCDLIFECYCLE.class
})
