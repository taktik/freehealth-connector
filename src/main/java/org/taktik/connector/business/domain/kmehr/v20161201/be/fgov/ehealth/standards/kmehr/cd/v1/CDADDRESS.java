...
import org.taktik.connector.business.domain.kmehr.v20161201.be.fgov.ehealth.standards.kmehr.schema.v1.RecipeCDADDRESS;
import org.taktik.connector.business.domain.kmehr.v20161201.be.fgov.ehealth.standards.kmehr.schema.v1.RecipeauthorCDADDRESS;


/**
 * <p>Classe Java pour CD-ADDRESS complex type.
 * 
 * <p>Le fragment de schéma suivant indique le contenu attendu figurant dans cette classe.
 * 
 * <pre>
 * &lt;complexType name="CD-ADDRESS">
 *   &lt;simpleContent>
 *     &lt;extension base="&lt;http://www.w3.org/2001/XMLSchema>string">
 *       &lt;attribute name="S" use="required" type="{http://www.ehealth.fgov.be/standards/kmehr/cd/v1}CD-ADDRESSschemes" />
...
@XmlType(name = "CD-ADDRESS", propOrder = {
    "value"
})
@XmlSeeAlso({
    RecipeCDADDRESS.class,
    RecipeauthorCDADDRESS.class
})
    ...
    implements Serializable
{
     ...
     * @return
     *     possible object is
     *     {@link CDADDRESSschemes }
     *     
     */
    public CDADDRESSschemes getS() {
        return s;
    }
     ...
     *     
     */
    public void setS(CDADDRESSschemes value) {
        this.s = value;
    }
