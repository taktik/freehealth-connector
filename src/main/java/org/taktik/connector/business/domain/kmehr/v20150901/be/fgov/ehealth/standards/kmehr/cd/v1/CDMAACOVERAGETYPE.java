...
/**
 * <p>Classe Java pour CD-MAA-COVERAGETYPE complex type.
 * 
 * <p>Le fragment de schéma suivant indique le contenu attendu figurant dans cette classe.
 * 
 * <pre>
 * &lt;complexType name="CD-MAA-COVERAGETYPE">
 *   &lt;simpleContent>
 *     &lt;extension base="&lt;http://www.ehealth.fgov.be/standards/kmehr/cd/v1>CD-MAA-COVERAGETYPEvalues">
 *       &lt;attribute name="S" use="required" type="{http://www.w3.org/2001/XMLSchema}string" fixed="CD-MAA-COVERAGETYPE" />
...
@XmlType(name = "CD-MAA-COVERAGETYPE", propOrder = {
    "value"
})
public class CDMAACOVERAGETYPE
    implements Serializable
{

    private final static long serialVersionUID = 20150901L;
    @XmlValue
    protected CDMAACOVERAGETYPEvalues value;
    @XmlAttribute(name = "S", required = true)
    protected String s = "CD-MAA-COVERAGETYPE";
     ...
     * @return
     *     possible object is
     *     {@link CDMAACOVERAGETYPEvalues }
     *     
     */
    public CDMAACOVERAGETYPEvalues getValue() {
        return value;
    }
     ...
     *     
     */
    public void setValue(CDMAACOVERAGETYPEvalues value) {
        this.value = value;
    }
