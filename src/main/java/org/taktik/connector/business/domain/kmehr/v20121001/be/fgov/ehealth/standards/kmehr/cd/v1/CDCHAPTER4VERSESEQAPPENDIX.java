...
/**
 * <p>Classe Java pour CD-CHAPTER4VERSESEQAPPENDIX complex type.
 * 
 * <p>Le fragment de schéma suivant indique le contenu attendu figurant dans cette classe.
 * 
 * <pre>
 * &lt;complexType name="CD-CHAPTER4VERSESEQAPPENDIX">
 *   &lt;simpleContent>
 *     &lt;extension base="&lt;http://www.ehealth.fgov.be/standards/kmehr/cd/v1>CD-CHAPTER4VERSESEQAPPENDIXvalues">
 *       &lt;attribute name="S" use="required" type="{http://www.w3.org/2001/XMLSchema}string" fixed="CD-CHAPTER4VERSESEQAPPENDIX" />
...
@XmlType(name = "CD-CHAPTER4VERSESEQAPPENDIX", propOrder = {
    "value"
})
public class CDCHAPTER4VERSESEQAPPENDIX
    implements Serializable
{
    ...
    protected String s = "CD-CHAPTER4VERSESEQAPPENDIX";
    ...
    public String getS() {
        if (s == null) {
            return "CD-CHAPTER4VERSESEQAPPENDIX";
        } else {
            return s;
        }
    }
