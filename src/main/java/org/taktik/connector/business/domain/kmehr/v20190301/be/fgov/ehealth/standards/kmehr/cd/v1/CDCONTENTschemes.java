 ...
 *     &lt;enumeration value="CD-LEGALREFERENCE"/>
 *     &lt;enumeration value="CD-LEGALTEXT"/>
 *     &lt;enumeration value="CD-FORMALINTERPRETATION"/>
 *     &lt;enumeration value="CD-REIMBURSEMENT-TERM-PARAMETER"/>
 *     &lt;enumeration value="CD-REIMBURSEMENT-CONTEXT-ENVIRONMENT"/>
 *   &lt;/restriction>
 * &lt;/simpleType>
 * </pre>
 *
...
public enum CDCONTENTschemes {
    ...
    CD_VACCINEINDICATION("CD-VACCINEINDICATION", "1.1"),
    @XmlEnumValue("CD-ATC")
    CD_ATC("CD-ATC", "1.0"),
    ...
    CD_LEGALREFERENCE("CD-LEGALREFERENCE", "1.0"),
    @XmlEnumValue("CD-LEGALTEXT")
    CD_LEGALTEXT("CD-LEGALTEXT", "1.0"),
    @XmlEnumValue("CD-FORMALINTERPRETATION")
    CD_FORMALINTERPRETATION("CD-FORMALINTERPRETATION", "1.0"),
    @XmlEnumValue("CD-REIMBURSEMENT-TERM-PARAMETER")
    CD_REIMBURSEMENT_TERM_PARAMETER("CD-REIMBURSEMENT-TERM-PARAMETER", "1.0"),
    @XmlEnumValue("CD-REIMBURSEMENT-CONTEXT-ENVIRONMENT")
    CD_REIMBURSEMENT_CONTEXT_ENVIRONMENT("CD-REIMBURSEMENT-CONTEXT-ENVIRONMENT", "1.0");
