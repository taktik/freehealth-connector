...
/**
 * <p>Classe Java pour CD-STENT-DOMINANCE complex type.
 * 
 * <p>Le fragment de schéma suivant indique le contenu attendu figurant dans cette classe.
 * 
 * <pre>
 * &lt;complexType name="CD-STENT-DOMINANCE">
 *   &lt;simpleContent>
 *     &lt;extension base="&lt;http://www.ehealth.fgov.be/standards/kmehr/cd/v1>CD-STENT-DOMINANCEvalues">
 *       &lt;attribute name="S" use="required" type="{http://www.w3.org/2001/XMLSchema}string" fixed="CD-STENT-DOMINANCE" />
...
@XmlType(name = "CD-STENT-DOMINANCE", propOrder = {
    "value"
})
public class CDSTENTDOMINANCE
    implements Serializable
{

    private final static long serialVersionUID = 20121001L;
    @XmlValue
    protected CDSTENTDOMINANCEvalues value;
    @XmlAttribute(name = "S", required = true)
    protected String s = "CD-STENT-DOMINANCE";
     ...
     * @return
     *     possible object is
     *     {@link CDSTENTDOMINANCEvalues }
     *
     */
    public CDSTENTDOMINANCEvalues getValue() {
        return value;
    }
     ...
     *
     */
    public void setValue(CDSTENTDOMINANCEvalues value) {
        this.value = value;
    }
