...
public class ObjectFactory {
    ...
    private final static QName _RecipecompoundprescriptionTypeMagistraltext_QNAME = new QName("http://www.ehealth.fgov.be/standards/kmehr/schema/v1", "magistraltext");
    private final static QName _RecipecompoundprescriptionTypeGalenicform_QNAME = new QName("http://www.ehealth.fgov.be/standards/kmehr/schema/v1", "galenicform");
    private final static QName _RecipecompoundprescriptionTypeQuantity_QNAME = new QName("http://www.ehealth.fgov.be/standards/kmehr/schema/v1", "quantity");
    private final static QName _RecipecompoundprescriptionTypeCompound_QNAME = new QName("http://www.ehealth.fgov.be/standards/kmehr/schema/v1", "compound");
    private final static QName _RecipecompoundprescriptionTypeFormularyreference_QNAME = new QName("http://www.ehealth.fgov.be/standards/kmehr/schema/v1", "formularyreference");
    private final static QName _KmehrmessageTypeSignature_QNAME = new QName("http://www.ehealth.fgov.be/standards/kmehr/schema/v1", "Signature");
    ...
    public JAXBElement<TextType> createRecipecompoundprescriptionTypeMagistraltext(TextType value) {
        return new JAXBElement<TextType>(_RecipecompoundprescriptionTypeMagistraltext_QNAME, TextType.class, RecipecompoundprescriptionType.class, value);
    }
    ...
    public JAXBElement<RecipegalenicformType> createRecipecompoundprescriptionTypeGalenicform(RecipegalenicformType value) {
        return new JAXBElement<RecipegalenicformType>(_RecipecompoundprescriptionTypeGalenicform_QNAME, RecipegalenicformType.class, RecipecompoundprescriptionType.class, value);
    }
    ...
    public JAXBElement<RecipequantityType> createRecipecompoundprescriptionTypeQuantity(RecipequantityType value) {
        return new JAXBElement<RecipequantityType>(_RecipecompoundprescriptionTypeQuantity_QNAME, RecipequantityType.class, RecipecompoundprescriptionType.class, value);
    }
    ...
    public JAXBElement<RecipecompoundType> createRecipecompoundprescriptionTypeCompound(RecipecompoundType value) {
        return new JAXBElement<RecipecompoundType>(_RecipecompoundprescriptionTypeCompound_QNAME, RecipecompoundType.class, RecipecompoundprescriptionType.class, value);
    }
    ...
    public JAXBElement<RecipeformularyreferenceType> createRecipecompoundprescriptionTypeFormularyreference(RecipeformularyreferenceType value) {
        return new JAXBElement<RecipeformularyreferenceType>(_RecipecompoundprescriptionTypeFormularyreference_QNAME, RecipeformularyreferenceType.class, RecipecompoundprescriptionType.class, value);
    }
    ...
    public JAXBElement<TextType> createCompoundprescriptionTypeMagistraltext(TextType value) {
        return new JAXBElement<TextType>(_RecipecompoundprescriptionTypeMagistraltext_QNAME, TextType.class, CompoundprescriptionType.class, value);
    }
    ...
    public JAXBElement<GalenicformType> createCompoundprescriptionTypeGalenicform(GalenicformType value) {
        return new JAXBElement<GalenicformType>(_RecipecompoundprescriptionTypeGalenicform_QNAME, GalenicformType.class, CompoundprescriptionType.class, value);
    }
    ...
    public JAXBElement<QuantityType> createCompoundprescriptionTypeQuantity(QuantityType value) {
        return new JAXBElement<QuantityType>(_RecipecompoundprescriptionTypeQuantity_QNAME, QuantityType.class, CompoundprescriptionType.class, value);
    }
    ...
    public JAXBElement<CompoundType> createCompoundprescriptionTypeCompound(CompoundType value) {
        return new JAXBElement<CompoundType>(_RecipecompoundprescriptionTypeCompound_QNAME, CompoundType.class, CompoundprescriptionType.class, value);
    }
    ...
    public JAXBElement<FormularyreferenceType> createCompoundprescriptionTypeFormularyreference(FormularyreferenceType value) {
        return new JAXBElement<FormularyreferenceType>(_RecipecompoundprescriptionTypeFormularyreference_QNAME, FormularyreferenceType.class, CompoundprescriptionType.class, value);
    }
    ...
    public JAXBElement<Signature> createKmehrmessageTypeSignature(Signature value) {
        return new JAXBElement<Signature>(_KmehrmessageTypeSignature_QNAME, Signature.class, KmehrmessageType.class, value);
    }
