...
/**
 * <p>Classe Java pour CD-EBIRTH-CONGENITALMALFORMATION complex type.
 * 
 * <p>Le fragment de schéma suivant indique le contenu attendu figurant dans cette classe.
 * 
 * <pre>
 * &lt;complexType name="CD-EBIRTH-CONGENITALMALFORMATION">
 *   &lt;simpleContent>
 *     &lt;extension base="&lt;http://www.ehealth.fgov.be/standards/kmehr/cd/v1>CD-EBIRTH-CONGENITALMALFORMATIONvalues">
 *       &lt;attribute name="S" use="required" type="{http://www.w3.org/2001/XMLSchema}string" fixed="CD-EBIRTH-CONGENITALMALFORMATION" />
...
@XmlType(name = "CD-EBIRTH-CONGENITALMALFORMATION", propOrder = {
    "value"
})
public class CDEBIRTHCONGENITALMALFORMATION
    implements Serializable
{

    private final static long serialVersionUID = 20130710L;
    @XmlValue
    protected CDEBIRTHCONGENITALMALFORMATIONvalues value;
    @XmlAttribute(name = "S", required = true)
    protected String s = "CD-EBIRTH-CONGENITALMALFORMATION";
     ...
     * @return
     *     possible object is
     *     {@link CDEBIRTHCONGENITALMALFORMATIONvalues }
     *     
     */
    public CDEBIRTHCONGENITALMALFORMATIONvalues getValue() {
        return value;
    }
     ...
     *     
     */
    public void setValue(CDEBIRTHCONGENITALMALFORMATIONvalues value) {
        this.value = value;
    }
    ...
    public String getS() {
        if (s == null) {
            return "CD-EBIRTH-CONGENITALMALFORMATION";
        } else {
            return s;
        }
    }
