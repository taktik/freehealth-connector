...
/**
 * <p>Classe Java pour CD-IMPLANTATION-TYPE complex type.
 * 
 * <p>Le fragment de schéma suivant indique le contenu attendu figurant dans cette classe.
 * 
 * <pre>
 * &lt;complexType name="CD-IMPLANTATION-TYPE">
 *   &lt;simpleContent>
 *     &lt;extension base="&lt;http://www.ehealth.fgov.be/standards/kmehr/cd/v1>CD-IMPLANTATION-TYPEvalues">
 *       &lt;attribute name="S" use="required" type="{http://www.w3.org/2001/XMLSchema}string" fixed="CD-IMPLANTATION-TYPE" />
...
@XmlType(name = "CD-IMPLANTATION-TYPE", propOrder = {
    "value"
})
public class CDIMPLANTATIONTYPE
    implements Serializable
{

    private final static long serialVersionUID = 20130710L;
    @XmlValue
    protected CDIMPLANTATIONTYPEvalues value;
    @XmlAttribute(name = "S", required = true)
    protected String s = "CD-IMPLANTATION-TYPE";
     ...
     * @return
     *     possible object is
     *     {@link CDIMPLANTATIONTYPEvalues }
     *     
     */
    public CDIMPLANTATIONTYPEvalues getValue() {
        return value;
    }
     ...
     *     
     */
    public void setValue(CDIMPLANTATIONTYPEvalues value) {
        this.value = value;
    }
