...
/**
 * <p>Classe Java pour CD-ITEM-BVT complex type.
 * 
 * <p>Le fragment de schéma suivant indique le contenu attendu figurant dans cette classe.
 * 
 * <pre>
 * &lt;complexType name="CD-ITEM-BVT">
 *   &lt;simpleContent>
 *     &lt;extension base="&lt;http://www.ehealth.fgov.be/standards/kmehr/cd/v1>CD-ITEM-BVTvalues">
 *       &lt;attribute name="S" use="required" type="{http://www.w3.org/2001/XMLSchema}string" fixed="CD-ITEM-BVT" />
...
@XmlType(name = "CD-ITEM-BVT", propOrder = {
    "value"
})
public class CDITEMBVT
    implements Serializable
{

    private final static long serialVersionUID = 20121001L;
    @XmlValue
    protected CDITEMBVTvalues value;
    @XmlAttribute(name = "S", required = true)
    protected String s = "CD-ITEM-BVT";
     ...
     * @return
     *     possible object is
     *     {@link CDITEMBVTvalues }
     *     
     */
    public CDITEMBVTvalues getValue() {
        return value;
    }
     ...
     *     
     */
    public void setValue(CDITEMBVTvalues value) {
        this.value = value;
    }
