...
/**
 * <p>Classe Java pour CD-ENCOUNTERSAFETYISSUE complex type.
 * 
 * <p>Le fragment de schéma suivant indique le contenu attendu figurant dans cette classe.
 * 
 * <pre>
 * &lt;complexType name="CD-ENCOUNTERSAFETYISSUE">
 *   &lt;simpleContent>
 *     &lt;extension base="&lt;http://www.ehealth.fgov.be/standards/kmehr/cd/v1>CD-ENCOUNTERSAFETYISSUEvalues">
 *       &lt;attribute name="S" use="required" type="{http://www.w3.org/2001/XMLSchema}string" fixed="CD-ENCOUNTERSAFETYISSUE" />
...
@XmlType(name = "CD-ENCOUNTERSAFETYISSUE", propOrder = {
    "value"
})
public class CDENCOUNTERSAFETYISSUE
    implements Serializable
{
    ...
    protected String s = "CD-ENCOUNTERSAFETYISSUE";
     ...
     * @return
     *     possible object is
     *     {@link CDENCOUNTERSAFETYISSUEvalues }
     *     
     */
    ...
    public String getS() {
        if (s == null) {
            return "CD-ENCOUNTERSAFETYISSUE";
        } else {
            return s;
        }
    }
