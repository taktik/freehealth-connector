...
/**
 * <p>Classe Java pour CD-TRANSACTION-TYPE complex type.
 * 
 * <p>Le fragment de schéma suivant indique le contenu attendu figurant dans cette classe.
 * 
 * <pre>
 * &lt;complexType name="CD-TRANSACTION-TYPE">
 *   &lt;simpleContent>
 *     &lt;extension base="&lt;http://www.ehealth.fgov.be/standards/kmehr/cd/v1>CD-TRANSACTION-TYPEvalues">
 *       &lt;attribute name="S" use="required" type="{http://www.w3.org/2001/XMLSchema}string" fixed="CD-TRANSACTION-TYPE" />
...
@XmlType(name = "CD-TRANSACTION-TYPE", propOrder = {
    "value"
})
public class CDTRANSACTIONTYPE
    implements Serializable
{

    private final static long serialVersionUID = 20130710L;
    @XmlValue
    protected CDTRANSACTIONTYPEvalues value;
    @XmlAttribute(name = "S", required = true)
    protected String s = "CD-TRANSACTION-TYPE";
     ...
     * @return
     *     possible object is
     *     {@link CDTRANSACTIONTYPEvalues }
     *     
     */
    public CDTRANSACTIONTYPEvalues getValue() {
        return value;
    }
     ...
     *     
     */
    public void setValue(CDTRANSACTIONTYPEvalues value) {
        this.value = value;
    }
