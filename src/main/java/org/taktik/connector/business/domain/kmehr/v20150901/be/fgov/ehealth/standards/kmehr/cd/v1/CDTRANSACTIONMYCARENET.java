...
/**
 * <p>Classe Java pour CD-TRANSACTION-MYCARENET complex type.
 * 
 * <p>Le fragment de schéma suivant indique le contenu attendu figurant dans cette classe.
 * 
 * <pre>
 * &lt;complexType name="CD-TRANSACTION-MYCARENET">
 *   &lt;simpleContent>
 *     &lt;extension base="&lt;http://www.ehealth.fgov.be/standards/kmehr/cd/v1>CD-TRANSACTION-MYCARENETvalues">
 *       &lt;attribute name="S" use="required" type="{http://www.w3.org/2001/XMLSchema}string" fixed="CD-TRANSACTION-MYCARENET" />
...
@XmlType(name = "CD-TRANSACTION-MYCARENET", propOrder = {
    "value"
})
public class CDTRANSACTIONMYCARENET
    implements Serializable
{

    private final static long serialVersionUID = 20150901L;
    @XmlValue
    protected CDTRANSACTIONMYCARENETvalues value;
    @XmlAttribute(name = "S", required = true)
    protected String s = "CD-TRANSACTION-MYCARENET";
     ...
     * @return
     *     possible object is
     *     {@link CDTRANSACTIONMYCARENETvalues }
     *
     */
     ...
     *
     */
    public void setValue(CDTRANSACTIONMYCARENETvalues value) {
        this.value = value;
    }
    ...
    public String getS() {
        if (s == null) {
            return "CD-TRANSACTION-MYCARENET";
        } else {
            return s;
        }
    }
