package org.taktik.connector.business.mycarenetcommons.builders;
...
public final class ResponseBuilderFactory {
   ...
   private static final String DEFAULT_RESPONSEBUILDER_CLASS = "org.taktik.connector.business.mycarenetcommons.builders.impl.ResponseBuilderImpl";
   private static ConfigurableFactoryHelper<ResponseBuilder> responseBuilderFactory = new ConfigurableFactoryHelper("mycarenet.mcn.responseobjectbuilder.class", "org.taktik.connector.business.mycarenetcommons.builders.impl.ResponseBuilderImpl");
