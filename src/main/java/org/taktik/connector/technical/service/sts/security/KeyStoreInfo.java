...
public class KeyStoreInfo {
   ...
   private String getKeystoreLoc(String pathKeystore) throws TechnicalConnectorException {
      String propLocation = config.getProperty("KEYSTORE_DIR", "");
      return StringUtils.isEmpty(propLocation) ? pathKeystore : config.getProperty("KEYSTORE_DIR") + pathKeystore;
   }
