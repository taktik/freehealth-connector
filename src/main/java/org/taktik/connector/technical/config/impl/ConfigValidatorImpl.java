...
public class ConfigValidatorImpl implements ConfigValidator {
   ...
   private Object processException(Exception e) {
      if (this.config.getBooleanProperty("org.taktik.connector.technical.config.impl.ConfigValidatorImpl.throwErrorOnInvalidconfig", PROP_VALIDATOR_ACTIVATOR_DEFAULT).booleanValue()) {
