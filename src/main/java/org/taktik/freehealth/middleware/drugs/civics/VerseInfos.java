 ...
 */
public class VerseInfos implements Comparable<VerseInfos>{
    String chapterName;
    ...
    SortedSet<VerseInfos> verses;

    public SortedSet<VerseInfos> getVerses() {
        return verses;
    }

    public void setVerses(SortedSet<VerseInfos> verses) {
        this.verses = verses;
    }
    ...
    @Override
    public int compareTo(VerseInfos verseInfos) {
        return verseSeq.compareTo(verseInfos.verseSeq);
    }
}
