...
@XmlType(name = "AttributeType", namespace = "urn:be:fgov:ehealth:mycarenet:commons:core:v4", propOrder = {
    "value"
})
public class AttributeType {

    @XmlElement(name = "Value", namespace = "urn:be:fgov:ehealth:mycarenet:commons:core:v4", required = true)
