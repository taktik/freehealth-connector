...
@XmlType(name = "SubjectType", namespace = "urn:be:fgov:ehealth:mycarenet:commons:core:v4", propOrder = {
    "identifier",
    "attribute"
})
@XmlSeeAlso({
...
public class SubjectType {
    ...
    @XmlElement(name = "Identifier", namespace = "urn:be:fgov:ehealth:mycarenet:commons:core:v4", required = true)
    protected List<SubjectType.Identifier> identifier;
     ...
     * {@link SubjectType.Identifier }
     * 
     * 
     */
    public List<SubjectType.Identifier> getIdentifier() {
        if (identifier == null) {
            identifier = new ArrayList<SubjectType.Identifier>();
        }
