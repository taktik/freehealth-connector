...
@XmlType(
   name = "ContactAddressDeclarationType",
   propOrder = {"countryIsoCode", "countryCode", "countryName", "cityCode", "cityName", "postalCode", "streetCode", "streetName", "houseNumber", "boxNumber", "typeCode", "inceptionDate", "expiryDate"}
)
public class ContactAddressDeclarationType implements Serializable {
