...
public class ObjectFactory {
   ...
   public JAXBElement<InsurabilityRequestTypeType> createInsurabilityRequestType(InsurabilityRequestTypeType value) {
      return new JAXBElement<>(_InsurabilityRequestType_QNAME, InsurabilityRequestTypeType.class, null, value);
   }
   ...
   public JAXBElement<InsurabilityContactTypeType> createInsurabilityContactType(InsurabilityContactTypeType value) {
      return new JAXBElement<>(_InsurabilityContactType_QNAME, InsurabilityContactTypeType.class, null, value);
   }
   ...
   public JAXBElement<String> createInsurabilityReference(String value) {
      return new JAXBElement<>(_InsurabilityReference_QNAME, String.class, null, value);
   }
   ...
   public JAXBElement<CareReceiverDetailType> createCareReceiverDetail(CareReceiverDetailType value) {
      return new JAXBElement<>(_CareReceiverDetail_QNAME, CareReceiverDetailType.class, null, value);
   }
   ...
   public JAXBElement<String> createInsuranceOrg(String value) {
      return new JAXBElement<>(_InsuranceOrg_QNAME, String.class, null, value);
   }
   ...
   public JAXBElement<DateTime> createTransferDate(DateTime value) {
      return new JAXBElement<>(_TransferDate_QNAME, DateTime.class, null, value);
   }
   ...
   public JAXBElement<Boolean> createPaymentByIo(Boolean value) {
      return new JAXBElement<>(_PaymentByIo_QNAME, Boolean.class, null, value);
   }
   ...
   public JAXBElement<XMLGregorianCalendar> createMaxInvoiced(XMLGregorianCalendar value) {
      return new JAXBElement<>(_MaxInvoiced_QNAME, XMLGregorianCalendar.class, null, value);
   }
   ...
   public JAXBElement<Boolean> createSpecialSocialCategory(Boolean value) {
      return new JAXBElement<>(_SpecialSocialCategory_QNAME, Boolean.class, null, value);
   }
   ...
   public JAXBElement<String> createHospital(String value) {
      return new JAXBElement<>(_Hospital_QNAME, String.class, null, value);
   }
   ...
   public JAXBElement<DateTime> createAdmissionDate(DateTime value) {
      return new JAXBElement<>(_AdmissionDate_QNAME, DateTime.class, null, value);
   }
   ...
   public JAXBElement<String> createAdmissionService(String value) {
      return new JAXBElement<>(_AdmissionService_QNAME, String.class, null, value);
   }
   ...
   public JAXBElement<String> createCT1(String value) {
      return new JAXBElement<>(_CT1_QNAME, String.class, null, value);
   }
   ...
   public JAXBElement<String> createCT2(String value) {
      return new JAXBElement<>(_CT2_QNAME, String.class, null, value);
   }
   ...
   public JAXBElement<String> createPaymentApproval(String value) {
      return new JAXBElement<>(_PaymentApproval_QNAME, String.class, null, value);
   }
   ...
   public JAXBElement<DateTime> createInsurabilityDate(DateTime value) {
      return new JAXBElement<>(_InsurabilityDate_QNAME, DateTime.class, null, value);
   }
   ...
   public JAXBElement<PeriodType> createMedicalContract(PeriodType value) {
      return new JAXBElement<>(_MedicalContract_QNAME, PeriodType.class, null, value);
   }
   ...
   public JAXBElement<PeriodType> createKineContract(PeriodType value) {
      return new JAXBElement<>(_KineContract_QNAME, PeriodType.class, null, value);
   }
   ...
   public JAXBElement<PeriodType> createNurseContract(PeriodType value) {
      return new JAXBElement<>(_NurseContract_QNAME, PeriodType.class, null, value);
   }
