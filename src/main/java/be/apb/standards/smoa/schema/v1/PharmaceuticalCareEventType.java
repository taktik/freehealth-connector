...
public class PharmaceuticalCareEventType extends AbstractEventType {
   ...
   protected List<DispensedForSamePrescription> dispensedForSamePrescription;
   protected DispensedWithoutPrescription dispensedWithoutPrescription;
   protected PharmaceuticalCareActivities pharmaceuticalCareActivities;
   ...
   public List<DispensedForSamePrescription> getDispensedForSamePrescription() {
   ...
   public DispensedWithoutPrescription getDispensedWithoutPrescription() {
      return this.dispensedWithoutPrescription;
   }

   public void setDispensedWithoutPrescription(DispensedWithoutPrescription value) {
      this.dispensedWithoutPrescription = value;
   }

   public PharmaceuticalCareActivities getPharmaceuticalCareActivities() {
      return this.pharmaceuticalCareActivities;
   }

   public void setPharmaceuticalCareActivities(PharmaceuticalCareActivities value) {
