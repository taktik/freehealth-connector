...
import org.taktik.connector.business.domain.kmehr.v20161201.Utils
...
object KmehrPrescriptionHelper {
    val versions = mapOf("CD-ADDRESS" to "1.1",
    ...
    fun mapPeriodToFrequency(period: Period): RecipefrequencyType {
    ...
    fun toDurationType(d: Duration?): RecipedurationType? {
        if (d == null) {
            return null
        }
