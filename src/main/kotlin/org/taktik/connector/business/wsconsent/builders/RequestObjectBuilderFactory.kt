...
object RequestObjectBuilderFactory {
    private val helperFactoryRequestObjectBuilder =
        ConfigurableFactoryHelper<RequestObjectBuilder>(
            "org.taktik.connector.business.wsconsent.builders.RequestObjectBuilder.class",
            "org.taktik.connector.business.wsconsent.builders.impl.RequestObjectBuilderImpl"
        )
    private val helperFactoryConsentBuilder =
        ConfigurableFactoryHelper<ConsentBuilder>(
            "wsconsent.ConsentBuilder.class",
            "org.taktik.connector.business.wsconsent.builders.impl.ConsentBuilderImpl"
        )
