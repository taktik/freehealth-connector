...
class ConsentBuilderImpl : ConsentBuilder {
	private fun createConsent(patient: PatientIdType, consent: List<CDCONSENT>, signdate: DateTime?, revokedate: DateTime?, author: AuthorWithPatientAndPersonType) =
			ConsentType().apply {
				this.author = author
	...
	override fun createNewConsent(patient: PatientIdType, consent: List<CDCONSENT>, signdate: DateTime, author: AuthorWithPatientAndPersonType) =
