...
class PutTherapeuticLinkResponse(dateTime: DateTime, author: Author, id: String, request: TherapeuticLinkRequestType, acknowledge: Acknowledge) : GeneralResponse(dateTime, author, id, request, acknowledge)
