...
class OperationContext(var recordDateTime: DateTime? = null, var operation: String? = null, var author: Author? = null, var proofs: MutableList<Proof> = ArrayList()): Serializable {
	@Deprecated("")
	constructor(operation: String, recordDate: Calendar, author: Author, proofs: MutableList<Proof>) : this(convertToDateTime(recordDate), operation, author, proofs)
