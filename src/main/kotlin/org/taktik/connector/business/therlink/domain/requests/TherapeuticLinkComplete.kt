...
class TherapeuticLinkComplete(patient: Patient, hcParty: HcParty, type: String, var operationContext: List<OperationContext>?) : TherapeuticLink(patient, hcParty, type) {
