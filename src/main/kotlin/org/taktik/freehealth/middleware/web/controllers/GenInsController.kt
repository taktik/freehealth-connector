...
class GenInsController(val genInsService: GenInsService) {
    @GetMapping("/{ssin}")
    fun getGeneralInsurability(@PathVariable ssin: String, @RequestParam tokenId: UUID, @RequestParam keystoreId: UUID, @RequestParam passPhrase: String, @RequestParam hcpNihii: String, @RequestParam hcpSsin: String, @RequestParam hcpName: String, @RequestParam(required = false) hcpQuality: String?, @RequestParam(required = false) date: Long?, @RequestParam(required = false) hospitalized: Boolean?): InsurabilityInfoDto =
