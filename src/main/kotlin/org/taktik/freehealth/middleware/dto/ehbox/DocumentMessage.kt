...
open class DocumentMessage(
        ...
        val freeInformationTableTitle: String? = null,
        val freeInformationTableRows: Map<String, String> = HashMap(),
        val patientInss: String? = null,
        val annex: List<Document>? = ArrayList(),
        val copyMailTo: List<String> = ArrayList(),
        val documentTitle: String? = null,
        val annexList: List<Document> = listOf()
) : Message(
        id = id,
