...
object Record90Description : RecordOrSegmentDescription() {
    ...
    init {
        ...
        pos = register(ZONE_DESCRIPTIONS_BY_ZONE, "1", "EnregistrementDeType90", "recordType", "N", pos, 2, "90")
        ...
        pos = register(ZONE_DESCRIPTIONS_BY_ZONE, "4", "Reserve", null, "N", pos, 7)
        ...
        pos = register(ZONE_DESCRIPTIONS_BY_ZONE, "15", "SigneMontantTotalNumeroCompteFinancierB", "signeAndTotalAmountCptB", "A", pos, 12)
        ...
        pos = register(ZONE_DESCRIPTIONS_BY_ZONE, "19", "SigneMontantTotalNumeroCompteFinancierA", "signeAndTotalAmountCptA", "A", pos, 12)
        ...
        pos = register(ZONE_DESCRIPTIONS_BY_ZONE, "27", "BCE", "cbe", "N", pos, 10)
