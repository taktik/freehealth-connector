...
object Record90Description : RecordOrSegmentDescription() {
    ...
    init {
        ...
        pos = register(ZONE_DESCRIPTIONS_BY_ZONE, "1", "EnregistrementDeType90", "N", pos, 2, "90")
        ...
        pos = register(ZONE_DESCRIPTIONS_BY_ZONE, "4", "Reserve", "N", pos, 7)
        ...
        pos = register(ZONE_DESCRIPTIONS_BY_ZONE, "7", "NumeroDenvoi", "N", pos, 3)
        ...
        pos = register(ZONE_DESCRIPTIONS_BY_ZONE, "15", "SigneMontantTotalNumeroCompteFinancierB", "A", pos, 12)
        ...
        pos = register(ZONE_DESCRIPTIONS_BY_ZONE, "19", "SigneMontantTotalNumeroCompteFinancierA", "A", pos, 12)
