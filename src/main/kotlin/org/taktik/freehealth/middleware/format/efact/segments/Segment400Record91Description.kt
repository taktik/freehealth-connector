...
object Segment400Record91Description : RecordOrSegmentDescription() {
    ...
    init {
        ...
        pos = register(ZONE_DESCRIPTIONS_BY_ZONE, "411", "Signe montant accepte compte A", "A", pos, 1)
        pos = register(ZONE_DESCRIPTIONS_BY_ZONE, "412", "montant accepte compte A", "N", pos, 11)
        pos = register(ZONE_DESCRIPTIONS_BY_ZONE, "4121", "Code erreur", "N", pos, 2)
        pos = register(ZONE_DESCRIPTIONS_BY_ZONE, "413", "Signe montant refuse compte A", "A", pos, 1)
        pos = register(ZONE_DESCRIPTIONS_BY_ZONE, "414", "montant refuse compte A", "N", pos, 11)
        pos = register(ZONE_DESCRIPTIONS_BY_ZONE, "4141", "Code erreur", "N", pos, 2)
        pos = register(ZONE_DESCRIPTIONS_BY_ZONE, "415", "Signe montant accepte compte B", "A", pos, 1)
        pos = register(ZONE_DESCRIPTIONS_BY_ZONE, "416", "Montant accepte compte B", "N", pos, 11)
        pos = register(ZONE_DESCRIPTIONS_BY_ZONE, "4161", "Code erreur", "N", pos, 2)
        pos = register(ZONE_DESCRIPTIONS_BY_ZONE, "417", "Signe montant refuse compte B", "A", pos, 1)
        pos = register(ZONE_DESCRIPTIONS_BY_ZONE, "418", "Montant refuse compte B", "N", pos, 11)
        pos = register(ZONE_DESCRIPTIONS_BY_ZONE, "4181", "Code erreur", "N", pos, 2)
        pos = register(ZONE_DESCRIPTIONS_BY_ZONE, "419", "Signe total montants acceptes compte A + compte B", "A", pos, 1)
        pos = register(ZONE_DESCRIPTIONS_BY_ZONE, "420", "Total montants acceptes compte A+compte B", "N", pos, 11)
        pos = register(ZONE_DESCRIPTIONS_BY_ZONE, "4201", "Code erreur", "N", pos, 2)
        pos = register(ZONE_DESCRIPTIONS_BY_ZONE, "421", "Signe total montants refuses compte A + compte B", "A", pos, 1)
        pos = register(ZONE_DESCRIPTIONS_BY_ZONE, "422", "Total montants refuses compte A+compteB", "N", pos, 11)
        pos = register(ZONE_DESCRIPTIONS_BY_ZONE, "4221", "Code erreur", "N", pos, 2)
        pos = register(ZONE_DESCRIPTIONS_BY_ZONE, "423", "Reference paiement compte A OA ou mutualite", "A", pos, 22)
        pos = register(ZONE_DESCRIPTIONS_BY_ZONE, "4231", "Code erreur", "N", pos, 2)
        pos = register(ZONE_DESCRIPTIONS_BY_ZONE, "424", "Reference paiement compte B OA ou mutualite", "A", pos, 22)
        pos = register(ZONE_DESCRIPTIONS_BY_ZONE, "4241", "Code erreur", "N", pos, 2)
              register(ZONE_DESCRIPTIONS_BY_ZONE, "425", "Reserve", "A", pos, 589)    }
