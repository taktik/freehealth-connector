...
fun prescriptionExample11() =
    PrescriptionExample(donaldDuckHealthcareParty(), fredFlintstonePatient(), listOf(adalatOrosMedication(), dermovateCremeMedication11()), LocalDateTime.of(2017, 2, 1,0,0))
