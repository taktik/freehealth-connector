...
class EattestV3ControllerTest : EhealthTest() {
    @LocalServerPort
    private val port: Int = 0

    private var tabAttesSv3C3: MutableList<SendAttestResult> = mutableListOf<SendAttestResult>()
    ...
    private fun getNissesv3(idx: Int) = listOf(nisses[100]!![6+idx], nisses[300]!![6+idx], nisses[500]!![6+idx], nisses[600]!![6+idx], nisses[900]!![6+idx])
    ...
    fun scenario1() {
        ...
        val results = getNisses(0).map {
            this.restTemplate.exchange(
                "http://localhost:$port/eattestv3/send/$it?hcpNihii=$nihii1&hcpSsin=$ssin1&hcpFirstName={firstName}&hcpLastName={lastName}&hcpCbe=$cbe1&treatmentReason=0000&patientFirstName={patientFirstName}&patientLastName={patientLastName}&patientGender={patientGender}&keystoreId=$keystoreId&tokenId=$tokenId&passPhrase={passPhrase}",
                HttpMethod.POST,
                HttpEntity(
                    eattest,
    ...
    fun scenario2() {
        ...
        val results = getNisses(0).map {
            this.restTemplate.exchange("http://localhost:$port/eattestv3/send/$it?hcpNihii=$nihii1&hcpSsin=$ssin1&hcpFirstName={firstName}&hcpLastName={lastName}&hcpCbe=$cbe1&treatmentReason=0000&patientFirstName={patientFirstName}&patientLastName={patientLastName}&patientGender={patientGender}&keystoreId=$keystoreId&tokenId=$tokenId&passPhrase={passPhrase}", HttpMethod.POST,HttpEntity(eattest, createHeaders(null, null, keystoreId, tokenId, passPhrase)),
 String::class.java, firstName1, lastName1, "John", "Doe", "male", passPhrase).body
        }
 ...
 String::class.java, firstName1, lastName1, "John", "Doe", "male", passPhrase).body
    ...
    fun v3scenario1() {
        ...
        assertResultsError("scenario v3 1", results,"219")
    }
    ...
    fun v3scenario2() {
        ...
        val results = getNissesv3(4).map {
            this.restTemplate.exchange("http://localhost:$port/eattestv3/send/$it?hcpNihii=$nihii1&hcpSsin=$ssin1&hcpFirstName={firstName}&hcpLastName={lastName}&hcpCbe=$cbe1&treatmentReason=0000&patientFirstName={patientFirstName}&patientLastName={patientLastName}&patientGender={patientGender}&keystoreId=$keystoreId&tokenId=$tokenId&passPhrase={passPhrase}", HttpMethod.POST,HttpEntity(eattest, createHeaders(null, null, keystoreId, tokenId, passPhrase)),
                String::class.java, firstName1, lastName1, "John", "Doe", "male", passPhrase).body
        }
        assertResultsError("scenario v3 2", results,"196")
    }
    ...
    fun v3scenario3() {
        ...
        val results = getNissesv3(0).map {
            this.restTemplate.exchange("http://localhost:$port/eattestv3/send/$it?hcpNihii=$nihii1&hcpSsin=$ssin1&hcpFirstName={firstName}&hcpLastName={lastName}&hcpCbe=$cbe1&treatmentReason=0070&patientFirstName={patientFirstName}&patientLastName={patientLastName}&patientGender={patientGender}&keystoreId=$keystoreId&tokenId=$tokenId&passPhrase={passPhrase}", HttpMethod.POST,HttpEntity(eattest, createHeaders(null, null, keystoreId, tokenId, passPhrase)),
                String::class.java, firstName1, lastName1, "John", "Doe", "male", passPhrase).body
        }
        assertResults("scenario v3 3", results)
    }
    ...
    fun v3scenario4() {
        ...
        val results = getNissesv3(0).map {
            this.restTemplate.exchange("http://localhost:$port/eattestv3/send/$it/verbose?hcpNihii=$nihii1&hcpSsin=$ssin1&hcpFirstName={firstName}&hcpLastName={lastName}&hcpCbe=$cbe1&treatmentReason=0070&patientFirstName={patientFirstName}&patientLastName={patientLastName}&patientGender={patientGender}&keystoreId=$keystoreId&tokenId=$tokenId&passPhrase={passPhrase}", HttpMethod.POST,HttpEntity(eattest, createHeaders(null, null, keystoreId, tokenId, passPhrase)),
                String::class.java, firstName1, lastName1, "John", "Doe", "male", passPhrase).body
        }
        assertResults("scenario v3 4", results)
    }
    ...
    fun v3scenario5() {
        ...
        val results = getNissesv3(4).map {
            this.restTemplate.exchange("http://localhost:$port/eattestv3/send/$it/verbose?hcpNihii=$nihii1&hcpSsin=$ssin1&hcpFirstName={firstName}&hcpLastName={lastName}&hcpCbe=$cbe1&treatmentReason=0000&patientFirstName={patientFirstName}&patientLastName={patientLastName}&patientGender={patientGender}&keystoreId=$keystoreId&tokenId=$tokenId&passPhrase={passPhrase}", HttpMethod.POST,HttpEntity(eattest, createHeaders(null, null, keystoreId, tokenId, passPhrase)),
                String::class.java, firstName1, lastName1, "John", "Doe", "male", passPhrase).body
        }
        assertResults("scenario v3 5", results)
    }

    fun v3scenario1Cancel() {
        val (keystoreId, tokenId, passPhrase) = register(restTemplate!!, port, ssin1!!, password1!!)
        val now = LocalDateTime.now()
        val eattest = Eattest(listOf(Eattest.EattestCode(
            date = now.year * 10000 + now.monthValue * 100 + now.dayOfMonth,
        ...
        assertResults("scenario v3 cancel 1", results)
    }

    fun v3scenario2Cancel() {
        val (keystoreId, tokenId, passPhrase) = register(restTemplate!!, port, ssin1!!, password1!!)
        val now = LocalDateTime.now()
        val eattest = Eattest(listOf(Eattest.EattestCode(
            date = now.year * 10000 + now.monthValue * 100 + now.dayOfMonth,
        ...
        assertResults("scenario v3 cancel 2", results)
    }

    fun v3scenario3Cancel() {
        val (keystoreId, tokenId, passPhrase) = register(restTemplate!!, port, ssin1!!, password1!!)
        var idx=0
        val results = getNissesv3(0).map {
            val attest = tabAttesSv3C3[idx++];
        ...
        assertResultsError("scenario v3 cancel 3", results,"240")
    }


    fun v3scenario4Cancel() {
        val (keystoreId, tokenId, passPhrase) = register(restTemplate!!, port, ssin1!!, password1!!)
        val results = getNissesv3(0).map {
            this.restTemplate.exchange("http://localhost:$port/eattestv3/send/$it?hcpNihii=$nihii1&hcpSsin=$ssin1&hcpFirstName={firstName}&hcpLastName={lastName}&hcpCbe=$cbe1&patientFirstName={patientFirstName}&patientLastName={patientLastName}&patientGender={patientGender}&keystoreId=$keystoreId&tokenId=$tokenId&passPhrase={passPhrase}&eAttestRef={attestRef}&reason={reason}", HttpMethod.DELETE,HttpEntity(null, createHeaders(null, null, keystoreId, tokenId, passPhrase)),
        ...
        assertResultsError("scenario v3 cancel 4", results,"141")
    }
