    ...
    fun getConsent() {
        ...
        val consent =
            this.restTemplate.getForObject(
                "http://localhost:$port/consent/${"74010414733"}?keystoreId=$keystoreId&tokenId=$tokenId&hcpNihii=$nihii1&hcpSsin=$ssin1&hcpFirstName={firstName}&hcpLastName={lastName}&patientFirstName=${"Antoine"}&patientLastName=${"Duchâteau"}&passPhrase={passPhrase}",
                String::class.java,
                firstName1,
                lastName1,
                passPhrase
        ...
        val consent =
            gson.fromJson(
                this.restTemplate.getForObject(
                    ...
                    lastName1,
                    passPhrase
                ), ConsentMessageDto::class.java
            )
        val revoke =
            this.restTemplate.postForObject(
                "http://localhost:$port/consent/revoke/${"74010414733"}?keystoreId=$keystoreId&tokenId=$tokenId&hcpNihii=$nihii1&hcpSsin=$ssin1&hcpFirstName={firstName}&hcpLastName={lastName}&patientFirstName=${"Antoine"}&patientLastName=${"Duchâteau"}&eidCardNumber=${"592363302467"}&passPhrase={passPhrase}",
                consent.consent,
                String::class.java,
                firstName1,
                lastName1,
