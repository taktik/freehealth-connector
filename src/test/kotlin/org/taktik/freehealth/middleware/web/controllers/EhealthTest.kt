...
open class EhealthTest {
    ...
    */
    ...
    @Value("\${org.taktik.icure.keystore4.cbe}") var cbe4: String? = null
    @Value("\${org.taktik.icure.keystore5.cbe}") var cbe5: String? = null
    @Value("\${org.taktik.icure.keystore.vaccinet.cbe}") var cbeVaccinet: String? = null
    ...
    @Value("\${org.taktik.icure.keystore4.nihii}") var nihii4: String? = null
    @Value("\${org.taktik.icure.keystore5.nihii}") var nihii5: String? = null
    @Value("\${org.taktik.icure.keystore.vaccinet.nihii}") var nihiiVaccinet: String? = null
    ...
    @Value("\${org.taktik.icure.keystore4.ssin}") var ssin4: String? = null
    @Value("\${org.taktik.icure.keystore5.ssin}") var ssin5: String? = null
    @Value("\${org.taktik.icure.keystore.vaccinet.ssin}") var ssinVaccinet: String? = null
    ...
    @Value("\${org.taktik.icure.keystore.vaccinet.password}") var passwordVaccinet: String? = null
    ...
    @Value("\${org.taktik.icure.keystore4.name}") var name4: String? = null
    @Value("\${org.taktik.icure.keystore5.name}") var name5: String? = null
    @Value("\${org.taktik.icure.keystore.vaccinet.name}") var nameVaccinet: String? = null
    ...
    @Value("\${org.taktik.icure.keystore4.firstName}") var firstName4: String? = null
    @Value("\${org.taktik.icure.keystore5.firstName}") var firstName5: String? = null
    @Value("\${org.taktik.icure.keystore.vaccinet.firstName}") var firstNameVaccinet: String? = null
    ...
    @Value("\${org.taktik.icure.keystore4.lastName}") var lastName4: String? = null
    @Value("\${org.taktik.icure.keystore5.lastName}") var lastName5: String? = null
    @Value("\${org.taktik.icure.keystore.vaccinet.lastName}") var lastNameVaccinet: String? = null
    ...
    @Value("\${org.taktik.icure.keystore4.BIC}") var BIC4: String? = null
    @Value("\${org.taktik.icure.keystore5.BIC}") var BIC5: String? = null
    @Value("\${org.taktik.icure.keystore.vaccinet.BIC}") var BICVaccinet: String? = null
    ...
    @Value("\${org.taktik.icure.keystore4.IBAN}") var IBAN4: String? = null
    @Value("\${org.taktik.icure.keystore5.IBAN}") var IBAN5: String? = null
    @Value("\${org.taktik.icure.keystore.vaccinet.IBAN}") var IBANVaccinet: String? = null
  ...
  init {
    ...
    protected fun registerGuardPost(restTemplate: TestRestTemplate, port: Int, nihii: String, passPhrase: String): Triple<UUID?, String, String> {
        val keystoreId = uploadKeystore((MyTestsConfiguration::class).java.getResource("$nihii.acc-p12").path, port, restTemplate)
        val res = restTemplate.exchange("http://localhost:$port/sts/token?isGuardPost=true&ssin=$nihii", HttpMethod.GET, HttpEntity<Void>(createHeaders(null, null, keystoreId, null, passPhrase)), SamlTokenResult::class.java, passPhrase)
        val tokenId = res.body?.let { it.tokenId }
        return Triple(keystoreId, tokenId.toString(), passPhrase)
    }
