						...
						<model:bvacList>
							<xsl:for-each select="model:bvacList/model:bvacDocument">
								<model:bvacDocument>
									<model:identification>
										<model:id>
											<xsl:sequence select="fn:concat(fn:concat(fn:concat(fn:concat(fn:concat(fn:concat(fn:concat(fn:concat(fn:substring(fn:concat('0000000', fn:string(model:identification/model:id)), xs:double('0'), xs:double('8')), '-'), fn:substring(fn:concat('0000000', fn:string(model:identification/model:id)), xs:double('8'), xs:double('4'))), '-'), fn:substring(fn:concat('0000000', fn:string(model:identification/model:id)), xs:double('12'), xs:double('4'))), '-'), fn:substring(fn:concat('0000000', fn:string(model:identification/model:id)), xs:double('16'), xs:double('4'))), '-'), fn:substring(fn:concat('0000000', fn:string(model:identification/model:id)), xs:double('20'), xs:double('12')))"/>
										</model:id>
										<model:barCode>
