...
public final class TrustStoreUpdater {
   ...
   private static void init() {
      ...
      try {
         shaCacheLocation = config.getProperty("truststoreupdater.local.cache", ConnectorIOUtils.getTempFileLocation(TrustStoreUpdater.class.getCanonicalName() + ".properties"));
