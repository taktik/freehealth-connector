...
public class SingleSignOnServiceImpl extends AbstractSessionServiceWithCache implements SingleSignOnService {
   ...
   public SingleSignOnServiceImpl() {
      try {
         ...
         this.browserHandler = (BrowserHandler)(new ConfigurableFactoryHelper("be.ehealth.technicalconnector.service.sso.browserhandler.default", DefaultBrowserHandler.class.getName())).getImplementation();
   ...
   private void signinWithSAML2POST(String targetLocation) throws TechnicalConnectorException {
      ...
      try {
         ...
         DeleteFileOnExitShutdownHook.deleteOnExit(result);
