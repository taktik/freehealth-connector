...
public final class UddiKeys {
   ...
   public static final String UDDI_DAAS_V1 = "$uddi{uddi:ehealth-fgov-be:business:dataattributeservice:v1}";
   ...
   public static final String UDDI_IDSUPPORT_V2 = "$uddi{uddi:ehealth-fgov-be:business:idsupport:v2}";
   /** @deprecated */
   @Deprecated
   ...
   public static final String UDDI_CERT_RA_V2 = "$uddi{uddi:ehealth-fgov-be:business:certra:v2}";
   public static final String UDDI_ETK_RA_V2 = "$uddi{uddi:ehealth-fgov-be:business:etkra:v2}";
