...
public class GenAsyncServiceImpl implements GenAsyncService, ConfigurationModuleBootstrap.ModuleBootstrapHook, ConfigurableImplementation {
   ...
   private static Duration getDuration(String startKey, String serviceName, long defaultDurationInSeconds) {
      String key = startKey + serviceName + ".v1";
   ...
   private static String getXsd(String serviceName) {
      return GenericAsyncConstants.XSD_V1_SERVICES.contains(serviceName) ? "/mycarenet-genasync/XSD/mycarenet-genasync-v1.xsd" : "/mycarenet-genasync/XSD/mycarenet-genasync-v1.3.xsd";
   }
}
