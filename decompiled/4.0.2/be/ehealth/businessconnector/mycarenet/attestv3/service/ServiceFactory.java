...
public final class ServiceFactory {
   ...
   public static GenericRequest getAttestPort(SAMLToken token) throws TechnicalConnectorException {
      ...
      return (new GenericRequest()).setEndpoint(config.getProperty("endpoint.eattestv3", "$uddi{uddi:ehealth-fgov-be:business:mycareneteattest:v3}")).setCredential(token, TokenType.SAML).addDefaulHandlerChain();
   }
