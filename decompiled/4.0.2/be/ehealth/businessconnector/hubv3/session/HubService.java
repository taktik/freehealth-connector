...
public interface HubService {
   ...
   DeclareTransactionResponse declareTransaction(KmehrHeaderDeclareTransaction var1, String var2) throws TechnicalConnectorException, IntraHubBusinessConnectorException;

   PutTransactionResponse putTransaction(Kmehrmessage var1, String var2) throws TechnicalConnectorException, IntraHubBusinessConnectorException;
   ...
   GetTransactionListResponse getTransactionList(PatientIdType var1, LocalSearchType var2, TransactionWithPeriodType var3, String var4, Integer var5) throws TechnicalConnectorException, IntraHubBusinessConnectorException;

   GetTransactionListResponse getTransactionList(PatientIdType var1, LocalSearchType var2, TransactionWithPeriodType var3, String var4) throws TechnicalConnectorException, IntraHubBusinessConnectorException;

   GetTransactionListResponse getTransactionList(PatientIdType var1, LocalSearchType var2, TransactionWithPeriodType var3, Integer var4) throws TechnicalConnectorException, IntraHubBusinessConnectorException;
   ...
   GetTransactionListResponse getTransactionList(PatientIdType var1, LocalSearchType var2, TransactionWithPeriodType var3, Paginationrequestinfo var4) throws TechnicalConnectorException, IntraHubBusinessConnectorException;

   GetTransactionListResponse getTransactionList(PatientIdType var1, LocalSearchType var2, TransactionWithPeriodType var3, Paginationrequestinfo var4, String var5) throws TechnicalConnectorException, IntraHubBusinessConnectorException;
   ...
   PutHCPartyResponse putHCParty(HCPartyAdaptedType var1, String var2) throws TechnicalConnectorException, IntraHubBusinessConnectorException;

   GetHCPartyResponse getHCParty(HCPartyIdType var1) throws TechnicalConnectorException, IntraHubBusinessConnectorException;

   GetHCPartyResponse getHCParty(HCPartyIdType var1, String var2) throws TechnicalConnectorException, IntraHubBusinessConnectorException;

   PutPatientResponse putPatient(PersonType var1, String var2) throws TechnicalConnectorException, IntraHubBusinessConnectorException;

   PutPatientResponse putPatient(PersonType var1) throws TechnicalConnectorException, IntraHubBusinessConnectorException;

   GetPatientResponse getPatient(PatientIdType var1, String var2) throws TechnicalConnectorException, IntraHubBusinessConnectorException;
   ...
   PutHCPartyConsentResponse putHCPartyConsent(ConsentHCPartyType var1, String var2) throws TechnicalConnectorException, IntraHubBusinessConnectorException;

   GetHCPartyConsentResponse getHCPartyConsent(HCPartyIdType var1, String var2) throws TechnicalConnectorException, IntraHubBusinessConnectorException;
   ...
   RevokeHCPartyConsentResponse revokeHCPartyConsent(ConsentHCPartyType var1, String var2) throws TechnicalConnectorException, IntraHubBusinessConnectorException;
   ...
   PutPatientConsentResponse putPatientConsent(ConsentType var1, String var2) throws TechnicalConnectorException, IntraHubBusinessConnectorException;
   ...
   GetPatientConsentResponse getPatientConsent(SelectGetPatientConsentType var1, String var2) throws TechnicalConnectorException, IntraHubBusinessConnectorException;
   ...
   RevokePatientConsentResponse revokePatientConsent(ConsentType var1, String var2) throws TechnicalConnectorException, IntraHubBusinessConnectorException;
   ...
   PutTherapeuticLinkResponse putTherapeuticLink(TherapeuticLinkType var1, String var2) throws TechnicalConnectorException, IntraHubBusinessConnectorException;
   ...
   GetTherapeuticLinkResponse getTherapeuticLink(SelectGetHCPartyPatientConsentType var1, String var2) throws TechnicalConnectorException, IntraHubBusinessConnectorException;
   ...
   RevokeTherapeuticLinkResponse revokeTherapeuticLink(TherapeuticLinkType var1, String var2) throws TechnicalConnectorException, IntraHubBusinessConnectorException;
   ...
   PutAccessRightResponse putAccessRight(AccessRightType var1, String var2) throws TechnicalConnectorException, IntraHubBusinessConnectorException;
   ...
   GetAccessRightResponse getAccessRight(TransactionIdType var1, String var2) throws TechnicalConnectorException, IntraHubBusinessConnectorException;
   ...
   RevokeAccessRightResponse revokeAccessRight(SelectRevokeAccessRightType var1, String var2) throws TechnicalConnectorException, IntraHubBusinessConnectorException;
   ...
   PutTransactionSetResponse putTransactionSet(Kmehrmessage var1, String var2) throws TechnicalConnectorException, IntraHubBusinessConnectorException;
   ...
   GetLatestUpdateResponse getLatestUpdate(SelectGetLatestUpdateType var1, String var2) throws TechnicalConnectorException, IntraHubBusinessConnectorException;
   ...
   GetPatientAuditTrailResponse getPatientAuditTrail(SelectGetPatientAuditTrailType var1, String var2) throws TechnicalConnectorException, IntraHubBusinessConnectorException;
