...
public final class ServiceFactory {
   ...
   public static GenericRequest getTarificationSessionForMycarenet(SAMLToken token) throws TechnicalConnectorException {
      ...
      genReq.addHandlerChain(HandlerChainUtil.buildChainWithValidator("validation.incoming.message.mcn.tarification", "/ehealth-mycarenet-tarification/XSD/mycarenet-tarification-protocol-1_0.xsd"));
      return genReq;
   }
}
