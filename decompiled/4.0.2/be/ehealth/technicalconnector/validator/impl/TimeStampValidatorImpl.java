...
public class TimeStampValidatorImpl implements TimeStampValidator, ConfigurableImplementation {
   ...
   public void validateTimeStampToken(TimeStampToken tsToken) throws InvalidTimeStampException, TechnicalConnectorException {
      Validate.notNull(this.keyStore, "keyStore is not correctly initialised.", new Object[0]);
      Validate.notNull(this.aliases, "aliases is not correctly initialised.", new Object[0]);
      Validate.notNull(tsToken, "Parameter tsToken value is not nullable.", new Object[0]);
