...
public class ConfigurationModuleVersion implements ConfigurationModule {
   ...
   public void dumpJarFromCP() {
      try {
         ...
         String[] var8 = cpElements;
         int var9 = cpElements.length;

         for(int var10 = 0; var10 < var9; ++var10) {
            String cpElement = var8[var10];
            LOG.debug(cpElement);
         }
   ...
   public void dumpServiceLoaderFiles() {
      try {
         ...
         String[] cpElements;
         StringBuilder sb;
         for(cpElements = ArrayUtils.EMPTY_STRING_ARRAY; resEnum.hasMoreElements(); cpElements = (String[])((String[])ArrayUtils.add(cpElements, sb.toString()))) {
