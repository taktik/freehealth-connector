...
public abstract class AbstractCommonBuilderImpl implements CommonBuilder {
   ...
   public CommonInput createCommonInput(PackageInfo packageInfo, boolean isTest, String inputReference) throws TechnicalConnectorException {
      ...
      return new CommonInput(isTest, origin, inputReference, (List)null, (List)null);
   }
   ...
   public CommonInput createCommonInput(McnPackageInfo packageInfo, boolean isTest, String inputReference) throws TechnicalConnectorException {
      return this.createCommonInput(packageInfo, isTest, inputReference, (List)null, (List)null);
   }
   ...
   public CommonInput createCommonInput(McnPackageInfo packageInfo, boolean isTest, String inputReference, List<Reference> references, List<Attribute> attributes) throws TechnicalConnectorException {
      Origin origin = this.createOrigin(packageInfo);
      return new CommonInput(isTest, origin, inputReference, references, attributes);
   }
   ...
   public Routing createRouting(Patient patientInfo, LocalDateTime refDate) {
      Routing routing = new Routing();
      routing.setPeriod((Period)null);
      routing.setCareReceiver(this.createCareReceiver(patientInfo));
