...
public class Patient implements Serializable {
   ...
   public static class Builder {
      ...
      public Builder withMutuality(String value) {
         this.patient.setMutuality(value);
         return this;
      }

      public Builder withRegNrWithMut(String value) {
      ...
      public Builder withSis(String value) {
         this.patient.setSisCardNumber(value);
         return this;
      }

      public Builder withIsiPlus(String value) {
