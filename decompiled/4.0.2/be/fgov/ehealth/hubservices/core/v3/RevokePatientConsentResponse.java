...
@XmlType(
   name = "RevokePatientConsentResponseType",
   propOrder = {"response", "acknowledge"}
)
@XmlRootElement(
   name = "RevokePatientConsentResponse",
   namespace = "http://www.ehealth.fgov.be/hubservices/protocol/v3"
)
public class RevokePatientConsentResponse implements Serializable {
   ...
   public RevokePatientConsentResponse() {
   }
