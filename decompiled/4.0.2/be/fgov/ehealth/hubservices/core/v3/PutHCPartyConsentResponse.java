...
@XmlType(
   name = "PutHCPartyConsentResponseType",
   propOrder = {"response", "acknowledge"}
)
@XmlRootElement(
   name = "PutHCPartyConsentResponse",
   namespace = "http://www.ehealth.fgov.be/hubservices/protocol/v3"
)
public class PutHCPartyConsentResponse implements Serializable {
   ...
   public PutHCPartyConsentResponse() {
   }
