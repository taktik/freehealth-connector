...
@XmlType(
   name = "ConsentWithStatusType",
   propOrder = {"patient", "cds", "signdate", "revokedate", "status", "author"}
)
public class ConsentWithStatusType implements Serializable {
