...
@XmlType(
   name = "RevokeTherapeuticLinkResponseType",
   propOrder = {"response", "acknowledge"}
)
@XmlRootElement(
   name = "RevokeTherapeuticLinkResponse",
   namespace = "http://www.ehealth.fgov.be/hubservices/protocol/v2"
)
public class RevokeTherapeuticLinkResponse implements Serializable {
   ...
   public RevokeTherapeuticLinkResponse() {
   }
