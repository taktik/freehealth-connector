...
@XmlType(
   name = "RevokeTransactionResponseType",
   propOrder = {"response", "acknowledge"}
)
@XmlRootElement(
   name = "RevokeTransactionResponse",
   namespace = "http://www.ehealth.fgov.be/hubservices/protocol/v2"
)
public class RevokeTransactionResponse implements Serializable {
   ...
   public RevokeTransactionResponse() {
   }
