...
@XmlType(
   name = "DeclareTransactionResponseType",
   propOrder = {"response", "acknowledge", "transaction"}
)
@XmlRootElement(
   name = "DeclareTransactionResponse",
   namespace = "http://www.ehealth.fgov.be/hubservices/protocol/v2"
)
public class DeclareTransactionResponse implements Serializable {
   ...
   public DeclareTransactionResponse() {
   }
