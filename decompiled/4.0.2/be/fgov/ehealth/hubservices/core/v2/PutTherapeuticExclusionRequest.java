...
@XmlType(
   name = "PutTherapeuticExclusionRequestType",
   propOrder = {"request", "therapeuticexclusion"}
)
@XmlRootElement(
   name = "PutTherapeuticExclusionRequest",
   namespace = "http://www.ehealth.fgov.be/hubservices/protocol/v2"
)
public class PutTherapeuticExclusionRequest implements Serializable {
   ...
   public PutTherapeuticExclusionRequest() {
   }
