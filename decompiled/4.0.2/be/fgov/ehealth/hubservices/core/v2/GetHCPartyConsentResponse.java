...
@XmlType(
   name = "GetHCPartyConsentResponseType",
   propOrder = {"response", "acknowledge", "consent"}
)
@XmlRootElement(
   name = "GetHCPartyConsentResponse",
   namespace = "http://www.ehealth.fgov.be/hubservices/protocol/v2"
)
public class GetHCPartyConsentResponse implements Serializable {
   ...
   public GetHCPartyConsentResponse() {
   }
