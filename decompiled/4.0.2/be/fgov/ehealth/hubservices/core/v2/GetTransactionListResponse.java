...
public class GetTransactionListResponse implements Serializable {
   ...
   protected KmehrHeaderGetTransactionListType kmehrheader;
   ...
   public KmehrHeaderGetTransactionListType getKmehrheader() {
      return this.kmehrheader;
   }

   public void setKmehrheader(KmehrHeaderGetTransactionListType value) {
