...
@XmlType(
   name = "GetTherapeuticExclusionHistoryResponseType",
   propOrder = {"response", "acknowledge", "therapeuticexclusionlist"}
)
@XmlRootElement(
   name = "GetTherapeuticExclusionHistoryResponse",
   namespace = "http://www.ehealth.fgov.be/hubservices/protocol/v2"
)
public class GetTherapeuticExclusionHistoryResponse implements Serializable {
   ...
   public GetTherapeuticExclusionHistoryResponse() {
   }
