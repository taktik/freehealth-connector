...
@XmlType(
   name = "RevokeHCPartyConsentResponseType",
   propOrder = {"response", "acknowledge"}
)
@XmlRootElement(
   name = "RevokeHCPartyConsentResponse",
   namespace = "http://www.ehealth.fgov.be/hubservices/protocol/v2"
)
public class RevokeHCPartyConsentResponse implements Serializable {
   ...
   public RevokeHCPartyConsentResponse() {
   }
