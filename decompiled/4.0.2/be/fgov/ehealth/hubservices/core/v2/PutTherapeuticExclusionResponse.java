...
@XmlType(
   name = "PutTherapeuticExclusionResponseType",
   propOrder = {"response", "acknowledge"}
)
@XmlRootElement(
   name = "PutTherapeuticExclusionResponse",
   namespace = "http://www.ehealth.fgov.be/hubservices/protocol/v2"
)
public class PutTherapeuticExclusionResponse implements Serializable {
   ...
   public PutTherapeuticExclusionResponse() {
   }
