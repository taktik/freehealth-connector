...
import be.fgov.ehealth.standards.kmehr.mycarenet.schema.v1.AddressTypeBase;
import be.fgov.ehealth.standards.kmehr.mycarenet.schema.v1.DateType;
import be.fgov.ehealth.standards.kmehr.mycarenet.schema.v1.InsuranceType;
import be.fgov.ehealth.standards.kmehr.mycarenet.schema.v1.MemberinsuranceType;
import be.fgov.ehealth.standards.kmehr.mycarenet.schema.v1.ProfessionType;
import be.fgov.ehealth.standards.kmehr.mycarenet.schema.v1.SexType;
import be.fgov.ehealth.standards.kmehr.mycarenet.schema.v1.TelecomType;
