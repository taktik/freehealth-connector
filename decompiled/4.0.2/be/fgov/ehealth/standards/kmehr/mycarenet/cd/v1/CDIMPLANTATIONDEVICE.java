...
@XmlType(
   name = "CD-IMPLANTATION-DEVICE",
   propOrder = {"value"}
)
public class CDIMPLANTATIONDEVICE implements Serializable {
   ...
   public String getS() {
      return this.s == null ? "CD-IMPLANTATION-DEVICE" : this.s;
   }
