...
@XmlType(
   name = "CD-MS-MEDICATIONTYPE",
   propOrder = {"value"}
)
public class CDMSMEDICATIONTYPE implements Serializable {
   ...
   public String getS() {
      return this.s == null ? "CD-MS-MEDICATIONTYPE" : this.s;
   }
