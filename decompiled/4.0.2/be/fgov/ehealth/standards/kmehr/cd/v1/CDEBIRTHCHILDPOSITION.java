...
@XmlType(
   name = "CD-EBIRTH-CHILDPOSITION",
   propOrder = {"value"}
)
public class CDEBIRTHCHILDPOSITION implements Serializable {
   ...
   public String getS() {
      return this.s == null ? "CD-EBIRTH-CHILDPOSITION" : this.s;
   }
