...
@XmlType(
   name = "DeleteInscriptionRequestType",
   propOrder = {"inscription"}
)
@XmlRootElement(
   name = "DeleteInscriptionRequest"
)
public class DeleteInscriptionRequest extends ConsultRnRequestType implements Serializable {
   ...
   public DeleteInscriptionRequest() {
   }
