...
import be.fgov.ehealth.dics.core.v3.refdata.PackagingTypeKeyType;
...
@XmlType(
   name = "PackagingTypeType",
   propOrder = {"name", "edqmCode", "edqmDefinition"}
)
public class PackagingTypeType extends PackagingTypeKeyType implements Serializable {
