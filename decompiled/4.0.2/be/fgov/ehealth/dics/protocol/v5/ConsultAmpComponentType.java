...
@XmlType(
   ...
   propOrder = {"dividable", "scored", "crushable", "containsAlcohol", "sugarFree", "modifiedReleaseType", "specificDrugDevice", "dimensions", "name", "note", "pharmaceuticalForms", "routeOfAdministrations", "realActualIngredients", "additionalFields"}
)
