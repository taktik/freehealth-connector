...
@XmlType(
   ...
   propOrder = {"authorisationNr", "vatNr", "europeanNr", "denomination", "legalForm", "building", "streetName", "streetNum", "postbox", "postcode", "city", "countryCode", "phone", "language", "website", "email", "additionalFields"}
)
public class ConsultCompanyType implements Serializable {
