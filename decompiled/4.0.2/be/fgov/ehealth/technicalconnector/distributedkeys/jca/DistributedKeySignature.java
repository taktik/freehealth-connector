...
public class DistributedKeySignature extends SignatureSpi {
   ...
   public static void registerDigestAlgorithm(String signatureAlgorithm, String digestAlgo) {
      digestAlgos.put(signatureAlgorithm, digestAlgo);
   }
   ...
   static {
      ...
      digestAlgos.put("NONEwithECDSA", (Object)null);
   }
}
