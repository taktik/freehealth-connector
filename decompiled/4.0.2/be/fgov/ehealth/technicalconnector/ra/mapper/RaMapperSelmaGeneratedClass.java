...
public final class RaMapperSelmaGeneratedClass implements RaMapper {
   ...
   public final LocalizedText asLocalizedText(TextType inTextType) {
      ...
      if (inTextType != null) {
         ...
         if (inTextType.getValues() != null) {
            ...
            Iterator var4 = inTextType.getValues().iterator();

            while(var4.hasNext()) {
               be.fgov.ehealth.certra.core.v2.LocalizedString avaluesItem = (be.fgov.ehealth.certra.core.v2.LocalizedString)var4.next();
   ...
   public final TextType asTextType(LocalizedText inLocalizedText) {
      ...
      if (inLocalizedText != null) {
         ...
         if (inLocalizedText.getValues() != null) {
            ...
            Iterator var4 = inLocalizedText.getValues().iterator();

            while(var4.hasNext()) {
               LocalizedString avaluesItem = (LocalizedString)var4.next();
               avaluesTmpCollection.add(this.asLocalizedString(avaluesItem));
            }
         }
      }
   ...
   public final ActorType asActorType(Actor inActor) {
      ...
      if (inActor != null) {
         ...
         if (inActor.getFirstNames() != null) {
            ...
            var4 = inActor.getFirstNames().iterator();

            while(var4.hasNext()) {
               String afirstnamesItem = (String)var4.next();
         ...
         if (inActor.getIds() != null) {
            ...
            var4 = inActor.getIds().iterator();

            while(var4.hasNext()) {
               ActorId aidsItem = (ActorId)var4.next();
   ...
   public final Actor asActor(ActorType inActorType) {
      ...
      if (inActorType != null) {
         ...
         if (inActorType.getFirstNames() == null) {
            ...
            var4 = inActorType.getFirstNames().iterator();
         ...
         if (inActorType.getIds() == null) {
            ...
            var4 = inActorType.getIds().iterator();

            while(var4.hasNext()) {
               Id aidsItem = (Id)var4.next();
   ...
   public final ActorQualities asActorQualities(GetActorQualitiesResponse inGetActorQualitiesResponse) {
      ...
      if (inGetActorQualitiesResponse != null) {
         ...
         if (inGetActorQualitiesResponse.getOrganizationAuthorizations() != null) {
            ...
            Iterator var4 = inGetActorQualitiesResponse.getOrganizationAuthorizations().iterator();

            while(var4.hasNext()) {
               OrganizationType aorganizationauthorizationsItem = (OrganizationType)var4.next();
   ...
   public RaMapperSelmaGeneratedClass() {
   }
}
