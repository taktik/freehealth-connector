...
@XmlType(
   name = "SinglePalliativeCareRequestType",
   propOrder = {"careReceiverId", "palliativeCareDetail"}
)
@XmlRootElement(
   name = "SinglePalliativeCareRequest"
)
public class SinglePalliativeCareRequest implements Serializable {
   ...
   public SinglePalliativeCareRequest() {
   }
