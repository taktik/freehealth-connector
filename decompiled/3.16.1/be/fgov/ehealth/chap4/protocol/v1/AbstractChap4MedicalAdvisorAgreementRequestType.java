...
@XmlType(
   name = "AbstractChap4MedicalAdvisorAgreementRequestType",
   propOrder = {"commonInput", "recordCommonInput", "careReceiver", "request"}
)
@XmlSeeAlso({ConsultChap4MedicalAdvisorAgreementRequest.class, AskChap4MedicalAdvisorAgreementRequest.class})
public class AbstractChap4MedicalAdvisorAgreementRequestType extends be.fgov.ehealth.commons.protocol.v1.RequestType implements Serializable {
