package be.ehealth.businessconnector.mediprima.validator;

import be.ehealth.technicalconnector.exception.TechnicalConnectorException;
import be.ehealth.technicalconnector.validator.ValidatorHelper;

public final class XmlValidator {
   private static final String MEDIPRIMA_XSD = "/ehealth-mediprima/XSD/ehealth-mediprima-protocol-1_0.xsd";
   ...
   public static void validateXml(Object xmlObject) throws TechnicalConnectorException {
      ValidatorHelper.validate(xmlObject, "/ehealth-mediprima/XSD/ehealth-mediprima-protocol-1_0.xsd");
   }
}
