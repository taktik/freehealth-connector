...
public class PublicationEh2EboxServiceImpl implements PublicationService, ConfigurationModuleBootstrap.ModuleBootstrapHook {
   private EhboxReplyValidator replyValidator;
   private SessionValidator sessionValidator;
   private static final Logger LOG = LoggerFactory.getLogger(PublicationEh2EboxServiceImpl.class);
   ...
   public PublicationEh2EboxServiceImpl() {
   ...
   public final SendMessageResponse sendMessage(SAMLToken token, SendMessageRequest request) throws ConnectorException {
      try {
         return (SendMessageResponse)EhBoxServiceHelper.callEhBoxService(token, ServiceFactory.getEh2EboxPublicationService(token), "urn:be:fgov:ehealth:ehbox:publication:protocol:v3:sendMessage", request, SendMessageResponse.class, this.sessionValidator, this.replyValidator);
