package be.ehealth.businessconnector.mycarenet.memberdata.service.impl;

import be.ehealth.businessconnector.mycarenet.memberdata.service.MemberDataService;
import be.ehealth.businessconnector.mycarenet.memberdata.service.ServiceFactory;
...
public class MemberDataServiceImpl implements MemberDataService, ConfigurationModuleBootstrap.ModuleBootstrapHook {
   ...
   public final MemberDataConsultationResponse consultMemberData(SAMLToken token, MemberDataConsultationRequest request) throws TechnicalConnectorException {
      try {
         ...
         return (MemberDataConsultationResponse)xmlResponse.asObject(MemberDataConsultationResponse.class);
