...
@XmlType(
   name = "getPrescriptionForExecutorParam",
   propOrder = {"rid", "symmKey", "version"}
)
@XmlRootElement(
   name = "getPrescriptionForExecutorParam"
)
public class GetPrescriptionForExecutorParam extends PartyIdentification implements Equals, HashCode, ToString {
   ...
   public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
      if (!(object instanceof GetPrescriptionForExecutorParam)) {
         return false;
      } else if (this == object) {
         return true;
         ...
         GetPrescriptionForExecutorParam that = (GetPrescriptionForExecutorParam)object;
