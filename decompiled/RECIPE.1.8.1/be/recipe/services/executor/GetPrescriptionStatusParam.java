...
public class GetPrescriptionStatusParam extends PartyIdentification implements Equals, HashCode, ToString {
   @XmlElement(
      required = true
   )
   ...
   public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
      if (!(object instanceof GetPrescriptionStatusParam)) {
         return false;
      } else if (this == object) {
         return true;
         ...
         GetPrescriptionStatusParam that = (GetPrescriptionStatusParam)object;
