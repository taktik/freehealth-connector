...
@XmlType(
   name = "markAsDeliveredParam",
   propOrder = {"rid", "symmKey"}
)
@XmlRootElement(
   name = "markAsDeliveredParam"
)
public class MarkAsDeliveredParam extends PartyIdentification implements Equals, HashCode, ToString {
   @XmlElement(
      required = true
   )
   ...
   public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
      if (!(object instanceof MarkAsDeliveredParam)) {
         return false;
      } else if (this == object) {
         return true;
         ...
         MarkAsDeliveredParam that = (MarkAsDeliveredParam)object;
