...
@XmlType(
   name = "markAsUndeliveredParam",
   propOrder = {"rid", "symmKey"}
)
@XmlRootElement(
   name = "markAsUndeliveredParam"
)
public class MarkAsUndeliveredParam extends PartyIdentification implements Equals, HashCode, ToString {
   @XmlElement(
      required = true
   )
   ...
   public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
      if (!(object instanceof MarkAsUndeliveredParam)) {
         return false;
      } else if (this == object) {
         return true;
         ...
         MarkAsUndeliveredParam that = (MarkAsUndeliveredParam)object;
