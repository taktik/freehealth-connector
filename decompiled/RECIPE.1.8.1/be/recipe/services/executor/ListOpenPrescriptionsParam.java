...
@XmlType(
   ...
   propOrder = {"symmKey", "mandateHolderId", "page", "session"}
)
@XmlRootElement(
   name = "listOpenPrescriptionsParam"
)
public class ListOpenPrescriptionsParam extends PartyIdentification implements Equals, HashCode, ToString {
   @XmlElement(
      required = true
   )
   ...
   public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
      if (!(object instanceof ListOpenPrescriptionsParam)) {
         return false;
      } else if (this == object) {
         return true;
         ...
         ListOpenPrescriptionsParam that = (ListOpenPrescriptionsParam)object;
