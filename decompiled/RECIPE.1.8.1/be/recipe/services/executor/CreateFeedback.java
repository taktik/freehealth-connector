...
@XmlType(
   name = "createFeedback",
   propOrder = {"createFeedbackParamSealed", "programIdentification", "mguid"}
)
@XmlRootElement(
   name = "createFeedback"
)
public class CreateFeedback implements Equals, HashCode, ToString {
   @XmlElement(
   ...
   public void setCreateFeedbackParamSealed(byte[] value) {
      this.createFeedbackParamSealed = value;
   }
   ...
   public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy strategy) {
      byte[] theCreateFeedbackParamSealed = this.getCreateFeedbackParamSealed();
      strategy.appendField(locator, this, "createFeedbackParamSealed", buffer, theCreateFeedbackParamSealed);
   ...
   public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
      if (!(object instanceof CreateFeedback)) {
         return false;
      } else if (this == object) {
         return true;
      } else {
         CreateFeedback that = (CreateFeedback)object;
         byte[] lhsCreateFeedbackParamSealed = this.getCreateFeedbackParamSealed();
         byte[] rhsCreateFeedbackParamSealed = that.getCreateFeedbackParamSealed();
         if (!strategy.equals(LocatorUtils.property(thisLocator, "createFeedbackParamSealed", lhsCreateFeedbackParamSealed), LocatorUtils.property(thatLocator, "createFeedbackParamSealed", rhsCreateFeedbackParamSealed), lhsCreateFeedbackParamSealed, rhsCreateFeedbackParamSealed)) {
            return false;
         } else {
   ...
   public int hashCode(ObjectLocator locator, HashCodeStrategy strategy) {
      ...
      byte[] theCreateFeedbackParamSealed = this.getCreateFeedbackParamSealed();
      int currentHashCode = strategy.hashCode(LocatorUtils.property(locator, "createFeedbackParamSealed", theCreateFeedbackParamSealed), currentHashCode, theCreateFeedbackParamSealed);
      String theMguid = this.getProgramIdentification();
