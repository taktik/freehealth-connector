...
public class ValidationProperties implements Equals, HashCode, ToString {
   @XmlElement(
   ...
   public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy strategy) {
      byte[] theValidationPropertiesParamSealed = this.getValidationPropertiesParamSealed();
      strategy.appendField(locator, this, "validationPropertiesParamSealed", buffer, theValidationPropertiesParamSealed);
   ...
   public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
      if (!(object instanceof ValidationProperties)) {
         return false;
      } else if (this == object) {
         return true;
      } else {
         ValidationProperties that = (ValidationProperties)object;
         byte[] lhsValidationPropertiesParamSealed = this.getValidationPropertiesParamSealed();
         byte[] rhsValidationPropertiesParamSealed = that.getValidationPropertiesParamSealed();
         if (!strategy.equals(LocatorUtils.property(thisLocator, "validationPropertiesParamSealed", lhsValidationPropertiesParamSealed), LocatorUtils.property(thatLocator, "validationPropertiesParamSealed", rhsValidationPropertiesParamSealed), lhsValidationPropertiesParamSealed, rhsValidationPropertiesParamSealed)) {
            return false;
         } else {
   ...
   public int hashCode(ObjectLocator locator, HashCodeStrategy strategy) {
      ...
      byte[] theValidationPropertiesParamSealed = this.getValidationPropertiesParamSealed();
      int currentHashCode = strategy.hashCode(LocatorUtils.property(locator, "validationPropertiesParamSealed", theValidationPropertiesParamSealed), currentHashCode, theValidationPropertiesParamSealed);
      String theMguid = this.getProgramIdentification();
