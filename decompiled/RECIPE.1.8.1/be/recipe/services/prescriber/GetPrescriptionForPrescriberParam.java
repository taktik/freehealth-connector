...
public class GetPrescriptionForPrescriberParam extends PartyIdentification implements Equals, HashCode, ToString {
   @XmlElement(
      required = true
   )
   ...
   public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
      if (!(object instanceof GetPrescriptionForPrescriberParam)) {
         return false;
      } else if (this == object) {
         return true;
         ...
         GetPrescriptionForPrescriberParam that = (GetPrescriptionForPrescriberParam)object;
