...
public class PutVision implements Equals, HashCode, ToString {
   @XmlElement(
   ...
   public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy strategy) {
      byte[] thePutVisionParamSealed = this.getPutVisionParamSealed();
      strategy.appendField(locator, this, "putVisionParamSealed", buffer, thePutVisionParamSealed);
   ...
   public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
      if (!(object instanceof PutVision)) {
         return false;
      } else if (this == object) {
         return true;
      } else {
         PutVision that = (PutVision)object;
         byte[] lhsPutVisionParamSealed = this.getPutVisionParamSealed();
         byte[] rhsPutVisionParamSealed = that.getPutVisionParamSealed();
         if (!strategy.equals(LocatorUtils.property(thisLocator, "putVisionParamSealed", lhsPutVisionParamSealed), LocatorUtils.property(thatLocator, "putVisionParamSealed", rhsPutVisionParamSealed), lhsPutVisionParamSealed, rhsPutVisionParamSealed)) {
            return false;
         } else {
   ...
   public int hashCode(ObjectLocator locator, HashCodeStrategy strategy) {
      ...
      byte[] thePutVisionParamSealed = this.getPutVisionParamSealed();
      int currentHashCode = strategy.hashCode(LocatorUtils.property(locator, "putVisionParamSealed", thePutVisionParamSealed), currentHashCode, thePutVisionParamSealed);
      String theMguid = this.getProgramIdentification();
