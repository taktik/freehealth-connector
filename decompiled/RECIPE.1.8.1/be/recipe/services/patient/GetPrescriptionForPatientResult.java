...
public class GetPrescriptionForPatientResult extends ResponseType implements Equals, HashCode, ToString {
   @XmlElement(
      type = String.class
   )
   ...
   public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
      if (!(object instanceof GetPrescriptionForPatientResult)) {
         return false;
      } else if (this == object) {
         return true;
         ...
         GetPrescriptionForPatientResult that = (GetPrescriptionForPatientResult)object;
