...
public class UpdateFeedbackFlag implements Equals, HashCode, ToString {
   @XmlElement(
   ...
   public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy strategy) {
      byte[] theUpdateFeedbackFlagParamSealed = this.getUpdateFeedbackFlagParamSealed();
      strategy.appendField(locator, this, "updateFeedbackFlagParamSealed", buffer, theUpdateFeedbackFlagParamSealed);
   ...
   public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
      if (!(object instanceof UpdateFeedbackFlag)) {
         return false;
      } else if (this == object) {
         return true;
      } else {
         UpdateFeedbackFlag that = (UpdateFeedbackFlag)object;
         byte[] lhsUpdateFeedbackFlagParamSealed = this.getUpdateFeedbackFlagParamSealed();
         byte[] rhsUpdateFeedbackFlagParamSealed = that.getUpdateFeedbackFlagParamSealed();
         if (!strategy.equals(LocatorUtils.property(thisLocator, "updateFeedbackFlagParamSealed", lhsUpdateFeedbackFlagParamSealed), LocatorUtils.property(thatLocator, "updateFeedbackFlagParamSealed", rhsUpdateFeedbackFlagParamSealed), lhsUpdateFeedbackFlagParamSealed, rhsUpdateFeedbackFlagParamSealed)) {
            return false;
         } else {
   ...
   public int hashCode(ObjectLocator locator, HashCodeStrategy strategy) {
      ...
      byte[] theUpdateFeedbackFlagParamSealed = this.getUpdateFeedbackFlagParamSealed();
      int currentHashCode = strategy.hashCode(LocatorUtils.property(locator, "updateFeedbackFlagParamSealed", theUpdateFeedbackFlagParamSealed), currentHashCode, theUpdateFeedbackFlagParamSealed);
      String theMguid = this.getProgramIdentification();
