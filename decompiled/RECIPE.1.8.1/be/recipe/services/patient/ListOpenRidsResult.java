...
public class ListOpenRidsResult extends ResponseType implements Equals, HashCode, ToString {
   protected List<ListOpenRidsResultItem> items;
   ...
   public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy strategy) {
      ...
      List<ListOpenRidsResultItem> theItems = this.items != null && !this.items.isEmpty() ? this.getItems() : null;
   ...
   public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
      if (!(object instanceof ListOpenRidsResult)) {
         ...
         List<ListOpenRidsResultItem> lhsItems = this.items != null && !this.items.isEmpty() ? this.getItems() : null;
         List<ListOpenRidsResultItem> rhsItems = that.items != null && !that.items.isEmpty() ? that.getItems() : null;
