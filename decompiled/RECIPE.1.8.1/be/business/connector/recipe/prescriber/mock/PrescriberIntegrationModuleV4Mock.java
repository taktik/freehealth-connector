...
public class PrescriberIntegrationModuleV4Mock extends PrescriberIntegrationModuleDevV4Impl implements PrescriberIntegrationModuleDevV4 {
   private static final Logger LOG = Logger.getLogger(PrescriberIntegrationModuleV4Mock.class);

   public PrescriberIntegrationModuleV4Mock() throws IntegrationModuleException {
   }
   ...
   public PutVisionResult putData(PutVisionParam request) throws IntegrationModuleException {
