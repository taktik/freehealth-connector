...
public abstract class AbstractPrescriberIntegrationModule extends AbstractIntegrationModule {
   ...
   protected void checkStatus(be.recipe.services.core.ResponseType response) throws IntegrationModuleException {
      if (!"100".equals(response.getStatus().getCode()) && !"200".equals(response.getStatus().getCode())) {
         LOG.error("Error Status received : " + response.getStatus().getCode());
   ...
   protected KeyResult getNewKey(String patientId, String prescriptionType) throws IntegrationModuleException {
      KeyResult key = null;
   ...
   private static void ajc$preClinit() {
      ...
      ajc$tjp_1 = var0.makeSJP("method-execution", var0.makeMethodSig("4", "sealPrescriptionForUnknown", "be.business.connector.recipe.prescriber.AbstractPrescriberIntegrationModule", "be.ehealth.technicalconnector.service.kgss.domain.KeyResult:[B", "key:messageToProtect", "be.business.connector.core.exceptions.IntegrationModuleException", "[B"), 333);
      ajc$tjp_2 = var0.makeSJP("method-execution", var0.makeMethodSig("4", "unsealFeedback", "be.business.connector.recipe.prescriber.AbstractPrescriberIntegrationModule", "[B", "message", "be.business.connector.core.exceptions.IntegrationModuleException", "[B"), 347);
