...
public class ExecutorIntegrationModuleV4Impl extends ExecutorIntegrationModuleImpl implements ExecutorIntegrationModuleV4 {
   private final Map<MultiKey, byte[]> sessionMap = new HashMap();
   // $FF: synthetic field
   ...
   public ListOpenPrescriptionsResult getData(ListOpenPrescriptionsParam param) throws IntegrationModuleException {
      ...
      try {
         try {
            ...
            this.sessionMap.put(new MultiKey(param.getExecutorId(), param.getPatientId()), result.getSession());
            return result;
   ...
   private ListRelationsRequest getListPatientRelation(ListRelationsParam data) throws IntegrationModuleException {
      ...
      data.setSession((byte[])this.sessionMap.get(new MultiKey(data.getExecutorId(), data.getPatientId())));
   ...
   private static void ajc$preClinit() {
      ...
      ajc$tjp_4 = var0.makeSJP("method-execution", var0.makeMethodSig("1", "markAsArchived", "be.business.connector.recipe.executor.ExecutorIntegrationModuleV4Impl", "java.lang.String", "rid", "be.business.connector.core.exceptions.IntegrationModuleException", "void"), 413);
      ajc$tjp_5 = var0.makeSJP("method-execution", var0.makeMethodSig("1", "markAsDelivered", "be.business.connector.recipe.executor.ExecutorIntegrationModuleV4Impl", "java.lang.String", "rid", "be.business.connector.core.exceptions.IntegrationModuleException", "void"), 447);
      ajc$tjp_6 = var0.makeSJP("method-execution", var0.makeMethodSig("1", "markAsUndelivered", "be.business.connector.recipe.executor.ExecutorIntegrationModuleV4Impl", "java.lang.String", "rid", "be.business.connector.core.exceptions.IntegrationModuleException", "void"), 480);
      ajc$tjp_7 = var0.makeSJP("method-execution", var0.makeMethodSig("1", "revokePrescription", "be.business.connector.recipe.executor.ExecutorIntegrationModuleV4Impl", "java.lang.String:java.lang.String", "rid:reason", "be.business.connector.core.exceptions.IntegrationModuleException", "void"), 517);
      ajc$tjp_8 = var0.makeSJP("method-execution", var0.makeMethodSig("1", "listNotifications", "be.business.connector.recipe.executor.ExecutorIntegrationModuleV4Impl", "boolean", "readFlag", "be.business.connector.core.exceptions.IntegrationModuleException", "java.util.List"), 551);
      ajc$tjp_9 = var0.makeSJP("method-execution", var0.makeMethodSig("1", "createFeedback", "be.business.connector.recipe.executor.ExecutorIntegrationModuleV4Impl", "java.lang.String:java.lang.String:[B", "prescriberId:rid:feedbackText", "be.business.connector.core.exceptions.IntegrationModuleException", "void"), 588);
   }
}
