...
public class AuthorPaginationRequestType extends AuthorRequestType implements Equals, HashCode, ToString {
   @XmlAttribute(
      name = "Offset",
      required = true
   )
   ...
   public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
      if (!(object instanceof AuthorPaginationRequestType)) {
         return false;
      } else if (this == object) {
         return true;
         ...
         AuthorPaginationRequestType that = (AuthorPaginationRequestType)object;
