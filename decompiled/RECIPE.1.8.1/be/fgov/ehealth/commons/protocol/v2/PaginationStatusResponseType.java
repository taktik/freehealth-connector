...
@XmlType(
   name = "PaginationStatusResponseType"
)
public class PaginationStatusResponseType extends StatusResponseType implements Equals, HashCode, ToString {
   @XmlAttribute(
      name = "Offset",
      required = true
   )
   ...
   public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
      if (!(object instanceof PaginationStatusResponseType)) {
         return false;
      } else if (this == object) {
         return true;
         ...
         PaginationStatusResponseType that = (PaginationStatusResponseType)object;
