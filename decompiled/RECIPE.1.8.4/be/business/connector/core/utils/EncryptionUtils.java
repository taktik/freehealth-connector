         ...
         try {
            ...
            if (stream != null) {
               try {
                  ...
                  throw new IntegrationModuleException(I18nHelper.getLabel("error.keystore.password"), var8);
               }
            ...
            LOG.error("Invalid old keystore configuration", var9);
            throw new IntegrationModuleException(I18nHelper.getLabel("error.keystore"), var9);
         }
      }
