...
@WebServiceClient(
   ...
   wsdlLocation = "file:/C:/projects/development/recipe-business-connector_1.8.0_release/business-connector/be-ehealth-recipe-client/src/main/resources/META-INF/ehealth-recipe-services/WSDL/RecipeWebService-executor-2_0.wsdl",
...
public class RecipeExecutorService extends Service {
   ...
   static {
      ...
      try {
         url = new URL("file:/C:/projects/development/recipe-business-connector_1.8.0_release/business-connector/be-ehealth-recipe-client/src/main/resources/META-INF/ehealth-recipe-services/WSDL/RecipeWebService-executor-2_0.wsdl");
      } catch (MalformedURLException var2) {
         Logger.getLogger(RecipeExecutorService.class.getName()).log(Level.INFO, "Can not initialize the default wsdl from {0}", "file:/C:/projects/development/recipe-business-connector_1.8.0_release/business-connector/be-ehealth-recipe-client/src/main/resources/META-INF/ehealth-recipe-services/WSDL/RecipeWebService-executor-2_0.wsdl");
      }
