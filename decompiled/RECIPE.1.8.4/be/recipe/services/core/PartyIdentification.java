...
@XmlSeeAlso({ListOpenRidsParam.class, UpdateFeedbackFlagParam.class, PutVisionParam.class, ListRidsHistoryParam.class, CreatePrescriptionParam.class, GetPrescriptionStatusParam.class, RevokePrescriptionParam.class, GetPrescriptionForPrescriberParam.class, ListFeedbacksParam.class, ValidationPropertiesParam.class, SendNotificationParam.class, MarkAsArchivedParam.class, CreateFeedbackParam.class, PutRidsInProcessParam.class, GetPrescriptionForExecutorParam.class, be.recipe.services.executor.ListRidsHistoryParam.class, ListRidsInProcessParam.class, MarkAsUndeliveredParam.class, MarkAsDeliveredParam.class, ListNotificationsParam.class, ListRelationsParam.class, ListOpenPrescriptionsParam.class, ListReservationsParam.class, be.recipe.services.executor.GetPrescriptionStatusParam.class, be.recipe.services.executor.RevokePrescriptionParam.class, be.recipe.services.patient.ListOpenRidsParam.class, ListPatientPrescriptionsParam.class, GetPrescriptionForPatientParam.class, CreateRelationParam.class, be.recipe.services.patient.ListRelationsParam.class, be.recipe.services.patient.UpdateFeedbackFlagParam.class, be.recipe.services.patient.RevokePrescriptionParam.class, RevokeRelationParam.class})
public class PartyIdentification implements Equals, HashCode, ToString {
