...
public class ListOpenRidsResult extends ResponseType implements Equals, HashCode, ToString {
   ...
   public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
      if (!(object instanceof ListOpenRidsResult)) {
         return false;
      } else if (this == object) {
         return true;
         ...
         ListOpenRidsResult that = (ListOpenRidsResult)object;
