...
public class GetPrescriptionForPrescriber implements Equals, HashCode, ToString {
   @XmlElement(
   ...
   public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy strategy) {
      byte[] theGetPrescriptionForPrescriberParamSealed = this.getGetPrescriptionForPrescriberParamSealed();
      strategy.appendField(locator, this, "getPrescriptionForPrescriberParamSealed", buffer, theGetPrescriptionForPrescriberParamSealed);
   ...
   public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
      if (!(object instanceof GetPrescriptionForPrescriber)) {
         return false;
      } else if (this == object) {
         return true;
      } else {
         GetPrescriptionForPrescriber that = (GetPrescriptionForPrescriber)object;
         byte[] lhsGetPrescriptionForPrescriberParamSealed = this.getGetPrescriptionForPrescriberParamSealed();
         byte[] rhsGetPrescriptionForPrescriberParamSealed = that.getGetPrescriptionForPrescriberParamSealed();
         if (!strategy.equals(LocatorUtils.property(thisLocator, "getPrescriptionForPrescriberParamSealed", lhsGetPrescriptionForPrescriberParamSealed), LocatorUtils.property(thatLocator, "getPrescriptionForPrescriberParamSealed", rhsGetPrescriptionForPrescriberParamSealed), lhsGetPrescriptionForPrescriberParamSealed, rhsGetPrescriptionForPrescriberParamSealed)) {
            return false;
         } else {
   ...
   public int hashCode(ObjectLocator locator, HashCodeStrategy strategy) {
      ...
      byte[] theGetPrescriptionForPrescriberParamSealed = this.getGetPrescriptionForPrescriberParamSealed();
      int currentHashCode = strategy.hashCode(LocatorUtils.property(locator, "getPrescriptionForPrescriberParamSealed", theGetPrescriptionForPrescriberParamSealed), currentHashCode, theGetPrescriptionForPrescriberParamSealed);
      String theMguid = this.getProgramIdentification();
