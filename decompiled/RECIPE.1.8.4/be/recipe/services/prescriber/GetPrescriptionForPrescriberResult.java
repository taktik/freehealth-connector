...
public class GetPrescriptionForPrescriberResult extends ResponseType implements Equals, HashCode, ToString {
   @XmlElement(
      type = String.class
   )
   ...
   public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
      if (!(object instanceof GetPrescriptionForPrescriberResult)) {
         return false;
      } else if (this == object) {
         return true;
         ...
         GetPrescriptionForPrescriberResult that = (GetPrescriptionForPrescriberResult)object;
