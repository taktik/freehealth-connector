...
public class GetListOpenPrescriptionParam extends PartyIdentification implements Equals, HashCode, ToString {
   @XmlElement(
      required = true
   )
   ...
   public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
      if (!(object instanceof GetListOpenPrescriptionParam)) {
         return false;
      } else if (this == object) {
         return true;
         ...
         GetListOpenPrescriptionParam that = (GetListOpenPrescriptionParam)object;
