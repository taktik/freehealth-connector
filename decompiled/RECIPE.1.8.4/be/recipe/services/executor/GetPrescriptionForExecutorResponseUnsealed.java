...
@XmlType(
   name = "getPrescriptionForExecutorResponseUnsealed",
   propOrder = {"getPrescriptionForExecutorResult"}
)
@XmlRootElement(
   name = "getPrescriptionForExecutorResponseUnsealed"
)
public class GetPrescriptionForExecutorResponseUnsealed implements Equals, HashCode, ToString {
   @XmlElement(
   ...
   public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
      if (!(object instanceof GetPrescriptionForExecutorResponseUnsealed)) {
         return false;
      } else if (this == object) {
         return true;
      } else {
         GetPrescriptionForExecutorResponseUnsealed that = (GetPrescriptionForExecutorResponseUnsealed)object;
