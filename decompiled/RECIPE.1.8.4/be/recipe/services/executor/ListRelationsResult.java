...
@XmlType(
   name = "listRelationsResult",
   propOrder = {"items", "hasMoreResults", "session"}
)
@XmlRootElement(
   name = "listRelationsResult"
)
public class ListRelationsResult extends ResponseType implements Equals, HashCode, ToString {
   ...
   public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy strategy) {
      ...
      List<ListRelationsItem> theItems = this.items != null && !this.items.isEmpty() ? this.getItems() : null;
   ...
   public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
      if (!(object instanceof ListRelationsResult)) {
         return false;
      } else if (this == object) {
         return true;
         ...
         ListRelationsResult that = (ListRelationsResult)object;
         List<ListRelationsItem> lhsItems = this.items != null && !this.items.isEmpty() ? this.getItems() : null;
         List<ListRelationsItem> rhsItems = that.items != null && !that.items.isEmpty() ? that.getItems() : null;
