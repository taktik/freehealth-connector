...
public class ListOpenPrescriptionsResult extends ResponseType implements Equals, HashCode, ToString {
   protected List<GetOpenPrescriptionForExecutor> prescriptions;
   protected Boolean hasMoreResults;
   protected byte[] session;

   public List<GetOpenPrescriptionForExecutor> getPrescriptions() {
   ...
   public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy strategy) {
      ...
      List<GetOpenPrescriptionForExecutor> thePrescriptions = this.prescriptions != null && !this.prescriptions.isEmpty() ? this.getPrescriptions() : null;
   ...
   public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
      if (!(object instanceof ListOpenPrescriptionsResult)) {
         return false;
      } else if (this == object) {
         return true;
         ...
         ListOpenPrescriptionsResult that = (ListOpenPrescriptionsResult)object;
         List<GetOpenPrescriptionForExecutor> lhsPrescriptions = this.prescriptions != null && !this.prescriptions.isEmpty() ? this.getPrescriptions() : null;
         List<GetOpenPrescriptionForExecutor> rhsPrescriptions = that.prescriptions != null && !that.prescriptions.isEmpty() ? that.getPrescriptions() : null;
