...
@XmlType(
   name = "listRelationsParam",
   propOrder = {"symmKey", "mandateHolderId", "page", "session"}
)
@XmlRootElement(
   name = "listRelationsParam"
)
public class ListRelationsParam extends PartyIdentification implements Equals, HashCode, ToString {
   @XmlElement(
      required = true
   )
   ...
   public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
      if (!(object instanceof ListRelationsParam)) {
         return false;
      } else if (this == object) {
         return true;
         ...
         ListRelationsParam that = (ListRelationsParam)object;
