...
@XmlType(
   ...
   propOrder = {"listOpenPrescriptionsParamSealed", "programIdentification", "mguid"}
)
@XmlRootElement(
   name = "listOpenPrescriptions"
)
public class ListOpenPrescriptions implements Equals, HashCode, ToString {
   @XmlElement(
   ...
   public void setListOpenPrescriptionsParamSealed(byte[] value) {
      this.listOpenPrescriptionsParamSealed = value;
   }
   ...
   public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy strategy) {
      byte[] theListOpenPrescriptionsParamSealed = this.getListOpenPrescriptionsParamSealed();
      strategy.appendField(locator, this, "listOpenPrescriptionsParamSealed", buffer, theListOpenPrescriptionsParamSealed);
   ...
   public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
      if (!(object instanceof ListOpenPrescriptions)) {
         return false;
      } else if (this == object) {
         return true;
      } else {
         ListOpenPrescriptions that = (ListOpenPrescriptions)object;
         byte[] lhsListOpenPrescriptionsParamSealed = this.getListOpenPrescriptionsParamSealed();
         byte[] rhsListOpenPrescriptionsParamSealed = that.getListOpenPrescriptionsParamSealed();
         if (!strategy.equals(LocatorUtils.property(thisLocator, "listOpenPrescriptionsParamSealed", lhsListOpenPrescriptionsParamSealed), LocatorUtils.property(thatLocator, "listOpenPrescriptionsParamSealed", rhsListOpenPrescriptionsParamSealed), lhsListOpenPrescriptionsParamSealed, rhsListOpenPrescriptionsParamSealed)) {
            return false;
         } else {
   ...
   public int hashCode(ObjectLocator locator, HashCodeStrategy strategy) {
      ...
      byte[] theListOpenPrescriptionsParamSealed = this.getListOpenPrescriptionsParamSealed();
      int currentHashCode = strategy.hashCode(LocatorUtils.property(locator, "listOpenPrescriptionsParamSealed", theListOpenPrescriptionsParamSealed), currentHashCode, theListOpenPrescriptionsParamSealed);
      String theMguid = this.getProgramIdentification();
