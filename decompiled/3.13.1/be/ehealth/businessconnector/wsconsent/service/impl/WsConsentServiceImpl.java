...
public class WsConsentServiceImpl implements WsConsentService, ConfigurationModuleBootstrap.ModuleBootstrapHook {
   ...
   private static final String WSCONSENT_PROT = "/ehealth-hubservices/XSD/hubservices_protocol-2_2.xsd";
   ...
   protected GenericRequest getPort(SAMLToken token) throws TechnicalConnectorException {
      ...
      req.setHandlerChain(HandlerChainUtil.buildChainWithValidator("validation.incoming.wsconsent.message", "/ehealth-hubservices/XSD/hubservices_protocol-2_2.xsd"));
