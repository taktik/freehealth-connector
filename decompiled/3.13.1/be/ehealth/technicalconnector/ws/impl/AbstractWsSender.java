...
public abstract class AbstractWsSender {
   ...
   private static ConfigurableFactoryHelper<InvokeStrategy> invokeStrategyHelper = new ConfigurableFactoryHelper("be.ehealth.technicalconnector.ws.genericsender.invokestrategy", NoRetryInvokeStrategy.class.getName());
