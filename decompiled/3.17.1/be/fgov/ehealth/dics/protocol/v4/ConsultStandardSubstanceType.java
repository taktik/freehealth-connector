...
@XmlType(
   name = "ConsultStandardSubstanceType",
   propOrder = {"name", "definition", "url"}
)
@XmlSeeAlso({ConsultStandardSubstanceAndSubstanceType.class})
public class ConsultStandardSubstanceType implements Serializable {
