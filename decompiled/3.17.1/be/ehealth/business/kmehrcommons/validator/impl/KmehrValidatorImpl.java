...
public class KmehrValidatorImpl implements KmehrValidator {
   protected static final String KMEHR_LOCATION = "/ehealth-kmehr/XSD/kmehr_elements-1_28.xsd";

   public void validateKmehrMessage(Kmehrmessage msg) throws TechnicalConnectorException {
      ValidatorHelper.validate(msg, Kmehrmessage.class, "/ehealth-kmehr/XSD/kmehr_elements-1_28.xsd");
   }
}
