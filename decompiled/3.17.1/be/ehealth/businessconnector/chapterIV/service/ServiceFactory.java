...
public final class ServiceFactory {
   ...
   protected static final String CH4_PROT = "/ehealth-chapteriv/XSD/chap4services_protocol-1_0.xsd";
   ...
   public static GenericRequest getConsultationService(SAMLToken token) throws MalformedURLException, TechnicalConnectorException, ChapterIVBusinessConnectorException {
      ...
      genReq.setHandlerChain(HandlerChainUtil.buildChainWithValidator("validation.incoming.chapterIV.consultation.message", "/ehealth-chapteriv/XSD/chap4services_protocol-1_0.xsd"));
      return genReq;
   }
   ...
   public static GenericRequest getAdmissionService(SAMLToken token) throws MalformedURLException, TechnicalConnectorException, ChapterIVBusinessConnectorException {
      ...
      genReq.setCredential(token, TokenType.SAML);
      genReq.setDefaultHandlerChain();
      genReq.setHandlerChain(HandlerChainUtil.buildChainWithValidator("validation.incoming.chapterIV.admission.message", "/ehealth-chapteriv/XSD/chap4services_protocol-1_0.xsd"));
      return genReq;
   }
}
