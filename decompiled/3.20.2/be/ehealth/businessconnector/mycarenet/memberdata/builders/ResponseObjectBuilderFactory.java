...
public final class ResponseObjectBuilderFactory {
   ...
   private static final String DEFAULT_RESPONSEBUILDER_CLASS = "be.ehealth.businessconnector.mycarenet.memberdata.builders.impl.ResponseObjectBuilderImpl";
   private static ConfigurableFactoryHelper<ResponseObjectBuilder> helperFactoryresponseBuilder = new ConfigurableFactoryHelper("memberdata.responseobjectbuilder.class", "be.ehealth.businessconnector.mycarenet.memberdata.builders.impl.ResponseObjectBuilderImpl");
