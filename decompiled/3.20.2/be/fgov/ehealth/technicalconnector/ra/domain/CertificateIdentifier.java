...
public final class CertificateIdentifier implements Serializable {
   ...
   private CertificateIdentifier(CertificateIdentifier.Builder builder) {
      this.actor = builder.actor;
      this.applicationId = builder.applicationId;
   }

   public static CertificateIdentifier.Builder newBuilder() {
      return new CertificateIdentifier.Builder();
   }
   ...
   // $FF: synthetic method
   CertificateIdentifier(CertificateIdentifier.Builder x0, Object x1) {
      this(x0);
   }
