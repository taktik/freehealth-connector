...
@XmlType(
   name = "SingleNurseContractualCareResponseType",
   propOrder = {"careReceiverDetail", "nurseContractualCareResponseDetail", "careReceiverId", "messageFault", "nurseContractualCareRequestDetail"}
)
@XmlRootElement(
   name = "SingleNurseContractualCareResponse"
)
public class SingleNurseContractualCareResponse implements Serializable {
   ...
   protected NurseContractualCareResponseDetail nurseContractualCareResponseDetail;
   @XmlElement(
      name = "CareReceiverId"
   )
   ...
   public NurseContractualCareResponseDetail getNurseContractualCareResponseDetail() {
      return this.nurseContractualCareResponseDetail;
   }
