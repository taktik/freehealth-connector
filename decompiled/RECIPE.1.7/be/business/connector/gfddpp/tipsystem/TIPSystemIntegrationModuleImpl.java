...
import org.taktik.connector.business.recipeprojects.core.utils.SealedProcessor;
...
import org.taktik.connector.business.recipeprojects.common.utils.ProductFilterUtils;
...
public class TIPSystemIntegrationModuleImpl extends AbstractIntegrationModule implements TIPSystemIntegrationModule {
   ...
   static final StoreDataEntriesResponse registerMedicationSchemeEntries_aroundBody6(TIPSystemIntegrationModuleImpl ajc$this, StoreDataEntriesRequest storeRequest, JoinPoint var2) {
      ...
      if (CollectionUtils.isNotEmpty(errors)) {
         ...
         try {
            ...
            storeResponse.setVersion(oldMedicationSchemeVersion == null ? 1 : oldMedicationSchemeVersion.intValue() + 1);
            ...
            if (var41.hasNext()) {
               ...
               int newDataEntryVersion = oldDataEntryVersion == null ? 1 : oldDataEntryVersion.intValue() + 1;
   ...
   static final String getStatusMessages_aroundBody12(TIPSystemIntegrationModuleImpl ajc$this, String sGuid, String dGuid, JoinPoint var3) {
      ...
      try {
         ...
         if (StringUtils.isNoneBlank(sGuid)) {
   ...
   private static void ajc$preClinit() {
      ...
      ajc$tjp_0 = var0.makeSJP("method-execution", var0.makeMethodSig("1", "archivePrescription", "be.business.connector.gfddpp.tipsystem.TIPSystemIntegrationModuleImpl", "java.lang.String", "rid", "be.business.connector.core.exceptions.IntegrationModuleException", "java.lang.String"), 178);
      ajc$tjp_1 = var0.makeSJP("method-execution", var0.makeMethodSig("1", "archivePrescriptionComment", "be.business.connector.gfddpp.tipsystem.TIPSystemIntegrationModuleImpl", "java.lang.String:java.lang.String", "rid:comment", "be.business.connector.core.exceptions.IntegrationModuleException", "java.lang.String"), 236);
      ...
      ajc$tjp_6 = var0.makeSJP("method-execution", var0.makeMethodSig("1", "getStatusMessages", "be.business.connector.gfddpp.tipsystem.TIPSystemIntegrationModuleImpl", "java.lang.String:java.lang.String", "sGuid:dGuid", "be.business.connector.core.exceptions.IntegrationModuleException", "java.lang.String"), 738);
   }
