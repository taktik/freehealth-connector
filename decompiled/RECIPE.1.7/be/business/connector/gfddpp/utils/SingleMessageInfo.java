...
public class SingleMessageInfo {
   ...
   public final void initSingleMessageInfo(SingleMessage singleMessageObject) throws IntegrationModuleException {
      ...
      while(var7.hasNext()) {
         ...
         if (type instanceof ArchivePrescriptionEventType) {
            ...
            if (!(type instanceof MedicationSchemeEntriesRequest)) {
   ...
   public void validateKnownEventType() throws IntegrationModuleException {
      ...
      if (!this.HasBvacEventType && !this.HasPharmaceuticalCareEventType && !this.HasArchivePrescriptionEventType && !this.HasArchivePrescriptionCommentEventType && !this.HasMedicationSchemeEntriesRequest) {
         LOG.error("SingleMessageInfo=-----= ----- " + procedure + " =$=" + this.info + "error: error.validation.event.type");
         throw new IntegrationModuleException(I18nHelper.getLabel("error.validation.event.type"));
      }
   }
   ...
   public void validateEventTypesForRegisterData() throws IntegrationModuleException {
      ...
      if (!this.HasPharmaceuticalCareEventType && !this.HasBvacEventType && !this.HasArchivePrescriptionEventType && !this.HasArchivePrescriptionCommentEventType && !this.HasMedicationSchemeEntriesRequest) {
         LOG.error("SingleMessageInfo=-----= ----- " + procedure + " =$=" + this.info + "error: error.validation.event.type");
   ...
   public void validateEventTypesForUpdateData() throws IntegrationModuleException {
      ...
      if (!this.HasBvacEventType && !this.HasArchivePrescriptionEventType && !this.HasArchivePrescriptionCommentEventType && !this.HasMedicationSchemeEntriesRequest) {
   ...
   public void validateSingleMessageXsd() throws IntegrationModuleException, GFDDPPException {
      ...
      try {
         SingleMessageValidationXsd var3 = smvh;
         synchronized(smvh) {
   ...
   public void setGuids(String nihiiPharmacyNumber) throws IntegrationModuleException {
      ...
      if (this.HasMedicationSchemeEntriesRequest) {
         ...
         while(var5.hasNext()) {
            ...
            Iterator var17 = medicationSchemeEntriesRequest.getDataEntry().iterator();

            while(var17.hasNext()) {
               DataEntryRequest dataEntryRequest = (DataEntryRequest)var17.next();
   ...
   public String getEvents() throws IntegrationModuleException, GFDDPPException {
      ...
      if (this.HasBvacEventType) {
         ...
         Iterator var21 = wrapper.getAllEventsOfType(PharmaceuticalCareEventType.class).iterator();

         while(var21.hasNext()) {
            PharmaceuticalCareEventType pharmaceuticalCareEventType = (PharmaceuticalCareEventType)var21.next();
