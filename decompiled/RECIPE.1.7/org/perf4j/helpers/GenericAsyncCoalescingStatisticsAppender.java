...
public class GenericAsyncCoalescingStatisticsAppender {
   ...
   private class StopWatchesFromQueueIterator implements Iterator<StopWatch> {
      ...
      // $FF: synthetic method
      StopWatchesFromQueueIterator(GenericAsyncCoalescingStatisticsAppender.SyntheticClass_1 x1) {
         this();
      }
   }
   ...
   private class Dispatcher implements Runnable {
      ...
      // $FF: synthetic method
      Dispatcher(GenericAsyncCoalescingStatisticsAppender.SyntheticClass_1 x1) {
         this();
      }
   }
