...
public class IntrahubEncryptionUtil {
   ...
   public static <T> T encryptFolder(T request, String hubIdPropKey, String hubAppIdPropKey) throws IntraHubBusinessConnectorException, TechnicalConnectorException {
