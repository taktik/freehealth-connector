...
public class ObjectFactory {
   public KmehrHeaderGetTransactionList createKmehrHeaderGetTransactionList() {
      return new KmehrHeaderGetTransactionList();
   }
   ...
   public KmehrHeaderDeclareTransaction createKmehrHeaderDeclareTransaction() {
      return new KmehrHeaderDeclareTransaction();
   }
   ...
   public LatestUpdateListType createLatestUpdateListType() {
      return new LatestUpdateListType();
   }
   ...
   public SelectGetLatestUpdateType createSelectGetLatestUpdateType() {
      return new SelectGetLatestUpdateType();
   }
   ...
   public GetLatestUpdateRequest createGetLatestUpdateRequest() {
      return new GetLatestUpdateRequest();
   }

   public GetLatestUpdateResponse createGetLatestUpdateResponse() {
      return new GetLatestUpdateResponse();
   }
   ...
   public Latestupdate createLatestupdate() {
