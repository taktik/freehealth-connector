...
@WebServiceClient(
   ...
   wsdlLocation = "file:/C:/Workspace/BusinessConnector/business-connector/be-ehealth-recipe-client/src/main/resources/META-INF/ehealth-recipe-services/WSDL/RecipeWebService-executor-1_0.wsdl",
   targetNamespace = "urn:be:fgov:ehealth:recipe:protocol:v1"
)
public class RecipeExecutorService extends Service {
   public static final URL WSDL_LOCATION;
   public static final QName SERVICE = new QName("urn:be:fgov:ehealth:recipe:protocol:v1", "RecipeExecutorService");
   public static final QName RecipeExecutorServiceSOAP11 = new QName("urn:be:fgov:ehealth:recipe:protocol:v1", "RecipeExecutorServiceSOAP11");
   ...
   static {
      ...
      try {
         url = new URL("file:/C:/Workspace/BusinessConnector/business-connector/be-ehealth-recipe-client/src/main/resources/META-INF/ehealth-recipe-services/WSDL/RecipeWebService-executor-1_0.wsdl");
      } catch (MalformedURLException var2) {
         Logger.getLogger(RecipeExecutorService.class.getName()).log(Level.INFO, "Can not initialize the default wsdl from {0}", "file:/C:/Workspace/BusinessConnector/business-connector/be-ehealth-recipe-client/src/main/resources/META-INF/ehealth-recipe-services/WSDL/RecipeWebService-executor-1_0.wsdl");
      }
