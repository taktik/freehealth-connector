...
@XmlType(
   name = "PaginationResponseType"
)
public class PaginationResponseType extends ResponseType implements Equals, HashCode, ToString {
   @XmlAttribute(
      name = "Offset",
      required = true
   )
   ...
   public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
      if (!(object instanceof PaginationResponseType)) {
         return false;
      } else if (this == object) {
         return true;
         ...
         PaginationResponseType that = (PaginationResponseType)object;
