...
public class ListRidsHistoryResult extends ResponseType implements Equals, HashCode, ToString {
   ...
   public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy strategy) {
      ...
      List<ListRidsHistoryResultItem> theItems = this.items != null && !this.items.isEmpty() ? this.getItems() : null;
   ...
   public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
      if (!(object instanceof ListRidsHistoryResult)) {
         return false;
      } else if (this == object) {
         return true;
         ...
         ListRidsHistoryResult that = (ListRidsHistoryResult)object;
         List<ListRidsHistoryResultItem> lhsItems = this.items != null && !this.items.isEmpty() ? this.getItems() : null;
         List<ListRidsHistoryResultItem> rhsItems = that.items != null && !that.items.isEmpty() ? that.getItems() : null;
