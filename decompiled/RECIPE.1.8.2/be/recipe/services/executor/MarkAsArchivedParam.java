...
@XmlType(
   name = "markAsArchivedParam",
   propOrder = {"rid", "symmKey"}
)
@XmlRootElement(
   name = "markAsArchivedParam"
)
public class MarkAsArchivedParam extends PartyIdentification implements Equals, HashCode, ToString {
   @XmlElement(
      required = true
   )
   ...
   public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
      if (!(object instanceof MarkAsArchivedParam)) {
         return false;
      } else if (this == object) {
         return true;
         ...
         MarkAsArchivedParam that = (MarkAsArchivedParam)object;
