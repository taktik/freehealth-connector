...
public class ListOpenPrescription implements Equals, HashCode, ToString {
   @XmlElement(
   ...
   public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy strategy) {
      byte[] theGetListOpenPrescriptionParamSealed = this.getGetListOpenPrescriptionParamSealed();
      strategy.appendField(locator, this, "getListOpenPrescriptionParamSealed", buffer, theGetListOpenPrescriptionParamSealed);
   ...
   public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
      if (!(object instanceof ListOpenPrescription)) {
         return false;
      } else if (this == object) {
         return true;
      } else {
         ListOpenPrescription that = (ListOpenPrescription)object;
         byte[] lhsGetListOpenPrescriptionParamSealed = this.getGetListOpenPrescriptionParamSealed();
         byte[] rhsGetListOpenPrescriptionParamSealed = that.getGetListOpenPrescriptionParamSealed();
         if (!strategy.equals(LocatorUtils.property(thisLocator, "getListOpenPrescriptionParamSealed", lhsGetListOpenPrescriptionParamSealed), LocatorUtils.property(thatLocator, "getListOpenPrescriptionParamSealed", rhsGetListOpenPrescriptionParamSealed), lhsGetListOpenPrescriptionParamSealed, rhsGetListOpenPrescriptionParamSealed)) {
            return false;
         } else {
   ...
   public int hashCode(ObjectLocator locator, HashCodeStrategy strategy) {
      ...
      byte[] theGetListOpenPrescriptionParamSealed = this.getGetListOpenPrescriptionParamSealed();
      int currentHashCode = strategy.hashCode(LocatorUtils.property(locator, "getListOpenPrescriptionParamSealed", theGetListOpenPrescriptionParamSealed), currentHashCode, theGetListOpenPrescriptionParamSealed);
      String theMguid = this.getProgramIdentification();
