...
public class GetPrescriptionStatus implements Equals, HashCode, ToString {
   @XmlElement(
   ...
   public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy strategy) {
      byte[] theGetPrescriptionStatusParamSealed = this.getGetPrescriptionStatusParamSealed();
      strategy.appendField(locator, this, "getPrescriptionStatusParamSealed", buffer, theGetPrescriptionStatusParamSealed);
   ...
   public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
      if (!(object instanceof GetPrescriptionStatus)) {
         return false;
      } else if (this == object) {
         return true;
      } else {
         GetPrescriptionStatus that = (GetPrescriptionStatus)object;
         byte[] lhsGetPrescriptionStatusParamSealed = this.getGetPrescriptionStatusParamSealed();
         byte[] rhsGetPrescriptionStatusParamSealed = that.getGetPrescriptionStatusParamSealed();
         if (!strategy.equals(LocatorUtils.property(thisLocator, "getPrescriptionStatusParamSealed", lhsGetPrescriptionStatusParamSealed), LocatorUtils.property(thatLocator, "getPrescriptionStatusParamSealed", rhsGetPrescriptionStatusParamSealed), lhsGetPrescriptionStatusParamSealed, rhsGetPrescriptionStatusParamSealed)) {
            return false;
         } else {
   ...
   public int hashCode(ObjectLocator locator, HashCodeStrategy strategy) {
      ...
      byte[] theGetPrescriptionStatusParamSealed = this.getGetPrescriptionStatusParamSealed();
      int currentHashCode = strategy.hashCode(LocatorUtils.property(locator, "getPrescriptionStatusParamSealed", theGetPrescriptionStatusParamSealed), currentHashCode, theGetPrescriptionStatusParamSealed);
      String theMguid = this.getProgramIdentification();
