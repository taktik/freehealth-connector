...
public class RevokePrescription implements Equals, HashCode, ToString {
   @XmlElement(
   ...
   public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy strategy) {
      byte[] theRevokePrescriptionParamSealed = this.getRevokePrescriptionParamSealed();
      strategy.appendField(locator, this, "revokePrescriptionParamSealed", buffer, theRevokePrescriptionParamSealed);
   ...
   public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
      if (!(object instanceof RevokePrescription)) {
         return false;
      } else if (this == object) {
         return true;
      } else {
         RevokePrescription that = (RevokePrescription)object;
         byte[] lhsRevokePrescriptionParamSealed = this.getRevokePrescriptionParamSealed();
         byte[] rhsRevokePrescriptionParamSealed = that.getRevokePrescriptionParamSealed();
         if (!strategy.equals(LocatorUtils.property(thisLocator, "revokePrescriptionParamSealed", lhsRevokePrescriptionParamSealed), LocatorUtils.property(thatLocator, "revokePrescriptionParamSealed", rhsRevokePrescriptionParamSealed), lhsRevokePrescriptionParamSealed, rhsRevokePrescriptionParamSealed)) {
            return false;
         } else {
   ...
   public int hashCode(ObjectLocator locator, HashCodeStrategy strategy) {
      ...
      byte[] theRevokePrescriptionParamSealed = this.getRevokePrescriptionParamSealed();
      int currentHashCode = strategy.hashCode(LocatorUtils.property(locator, "revokePrescriptionParamSealed", theRevokePrescriptionParamSealed), currentHashCode, theRevokePrescriptionParamSealed);
      String theMguid = this.getProgramIdentification();
