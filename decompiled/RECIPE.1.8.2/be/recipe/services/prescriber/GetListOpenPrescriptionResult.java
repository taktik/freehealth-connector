...
public class GetListOpenPrescriptionResult extends ResponseType implements Equals, HashCode, ToString {
   ...
   public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy strategy) {
      ...
      List<String> thePrescriptions = this.prescriptions != null && !this.prescriptions.isEmpty() ? this.getPrescriptions() : null;
   ...
   public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
      if (!(object instanceof GetListOpenPrescriptionResult)) {
         return false;
      } else if (this == object) {
         return true;
         ...
         GetListOpenPrescriptionResult that = (GetListOpenPrescriptionResult)object;
         List<String> lhsPrescriptions = this.prescriptions != null && !this.prescriptions.isEmpty() ? this.getPrescriptions() : null;
         List<String> rhsPrescriptions = that.prescriptions != null && !that.prescriptions.isEmpty() ? that.getPrescriptions() : null;
