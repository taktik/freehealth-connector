...
public class ListOpenRids implements Equals, HashCode, ToString {
   @XmlElement(
   ...
   public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy strategy) {
      byte[] theListOpenRidsParamSealed = this.getListOpenRidsParamSealed();
      strategy.appendField(locator, this, "listOpenRidsParamSealed", buffer, theListOpenRidsParamSealed);
   ...
   public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
      if (!(object instanceof ListOpenRids)) {
         return false;
      } else if (this == object) {
         return true;
      } else {
         ListOpenRids that = (ListOpenRids)object;
         byte[] lhsListOpenRidsParamSealed = this.getListOpenRidsParamSealed();
         byte[] rhsListOpenRidsParamSealed = that.getListOpenRidsParamSealed();
         if (!strategy.equals(LocatorUtils.property(thisLocator, "listOpenRidsParamSealed", lhsListOpenRidsParamSealed), LocatorUtils.property(thatLocator, "listOpenRidsParamSealed", rhsListOpenRidsParamSealed), lhsListOpenRidsParamSealed, rhsListOpenRidsParamSealed)) {
            return false;
         } else {
   ...
   public int hashCode(ObjectLocator locator, HashCodeStrategy strategy) {
      ...
      byte[] theListOpenRidsParamSealed = this.getListOpenRidsParamSealed();
      int currentHashCode = strategy.hashCode(LocatorUtils.property(locator, "listOpenRidsParamSealed", theListOpenRidsParamSealed), currentHashCode, theListOpenRidsParamSealed);
      String theMguid = this.getProgramIdentification();
