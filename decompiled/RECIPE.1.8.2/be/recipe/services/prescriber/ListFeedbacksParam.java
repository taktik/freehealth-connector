...
public class ListFeedbacksParam extends PartyIdentification implements Equals, HashCode, ToString {
   ...
   public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
      if (!(object instanceof ListFeedbacksParam)) {
         return false;
      } else if (this == object) {
         return true;
         ...
         ListFeedbacksParam that = (ListFeedbacksParam)object;
