...
public class SendNotification implements Equals, HashCode, ToString {
   @XmlElement(
   ...
   public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy strategy) {
      byte[] theSendNotificationParamSealed = this.getSendNotificationParamSealed();
      strategy.appendField(locator, this, "sendNotificationParamSealed", buffer, theSendNotificationParamSealed);
   ...
   public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
      if (!(object instanceof SendNotification)) {
         return false;
      } else if (this == object) {
         return true;
      } else {
         SendNotification that = (SendNotification)object;
         byte[] lhsSendNotificationParamSealed = this.getSendNotificationParamSealed();
         byte[] rhsSendNotificationParamSealed = that.getSendNotificationParamSealed();
         if (!strategy.equals(LocatorUtils.property(thisLocator, "sendNotificationParamSealed", lhsSendNotificationParamSealed), LocatorUtils.property(thatLocator, "sendNotificationParamSealed", rhsSendNotificationParamSealed), lhsSendNotificationParamSealed, rhsSendNotificationParamSealed)) {
            return false;
         } else {
   ...
   public int hashCode(ObjectLocator locator, HashCodeStrategy strategy) {
      ...
      byte[] theSendNotificationParamSealed = this.getSendNotificationParamSealed();
      int currentHashCode = strategy.hashCode(LocatorUtils.property(locator, "sendNotificationParamSealed", theSendNotificationParamSealed), currentHashCode, theSendNotificationParamSealed);
      String theMguid = this.getProgramIdentification();
