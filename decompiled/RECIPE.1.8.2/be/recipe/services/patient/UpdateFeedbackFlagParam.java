...
public class UpdateFeedbackFlagParam extends PartyIdentification implements Equals, HashCode, ToString {
   @XmlElement(
      required = true
   )
   ...
   public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy strategy) {
      ...
      boolean theAllowFeedback = this.isAllowFeedback();
      strategy.appendField(locator, this, "allowFeedback", buffer, theAllowFeedback);
   ...
   public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
      if (!(object instanceof UpdateFeedbackFlagParam)) {
         return false;
      } else if (this == object) {
         return true;
         ...
         UpdateFeedbackFlagParam that = (UpdateFeedbackFlagParam)object;
         ...
         if (!strategy.equals(LocatorUtils.property(thisLocator, "rid", lhsRid), LocatorUtils.property(thatLocator, "rid", rhsRid), lhsRid, rhsRid)) {
            ...
            boolean lhsAllowFeedback = this.isAllowFeedback();
            boolean rhsAllowFeedback = that.isAllowFeedback();
            if (!strategy.equals(LocatorUtils.property(thisLocator, "allowFeedback", lhsAllowFeedback), LocatorUtils.property(thatLocator, "allowFeedback", rhsAllowFeedback), lhsAllowFeedback, rhsAllowFeedback)) {
               return false;
            } else {
   ...
   public int hashCode(ObjectLocator locator, HashCodeStrategy strategy) {
      ...
      boolean theAllowFeedback = this.isAllowFeedback();
      currentHashCode = strategy.hashCode(LocatorUtils.property(locator, "allowFeedback", theAllowFeedback), currentHashCode, theAllowFeedback);
      byte[] theSymmKey = this.getSymmKey();
