...
@XmlType(
   name = "createRelationParam",
   propOrder = {"mandateHolderId", "symmKey"}
)
@XmlRootElement(
   name = "createRelationParam"
)
public class CreateRelationParam extends PartyIdentification implements Equals, HashCode, ToString {
   @XmlElement(
      required = true
   )
   ...
   public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
      if (!(object instanceof CreateRelationParam)) {
         return false;
      } else if (this == object) {
         return true;
         ...
         CreateRelationParam that = (CreateRelationParam)object;
