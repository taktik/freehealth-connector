...
@XmlType(
   name = "listPatientPrescriptionsParam",
   propOrder = {"symmKey", "page", "session"}
)
@XmlRootElement(
   name = "listPatientPrescriptionsParam"
)
public class ListPatientPrescriptionsParam extends PartyIdentification implements Equals, HashCode, ToString {
   @XmlElement(
      required = true
   )
   ...
   public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
      if (!(object instanceof ListPatientPrescriptionsParam)) {
         return false;
      } else if (this == object) {
         return true;
         ...
         ListPatientPrescriptionsParam that = (ListPatientPrescriptionsParam)object;
